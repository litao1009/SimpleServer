...
template<>
class	DecomposeTable<DCP_DECORBARDUNIT_DOORBOARD_SEAL_TYPE>::Imp
{
public:
...
template<>
void	DecomposeTable<DCP_DECORBARDUNIT_DOORBOARD_SEAL_TYPE>::Init(Statement& ss)
{
...
template<>
void	DecomposeTable<DCP_DECORBARDUNIT_DOORBOARD_SEAL_TYPE>::PreProcess()
{
	auto& imp_ = *ImpSPtr_;
...
template<>
void	DecomposeTable<DCP_DECORBARDUNIT_DOORBOARD_SEAL_TYPE>::PostProcess()
{

}

template<>
void	DecomposeTable<DCP_DECORBARDUNIT_DOORBOARD_SEAL_TYPE>::PostDecompose(soci::session& sql, soci::session& sqlInsert)
{
