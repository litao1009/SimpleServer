...
template<>
class	DecomposeTable<DCP_CABDOOR_BOARD_GAP_TYPE>::Imp
{
public:
...
template<>
void	DecomposeTable<DCP_CABDOOR_BOARD_GAP_TYPE>::Init(Statement& ss)
{
...
template<>
void	DecomposeTable<DCP_CABDOOR_BOARD_GAP_TYPE>::PreProcess()
{
	auto& imp_ = *ImpSPtr_;
...
template<>
void	DecomposeTable<DCP_CABDOOR_BOARD_GAP_TYPE>::PostProcess()
{
...
template<>
void	DecomposeTable<DCP_CABDOOR_BOARD_GAP_TYPE>::PostDecompose(soci::session& sql, soci::session& sqlInsert)
{
