...
namespace autoDB
{
void	DS_CabBoardGapInfoImp::SData::SetAll(bool val)
{
...
void	DS_CabBoardGapInfoImp::SData::Flip()
{
...
void	DS_CabBoardGapInfoImp::SData::Check()
{
	if ( !CabBoardGapID_ )
	{
...
void	DS_CabBoardGapInfoImp::SData::ToUtf8()
{
}

void	DS_CabBoardGapInfoImp::SData::ToAscii()
{
}

autoDB::SColumns DS_CabBoardGapInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns DS_CabBoardGapInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.CabBoardGapID_ )
	{
...
DS_CabBoardGapInfoImp	DS_CabBoardGapInfoImp::operator() (const StringType& alias)
{
	return std::move(DS_CabBoardGapInfoImp(alias));
}

DS_CabBoardGapInfoImp::DS_CabBoardGapInfoImp( const StringType& alias ):Table(AUTODB_STR("DS_CabBoardGapInfo"), alias)
...
DS_CabBoardGapInfoImp::DS_CabBoardGapInfoImp( const DS_CabBoardGapInfoImp& rhs ):Table(rhs)
...
DS_CabBoardGapInfoImp::DS_CabBoardGapInfoImp( DS_CabBoardGapInfoImp&& rhs ):Table(rhs)
...
DS_CabBoardGapInfoImp	DS_CabBoardGapInfo("");



void	DS_CabBoardInfoImp::SData::SetAll(bool val)
{
	val ? CabBoardID_.reset(boost::initialized_value) : CabBoardID_=boost::none;
...
void	DS_CabBoardInfoImp::SData::Flip()
{
	CabBoardID_ ? CabBoardID_=boost::none : CabBoardID_.reset(boost::initialized_value);
...
void	DS_CabBoardInfoImp::SData::Check()
{
	if ( !CabBoardID_ )
	{
		CabBoardID_.reset(boost::initialized_value);
...
void	DS_CabBoardInfoImp::SData::ToUtf8()
{
	if ( CabBoardName_ )
	{
...
void	DS_CabBoardInfoImp::SData::ToAscii()
{
	if ( CabBoardName_ )
	{
...
autoDB::SColumns DS_CabBoardInfoImp::Use( const SData& data )
{
	SColumns ret;
	if ( data.CabBoardID_ )
	{
...
autoDB::SColumns DS_CabBoardInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.CabBoardID_ )
	{
...
DS_CabBoardInfoImp	DS_CabBoardInfoImp::operator() (const StringType& alias)
{
	return std::move(DS_CabBoardInfoImp(alias));
}

DS_CabBoardInfoImp::DS_CabBoardInfoImp( const StringType& alias ):Table(AUTODB_STR("DS_CabBoardInfo"), alias)
	,CabBoardID(ImpSPtr_,AUTODB_STR("CabBoardID"))
...
DS_CabBoardInfoImp::DS_CabBoardInfoImp( const DS_CabBoardInfoImp& rhs ):Table(rhs)
	,CabBoardID(rhs.CabBoardID)
	,CabID(rhs.CabID)
	,OrderCate(rhs.OrderCate)
	,OrderID(rhs.OrderID)
...
DS_CabBoardInfoImp::DS_CabBoardInfoImp( DS_CabBoardInfoImp&& rhs ):Table(rhs)
	,CabBoardID(std::move(rhs.CabBoardID))
...
DS_CabBoardInfoImp	DS_CabBoardInfo("");



void	DS_CabBoardSealInfoImp::SData::SetAll(bool val)
{
...
void	DS_CabBoardSealInfoImp::SData::Flip()
{
...
void	DS_CabBoardSealInfoImp::SData::Check()
{
	if ( !CabBoardSealID_ )
	{
...
void	DS_CabBoardSealInfoImp::SData::ToUtf8()
{
}

void	DS_CabBoardSealInfoImp::SData::ToAscii()
{
}

autoDB::SColumns DS_CabBoardSealInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns DS_CabBoardSealInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.CabBoardSealID_ )
	{
...
DS_CabBoardSealInfoImp	DS_CabBoardSealInfoImp::operator() (const StringType& alias)
{
	return std::move(DS_CabBoardSealInfoImp(alias));
}

DS_CabBoardSealInfoImp::DS_CabBoardSealInfoImp( const StringType& alias ):Table(AUTODB_STR("DS_CabBoardSealInfo"), alias)
...
DS_CabBoardSealInfoImp::DS_CabBoardSealInfoImp( const DS_CabBoardSealInfoImp& rhs ):Table(rhs)
...
DS_CabBoardSealInfoImp::DS_CabBoardSealInfoImp( DS_CabBoardSealInfoImp&& rhs ):Table(rhs)
...
DS_CabBoardSealInfoImp	DS_CabBoardSealInfo("");



void	DS_CabDoorBoardGapInfoImp::SData::SetAll(bool val)
{
...
void	DS_CabDoorBoardGapInfoImp::SData::Flip()
{
...
void	DS_CabDoorBoardGapInfoImp::SData::Check()
{
...
void	DS_CabDoorBoardGapInfoImp::SData::ToUtf8()
{
}

void	DS_CabDoorBoardGapInfoImp::SData::ToAscii()
{
}

autoDB::SColumns DS_CabDoorBoardGapInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns DS_CabDoorBoardGapInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.CabDoorBoardGapID_ )
	{
...
DS_CabDoorBoardGapInfoImp	DS_CabDoorBoardGapInfoImp::operator() (const StringType& alias)
{
	return std::move(DS_CabDoorBoardGapInfoImp(alias));
}

DS_CabDoorBoardGapInfoImp::DS_CabDoorBoardGapInfoImp( const StringType& alias ):Table(AUTODB_STR("DS_CabDoorBoardGapInfo"), alias)
...
DS_CabDoorBoardGapInfoImp::DS_CabDoorBoardGapInfoImp( const DS_CabDoorBoardGapInfoImp& rhs ):Table(rhs)
...
DS_CabDoorBoardGapInfoImp::DS_CabDoorBoardGapInfoImp( DS_CabDoorBoardGapInfoImp&& rhs ):Table(rhs)
...
DS_CabDoorBoardGapInfoImp	DS_CabDoorBoardGapInfo("");



void	DS_CabDoorBoardInfoImp::SData::SetAll(bool val)
{
	val ? CabDoorBoardID_.reset(boost::initialized_value) : CabDoorBoardID_=boost::none;
...
void	DS_CabDoorBoardInfoImp::SData::Flip()
{
	CabDoorBoardID_ ? CabDoorBoardID_=boost::none : CabDoorBoardID_.reset(boost::initialized_value);
...
void	DS_CabDoorBoardInfoImp::SData::Check()
{
	if ( !CabDoorBoardID_ )
	{
		CabDoorBoardID_.reset(boost::initialized_value);
...
void	DS_CabDoorBoardInfoImp::SData::ToUtf8()
{
}

void	DS_CabDoorBoardInfoImp::SData::ToAscii()
{
}

autoDB::SColumns DS_CabDoorBoardInfoImp::Use( const SData& data )
{
	SColumns ret;
	if ( data.CabDoorBoardID_ )
	{
...
autoDB::SColumns DS_CabDoorBoardInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.CabDoorBoardID_ )
	{
...
DS_CabDoorBoardInfoImp	DS_CabDoorBoardInfoImp::operator() (const StringType& alias)
{
	return std::move(DS_CabDoorBoardInfoImp(alias));
}

DS_CabDoorBoardInfoImp::DS_CabDoorBoardInfoImp( const StringType& alias ):Table(AUTODB_STR("DS_CabDoorBoardInfo"), alias)
	,CabDoorBoardID(ImpSPtr_,AUTODB_STR("CabDoorBoardID"))
...
DS_CabDoorBoardInfoImp::DS_CabDoorBoardInfoImp( const DS_CabDoorBoardInfoImp& rhs ):Table(rhs)
	,CabDoorBoardID(rhs.CabDoorBoardID)
...
DS_CabDoorBoardInfoImp::DS_CabDoorBoardInfoImp( DS_CabDoorBoardInfoImp&& rhs ):Table(rhs)
	,CabDoorBoardID(std::move(rhs.CabDoorBoardID))
...
DS_CabDoorBoardInfoImp	DS_CabDoorBoardInfo("");



void	DS_CabDoorBoardSealInfoImp::SData::SetAll(bool val)
{
...
void	DS_CabDoorBoardSealInfoImp::SData::Flip()
{
...
void	DS_CabDoorBoardSealInfoImp::SData::Check()
{
...
void	DS_CabDoorBoardSealInfoImp::SData::ToUtf8()
{
}

void	DS_CabDoorBoardSealInfoImp::SData::ToAscii()
{
}

autoDB::SColumns DS_CabDoorBoardSealInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns DS_CabDoorBoardSealInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.CabDoorBoardSealID_ )
	{
...
DS_CabDoorBoardSealInfoImp	DS_CabDoorBoardSealInfoImp::operator() (const StringType& alias)
{
	return std::move(DS_CabDoorBoardSealInfoImp(alias));
}

DS_CabDoorBoardSealInfoImp::DS_CabDoorBoardSealInfoImp( const StringType& alias ):Table(AUTODB_STR("DS_CabDoorBoardSealInfo"), alias)
...
DS_CabDoorBoardSealInfoImp::DS_CabDoorBoardSealInfoImp( const DS_CabDoorBoardSealInfoImp& rhs ):Table(rhs)
...
DS_CabDoorBoardSealInfoImp::DS_CabDoorBoardSealInfoImp( DS_CabDoorBoardSealInfoImp&& rhs ):Table(rhs)
...
DS_CabDoorBoardSealInfoImp	DS_CabDoorBoardSealInfo("");



void	DS_CabDoorHWFInfoImp::SData::SetAll(bool val)
{
...
void	DS_CabDoorHWFInfoImp::SData::Flip()
{
...
void	DS_CabDoorHWFInfoImp::SData::Check()
{
	if ( !CabDoorHWFID_ )
	{
...
void	DS_CabDoorHWFInfoImp::SData::ToUtf8()
{
}

void	DS_CabDoorHWFInfoImp::SData::ToAscii()
{
}

autoDB::SColumns DS_CabDoorHWFInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns DS_CabDoorHWFInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.CabDoorHWFID_ )
	{
...
DS_CabDoorHWFInfoImp	DS_CabDoorHWFInfoImp::operator() (const StringType& alias)
{
	return std::move(DS_CabDoorHWFInfoImp(alias));
}

DS_CabDoorHWFInfoImp::DS_CabDoorHWFInfoImp( const StringType& alias ):Table(AUTODB_STR("DS_CabDoorHWFInfo"), alias)
...
DS_CabDoorHWFInfoImp::DS_CabDoorHWFInfoImp( const DS_CabDoorHWFInfoImp& rhs ):Table(rhs)
...
DS_CabDoorHWFInfoImp::DS_CabDoorHWFInfoImp( DS_CabDoorHWFInfoImp&& rhs ):Table(rhs)
...
DS_CabDoorHWFInfoImp	DS_CabDoorHWFInfo("");



void	DS_CabDoorHandleInfoImp::SData::SetAll(bool val)
{
...
void	DS_CabDoorHandleInfoImp::SData::Flip()
{
...
void	DS_CabDoorHandleInfoImp::SData::Check()
{
	if ( !CabDoorHandleID_ )
	{
...
void	DS_CabDoorHandleInfoImp::SData::ToUtf8()
{
}

void	DS_CabDoorHandleInfoImp::SData::ToAscii()
{
}

autoDB::SColumns DS_CabDoorHandleInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns DS_CabDoorHandleInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.CabDoorHandleID_ )
	{
...
DS_CabDoorHandleInfoImp	DS_CabDoorHandleInfoImp::operator() (const StringType& alias)
{
	return std::move(DS_CabDoorHandleInfoImp(alias));
}

DS_CabDoorHandleInfoImp::DS_CabDoorHandleInfoImp( const StringType& alias ):Table(AUTODB_STR("DS_CabDoorHandleInfo"), alias)
...
DS_CabDoorHandleInfoImp::DS_CabDoorHandleInfoImp( const DS_CabDoorHandleInfoImp& rhs ):Table(rhs)
...
DS_CabDoorHandleInfoImp::DS_CabDoorHandleInfoImp( DS_CabDoorHandleInfoImp&& rhs ):Table(rhs)
...
DS_CabDoorHandleInfoImp	DS_CabDoorHandleInfo("");



void	DS_CabDoorInfoImp::SData::SetAll(bool val)
{
	val ? CabDoorID_.reset(boost::initialized_value) : CabDoorID_=boost::none;
	val ? CabParentID_.reset(boost::initialized_value) : CabParentID_=boost::none;
	val ? ParentType_.reset(boost::initialized_value) : ParentType_=boost::none;
...
void	DS_CabDoorInfoImp::SData::Flip()
{
	CabDoorID_ ? CabDoorID_=boost::none : CabDoorID_.reset(boost::initialized_value);
	CabParentID_ ? CabParentID_=boost::none : CabParentID_.reset(boost::initialized_value);
	ParentType_ ? ParentType_=boost::none : ParentType_.reset(boost::initialized_value);
...
void	DS_CabDoorInfoImp::SData::Check()
{
	if ( !CabDoorID_ )
	{
		CabDoorID_.reset(boost::initialized_value);
...
void	DS_CabDoorInfoImp::SData::ToUtf8()
{
}

void	DS_CabDoorInfoImp::SData::ToAscii()
{
}

autoDB::SColumns DS_CabDoorInfoImp::Use( const SData& data )
{
	SColumns ret;
	if ( data.CabDoorID_ )
	{
...
autoDB::SColumns DS_CabDoorInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.CabDoorID_ )
	{
...
DS_CabDoorInfoImp	DS_CabDoorInfoImp::operator() (const StringType& alias)
{
	return std::move(DS_CabDoorInfoImp(alias));
}

DS_CabDoorInfoImp::DS_CabDoorInfoImp( const StringType& alias ):Table(AUTODB_STR("DS_CabDoorInfo"), alias)
	,CabDoorID(ImpSPtr_,AUTODB_STR("CabDoorID"))
	,CabParentID(ImpSPtr_,AUTODB_STR("CabParentID"))
	,ParentType(ImpSPtr_,AUTODB_STR("ParentType"))
	,OrderCate(ImpSPtr_,AUTODB_STR("OrderCate"))
...
DS_CabDoorInfoImp::DS_CabDoorInfoImp( const DS_CabDoorInfoImp& rhs ):Table(rhs)
	,CabDoorID(rhs.CabDoorID)
	,CabParentID(rhs.CabParentID)
	,ParentType(rhs.ParentType)
	,OrderCate(rhs.OrderCate)
...
DS_CabDoorInfoImp::DS_CabDoorInfoImp( DS_CabDoorInfoImp&& rhs ):Table(rhs)
	,CabDoorID(std::move(rhs.CabDoorID))
	,CabParentID(std::move(rhs.CabParentID))
	,ParentType(std::move(rhs.ParentType))
	,OrderCate(std::move(rhs.OrderCate))
...
DS_CabDoorInfoImp	DS_CabDoorInfo("");



void	DS_CabDoorRegionInfoImp::SData::SetAll(bool val)
{
	val ? CabDoorRegionID_.reset(boost::initialized_value) : CabDoorRegionID_=boost::none;
...
void	DS_CabDoorRegionInfoImp::SData::Flip()
{
	CabDoorRegionID_ ? CabDoorRegionID_=boost::none : CabDoorRegionID_.reset(boost::initialized_value);
...
void	DS_CabDoorRegionInfoImp::SData::Check()
{
	if ( !CabDoorRegionID_ )
	{
		CabDoorRegionID_.reset(boost::initialized_value);
...
void	DS_CabDoorRegionInfoImp::SData::ToUtf8()
{
}

void	DS_CabDoorRegionInfoImp::SData::ToAscii()
{
}

autoDB::SColumns DS_CabDoorRegionInfoImp::Use( const SData& data )
{
	SColumns ret;
	if ( data.CabDoorRegionID_ )
	{
...
autoDB::SColumns DS_CabDoorRegionInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.CabDoorRegionID_ )
	{
...
DS_CabDoorRegionInfoImp	DS_CabDoorRegionInfoImp::operator() (const StringType& alias)
{
	return std::move(DS_CabDoorRegionInfoImp(alias));
}

DS_CabDoorRegionInfoImp::DS_CabDoorRegionInfoImp( const StringType& alias ):Table(AUTODB_STR("DS_CabDoorRegionInfo"), alias)
	,CabDoorRegionID(ImpSPtr_,AUTODB_STR("CabDoorRegionID"))
...
DS_CabDoorRegionInfoImp::DS_CabDoorRegionInfoImp( const DS_CabDoorRegionInfoImp& rhs ):Table(rhs)
	,CabDoorRegionID(rhs.CabDoorRegionID)
...
DS_CabDoorRegionInfoImp::DS_CabDoorRegionInfoImp( DS_CabDoorRegionInfoImp&& rhs ):Table(rhs)
	,CabDoorRegionID(std::move(rhs.CabDoorRegionID))
...
DS_CabDoorRegionInfoImp	DS_CabDoorRegionInfo("");



void	DS_CabDoorSlideInfoImp::SData::SetAll(bool val)
{
...
void	DS_CabDoorSlideInfoImp::SData::Flip()
{
...
void	DS_CabDoorSlideInfoImp::SData::Check()
{
	if ( !CabDoorSlideID_ )
	{
...
void	DS_CabDoorSlideInfoImp::SData::ToUtf8()
{
}

void	DS_CabDoorSlideInfoImp::SData::ToAscii()
{
}

autoDB::SColumns DS_CabDoorSlideInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns DS_CabDoorSlideInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.CabDoorSlideID_ )
	{
...
DS_CabDoorSlideInfoImp	DS_CabDoorSlideInfoImp::operator() (const StringType& alias)
{
	return std::move(DS_CabDoorSlideInfoImp(alias));
}

DS_CabDoorSlideInfoImp::DS_CabDoorSlideInfoImp( const StringType& alias ):Table(AUTODB_STR("DS_CabDoorSlideInfo"), alias)
...
DS_CabDoorSlideInfoImp::DS_CabDoorSlideInfoImp( const DS_CabDoorSlideInfoImp& rhs ):Table(rhs)
...
DS_CabDoorSlideInfoImp::DS_CabDoorSlideInfoImp( DS_CabDoorSlideInfoImp&& rhs ):Table(rhs)
...
DS_CabDoorSlideInfoImp	DS_CabDoorSlideInfo("");



void	DS_CabDoorSystemInfoImp::SData::SetAll(bool val)
{
	val ? CabDoorSystemID_.reset(boost::initialized_value) : CabDoorSystemID_=boost::none;
	val ? CabID_.reset(boost::initialized_value) : CabID_=boost::none;
	val ? OrderCate_.reset(boost::initialized_value) : OrderCate_=boost::none;
...
void	DS_CabDoorSystemInfoImp::SData::Flip()
{
	CabDoorSystemID_ ? CabDoorSystemID_=boost::none : CabDoorSystemID_.reset(boost::initialized_value);
	CabID_ ? CabID_=boost::none : CabID_.reset(boost::initialized_value);
	OrderCate_ ? OrderCate_=boost::none : OrderCate_.reset(boost::initialized_value);
...
void	DS_CabDoorSystemInfoImp::SData::Check()
{
	if ( !CabDoorSystemID_ )
	{
		CabDoorSystemID_.reset(boost::initialized_value);
...
void	DS_CabDoorSystemInfoImp::SData::ToUtf8()
{
}

void	DS_CabDoorSystemInfoImp::SData::ToAscii()
{
}

autoDB::SColumns DS_CabDoorSystemInfoImp::Use( const SData& data )
{
	SColumns ret;
	if ( data.CabDoorSystemID_ )
	{
...
autoDB::SColumns DS_CabDoorSystemInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.CabDoorSystemID_ )
	{
...
DS_CabDoorSystemInfoImp	DS_CabDoorSystemInfoImp::operator() (const StringType& alias)
{
	return std::move(DS_CabDoorSystemInfoImp(alias));
}

DS_CabDoorSystemInfoImp::DS_CabDoorSystemInfoImp( const StringType& alias ):Table(AUTODB_STR("DS_CabDoorSystemInfo"), alias)
	,CabDoorSystemID(ImpSPtr_,AUTODB_STR("CabDoorSystemID"))
	,CabID(ImpSPtr_,AUTODB_STR("CabID"))
	,OrderCate(ImpSPtr_,AUTODB_STR("OrderCate"))
	,OrderID(ImpSPtr_,AUTODB_STR("OrderID"))
...
DS_CabDoorSystemInfoImp::DS_CabDoorSystemInfoImp( const DS_CabDoorSystemInfoImp& rhs ):Table(rhs)
	,CabDoorSystemID(rhs.CabDoorSystemID)
	,CabID(rhs.CabID)
	,OrderCate(rhs.OrderCate)
	,OrderID(rhs.OrderID)
...
DS_CabDoorSystemInfoImp::DS_CabDoorSystemInfoImp( DS_CabDoorSystemInfoImp&& rhs ):Table(rhs)
	,CabDoorSystemID(std::move(rhs.CabDoorSystemID))
	,CabID(std::move(rhs.CabID))
	,OrderCate(std::move(rhs.OrderCate))
	,OrderID(std::move(rhs.OrderID))
...
DS_CabDoorSystemInfoImp	DS_CabDoorSystemInfo("");



void	DS_CabFNFHWFInfoImp::SData::SetAll(bool val)
{
...
void	DS_CabFNFHWFInfoImp::SData::Flip()
{
...
void	DS_CabFNFHWFInfoImp::SData::Check()
{
	if ( !CabFNFHWFID_ )
	{
...
void	DS_CabFNFHWFInfoImp::SData::ToUtf8()
{
}

void	DS_CabFNFHWFInfoImp::SData::ToAscii()
{
}

autoDB::SColumns DS_CabFNFHWFInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns DS_CabFNFHWFInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.CabFNFHWFID_ )
	{
...
DS_CabFNFHWFInfoImp	DS_CabFNFHWFInfoImp::operator() (const StringType& alias)
{
	return std::move(DS_CabFNFHWFInfoImp(alias));
}

DS_CabFNFHWFInfoImp::DS_CabFNFHWFInfoImp( const StringType& alias ):Table(AUTODB_STR("DS_CabFNFHWFInfo"), alias)
...
DS_CabFNFHWFInfoImp::DS_CabFNFHWFInfoImp( const DS_CabFNFHWFInfoImp& rhs ):Table(rhs)
...
DS_CabFNFHWFInfoImp::DS_CabFNFHWFInfoImp( DS_CabFNFHWFInfoImp&& rhs ):Table(rhs)
...
DS_CabFNFHWFInfoImp	DS_CabFNFHWFInfo("");



void	DS_CabFNFHoleInfoImp::SData::SetAll(bool val)
{
...
void	DS_CabFNFHoleInfoImp::SData::Flip()
{
...
void	DS_CabFNFHoleInfoImp::SData::Check()
{
	if ( !CabFNFHoleID_ )
	{
...
void	DS_CabFNFHoleInfoImp::SData::ToUtf8()
{
}

void	DS_CabFNFHoleInfoImp::SData::ToAscii()
{
}

autoDB::SColumns DS_CabFNFHoleInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns DS_CabFNFHoleInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.CabFNFHoleID_ )
	{
...
DS_CabFNFHoleInfoImp	DS_CabFNFHoleInfoImp::operator() (const StringType& alias)
{
	return std::move(DS_CabFNFHoleInfoImp(alias));
}

DS_CabFNFHoleInfoImp::DS_CabFNFHoleInfoImp( const StringType& alias ):Table(AUTODB_STR("DS_CabFNFHoleInfo"), alias)
...
DS_CabFNFHoleInfoImp::DS_CabFNFHoleInfoImp( const DS_CabFNFHoleInfoImp& rhs ):Table(rhs)
...
DS_CabFNFHoleInfoImp::DS_CabFNFHoleInfoImp( DS_CabFNFHoleInfoImp&& rhs ):Table(rhs)
...
DS_CabFNFHoleInfoImp	DS_CabFNFHoleInfo("");



void	DS_CabFNFInfoImp::SData::SetAll(bool val)
{
	val ? CabFNFID_.reset(boost::initialized_value) : CabFNFID_=boost::none;
...
void	DS_CabFNFInfoImp::SData::Flip()
{
	CabFNFID_ ? CabFNFID_=boost::none : CabFNFID_.reset(boost::initialized_value);
...
void	DS_CabFNFInfoImp::SData::Check()
{
	if ( !CabFNFID_ )
	{
		CabFNFID_.reset(boost::initialized_value);
...
void	DS_CabFNFInfoImp::SData::ToUtf8()
{
	if ( UserMemo_ )
	{
...
void	DS_CabFNFInfoImp::SData::ToAscii()
{
	if ( UserMemo_ )
	{
...
autoDB::SColumns DS_CabFNFInfoImp::Use( const SData& data )
{
	SColumns ret;
	if ( data.CabFNFID_ )
	{
...
autoDB::SColumns DS_CabFNFInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.CabFNFID_ )
	{
...
DS_CabFNFInfoImp	DS_CabFNFInfoImp::operator() (const StringType& alias)
{
	return std::move(DS_CabFNFInfoImp(alias));
}

DS_CabFNFInfoImp::DS_CabFNFInfoImp( const StringType& alias ):Table(AUTODB_STR("DS_CabFNFInfo"), alias)
	,CabFNFID(ImpSPtr_,AUTODB_STR("CabFNFID"))
...
DS_CabFNFInfoImp::DS_CabFNFInfoImp( const DS_CabFNFInfoImp& rhs ):Table(rhs)
	,CabFNFID(rhs.CabFNFID)
...
DS_CabFNFInfoImp::DS_CabFNFInfoImp( DS_CabFNFInfoImp&& rhs ):Table(rhs)
	,CabFNFID(std::move(rhs.CabFNFID))
...
DS_CabFNFInfoImp	DS_CabFNFInfo("");



void	DS_CabFNFPartInfoImp::SData::SetAll(bool val)
{
...
void	DS_CabFNFPartInfoImp::SData::Flip()
{
...
void	DS_CabFNFPartInfoImp::SData::Check()
{
	if ( !CabFNFPartID_ )
	{
...
void	DS_CabFNFPartInfoImp::SData::ToUtf8()
{
}

void	DS_CabFNFPartInfoImp::SData::ToAscii()
{
}

autoDB::SColumns DS_CabFNFPartInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns DS_CabFNFPartInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.CabFNFPartID_ )
	{
...
DS_CabFNFPartInfoImp	DS_CabFNFPartInfoImp::operator() (const StringType& alias)
{
	return std::move(DS_CabFNFPartInfoImp(alias));
}

DS_CabFNFPartInfoImp::DS_CabFNFPartInfoImp( const StringType& alias ):Table(AUTODB_STR("DS_CabFNFPartInfo"), alias)
...
DS_CabFNFPartInfoImp::DS_CabFNFPartInfoImp( const DS_CabFNFPartInfoImp& rhs ):Table(rhs)
...
DS_CabFNFPartInfoImp::DS_CabFNFPartInfoImp( DS_CabFNFPartInfoImp&& rhs ):Table(rhs)
...
DS_CabFNFPartInfoImp	DS_CabFNFPartInfo("");



void	DS_CabFNFPartSealInfoImp::SData::SetAll(bool val)
{
...
void	DS_CabFNFPartSealInfoImp::SData::Flip()
{
...
void	DS_CabFNFPartSealInfoImp::SData::Check()
{
...
void	DS_CabFNFPartSealInfoImp::SData::ToUtf8()
{
}

void	DS_CabFNFPartSealInfoImp::SData::ToAscii()
{
}

autoDB::SColumns DS_CabFNFPartSealInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns DS_CabFNFPartSealInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.CabFNFPartSealID_ )
	{
...
DS_CabFNFPartSealInfoImp	DS_CabFNFPartSealInfoImp::operator() (const StringType& alias)
{
	return std::move(DS_CabFNFPartSealInfoImp(alias));
}

DS_CabFNFPartSealInfoImp::DS_CabFNFPartSealInfoImp( const StringType& alias ):Table(AUTODB_STR("DS_CabFNFPartSealInfo"), alias)
...
DS_CabFNFPartSealInfoImp::DS_CabFNFPartSealInfoImp( const DS_CabFNFPartSealInfoImp& rhs ):Table(rhs)
...
DS_CabFNFPartSealInfoImp::DS_CabFNFPartSealInfoImp( DS_CabFNFPartSealInfoImp&& rhs ):Table(rhs)
...
DS_CabFNFPartSealInfoImp	DS_CabFNFPartSealInfo("");



void	DS_CabInfoImp::SData::SetAll(bool val)
{
	val ? CabID_.reset(boost::initialized_value) : CabID_=boost::none;
	val ? OrderCate_.reset(boost::initialized_value) : OrderCate_=boost::none;
	val ? DesignPlanID_.reset(boost::initialized_value) : DesignPlanID_=boost::none;
...
void	DS_CabInfoImp::SData::Check()
{
	if ( !CabID_ )
	{
		CabID_.reset(boost::initialized_value);
...
void	DS_CabInfoImp::SData::ToUtf8()
{
}

void	DS_CabInfoImp::SData::ToAscii()
{
}

autoDB::SColumns DS_CabInfoImp::Use( const SData& data )
{
	SColumns ret;
	if ( data.CabID_ )
	{
...
autoDB::SColumns DS_CabInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.CabID_ )
	{
...
DS_CabInfoImp	DS_CabInfoImp::operator() (const StringType& alias)
{
	return std::move(DS_CabInfoImp(alias));
}

DS_CabInfoImp::DS_CabInfoImp( const StringType& alias ):Table(AUTODB_STR("DS_CabInfo"), alias)
	,CabID(ImpSPtr_,AUTODB_STR("CabID"))
	,OrderCate(ImpSPtr_,AUTODB_STR("OrderCate"))
	,DesignPlanID(ImpSPtr_,AUTODB_STR("DesignPlanID"))
	,OrderID(ImpSPtr_,AUTODB_STR("OrderID"))
...
DS_CabInfoImp::DS_CabInfoImp( const DS_CabInfoImp& rhs ):Table(rhs)
	,CabID(rhs.CabID)
	,OrderCate(rhs.OrderCate)
	,DesignPlanID(rhs.DesignPlanID)
	,OrderID(rhs.OrderID)
...
DS_CabInfoImp::DS_CabInfoImp( DS_CabInfoImp&& rhs ):Table(rhs)
	,CabID(std::move(rhs.CabID))
	,OrderCate(std::move(rhs.OrderCate))
	,DesignPlanID(std::move(rhs.DesignPlanID))
	,OrderID(std::move(rhs.OrderID))
...
DS_CabInfoImp	DS_CabInfo("");



void	DS_DecorBoardInfoImp::SData::SetAll(bool val)
{
...
void	DS_DecorBoardInfoImp::SData::Flip()
{
...
void	DS_DecorBoardInfoImp::SData::Check()
{
...
void	DS_DecorBoardInfoImp::SData::ToUtf8()
{
}

void	DS_DecorBoardInfoImp::SData::ToAscii()
{
}

autoDB::SColumns DS_DecorBoardInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns DS_DecorBoardInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.DesignDecorBoardID_ )
	{
...
DS_DecorBoardInfoImp	DS_DecorBoardInfoImp::operator() (const StringType& alias)
{
	return std::move(DS_DecorBoardInfoImp(alias));
}

DS_DecorBoardInfoImp::DS_DecorBoardInfoImp( const StringType& alias ):Table(AUTODB_STR("DS_DecorBoardInfo"), alias)
...
DS_DecorBoardInfoImp::DS_DecorBoardInfoImp( const DS_DecorBoardInfoImp& rhs ):Table(rhs)
...
DS_DecorBoardInfoImp::DS_DecorBoardInfoImp( DS_DecorBoardInfoImp&& rhs ):Table(rhs)
...
DS_DecorBoardInfoImp	DS_DecorBoardInfo("");



void	DS_DecorBoardUnitInfoImp::SData::SetAll(bool val)
{
...
void	DS_DecorBoardUnitInfoImp::SData::Flip()
{
...
void	DS_DecorBoardUnitInfoImp::SData::Check()
{
...
void	DS_DecorBoardUnitInfoImp::SData::ToUtf8()
{
}

void	DS_DecorBoardUnitInfoImp::SData::ToAscii()
{
}

autoDB::SColumns DS_DecorBoardUnitInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns DS_DecorBoardUnitInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.DesignDecorBoardUnitID_ )
	{
...
DS_DecorBoardUnitInfoImp	DS_DecorBoardUnitInfoImp::operator() (const StringType& alias)
{
	return std::move(DS_DecorBoardUnitInfoImp(alias));
}

DS_DecorBoardUnitInfoImp::DS_DecorBoardUnitInfoImp( const StringType& alias ):Table(AUTODB_STR("DS_DecorBoardUnitInfo"), alias)
...
DS_DecorBoardUnitInfoImp::DS_DecorBoardUnitInfoImp( const DS_DecorBoardUnitInfoImp& rhs ):Table(rhs)
...
DS_DecorBoardUnitInfoImp::DS_DecorBoardUnitInfoImp( DS_DecorBoardUnitInfoImp&& rhs ):Table(rhs)
...
DS_DecorBoardUnitInfoImp	DS_DecorBoardUnitInfo("");



void	DS_DecorBoardUnitSealInfoImp::SData::SetAll(bool val)
{
...
void	DS_DecorBoardUnitSealInfoImp::SData::Flip()
{
...
void	DS_DecorBoardUnitSealInfoImp::SData::Check()
{
...
void	DS_DecorBoardUnitSealInfoImp::SData::ToUtf8()
{
}

void	DS_DecorBoardUnitSealInfoImp::SData::ToAscii()
{
}

autoDB::SColumns DS_DecorBoardUnitSealInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns DS_DecorBoardUnitSealInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.DesignDecorBoardUnitSealID_ )
	{
...
DS_DecorBoardUnitSealInfoImp	DS_DecorBoardUnitSealInfoImp::operator() (const StringType& alias)
{
	return std::move(DS_DecorBoardUnitSealInfoImp(alias));
}

DS_DecorBoardUnitSealInfoImp::DS_DecorBoardUnitSealInfoImp( const StringType& alias ):Table(AUTODB_STR("DS_DecorBoardUnitSealInfo"), alias)
...
DS_DecorBoardUnitSealInfoImp::DS_DecorBoardUnitSealInfoImp( const DS_DecorBoardUnitSealInfoImp& rhs ):Table(rhs)
...
DS_DecorBoardUnitSealInfoImp::DS_DecorBoardUnitSealInfoImp( DS_DecorBoardUnitSealInfoImp&& rhs ):Table(rhs)
...
DS_DecorBoardUnitSealInfoImp	DS_DecorBoardUnitSealInfo("");



void	DS_DecorInfoImp::SData::SetAll(bool val)
{
...
void	DS_DecorInfoImp::SData::Flip()
{
...
void	DS_DecorInfoImp::SData::Check()
{
	if ( !DesignDecorID_ )
	{
...
void	DS_DecorInfoImp::SData::ToUtf8()
{
}

void	DS_DecorInfoImp::SData::ToAscii()
{
}

autoDB::SColumns DS_DecorInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns DS_DecorInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.DesignDecorID_ )
	{
...
DS_DecorInfoImp	DS_DecorInfoImp::operator() (const StringType& alias)
{
	return std::move(DS_DecorInfoImp(alias));
}

DS_DecorInfoImp::DS_DecorInfoImp( const StringType& alias ):Table(AUTODB_STR("DS_DecorInfo"), alias)
...
DS_DecorInfoImp::DS_DecorInfoImp( const DS_DecorInfoImp& rhs ):Table(rhs)
...
DS_DecorInfoImp::DS_DecorInfoImp( DS_DecorInfoImp&& rhs ):Table(rhs)
...
DS_DecorInfoImp	DS_DecorInfo("");



void	DS_DecorLineInfoImp::SData::SetAll(bool val)
{
...
void	DS_DecorLineInfoImp::SData::Flip()
{
...
void	DS_DecorLineInfoImp::SData::Check()
{
...
void	DS_DecorLineInfoImp::SData::ToUtf8()
{
}

void	DS_DecorLineInfoImp::SData::ToAscii()
{
}

autoDB::SColumns DS_DecorLineInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns DS_DecorLineInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.DesignDecorLineID_ )
	{
...
DS_DecorLineInfoImp	DS_DecorLineInfoImp::operator() (const StringType& alias)
{
	return std::move(DS_DecorLineInfoImp(alias));
}

DS_DecorLineInfoImp::DS_DecorLineInfoImp( const StringType& alias ):Table(AUTODB_STR("DS_DecorLineInfo"), alias)
...
DS_DecorLineInfoImp::DS_DecorLineInfoImp( const DS_DecorLineInfoImp& rhs ):Table(rhs)
...
DS_DecorLineInfoImp::DS_DecorLineInfoImp( DS_DecorLineInfoImp&& rhs ):Table(rhs)
...
DS_DecorLineInfoImp	DS_DecorLineInfo("");



void	DS_DesignPlanInfoImp::SData::SetAll(bool val)
{
	val ? DesignPlanID_.reset(boost::initialized_value) : DesignPlanID_=boost::none;
	val ? OrderCate_.reset(boost::initialized_value) : OrderCate_=boost::none;
	val ? OrderID_.reset(boost::initialized_value) : OrderID_=boost::none;
...
void	DS_DesignPlanInfoImp::SData::Flip()
{
	DesignPlanID_ ? DesignPlanID_=boost::none : DesignPlanID_.reset(boost::initialized_value);
	OrderCate_ ? OrderCate_=boost::none : OrderCate_.reset(boost::initialized_value);
	OrderID_ ? OrderID_=boost::none : OrderID_.reset(boost::initialized_value);
...
void	DS_DesignPlanInfoImp::SData::Check()
{
	if ( !DesignPlanID_ )
	{
		DesignPlanID_.reset(boost::initialized_value);
...
void	DS_DesignPlanInfoImp::SData::ToUtf8()
{
	if ( DesignPlanName_ )
	{
...
void	DS_DesignPlanInfoImp::SData::ToAscii()
{
	if ( DesignPlanName_ )
	{
...
autoDB::SColumns DS_DesignPlanInfoImp::Use( const SData& data )
{
	SColumns ret;
	if ( data.DesignPlanID_ )
	{
...
autoDB::SColumns DS_DesignPlanInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.DesignPlanID_ )
	{
...
DS_DesignPlanInfoImp	DS_DesignPlanInfoImp::operator() (const StringType& alias)
{
	return std::move(DS_DesignPlanInfoImp(alias));
}

DS_DesignPlanInfoImp::DS_DesignPlanInfoImp( const StringType& alias ):Table(AUTODB_STR("DS_DesignPlanInfo"), alias)
	,DesignPlanID(ImpSPtr_,AUTODB_STR("DesignPlanID"))
	,OrderCate(ImpSPtr_,AUTODB_STR("OrderCate"))
	,OrderID(ImpSPtr_,AUTODB_STR("OrderID"))
	,FactoryID(ImpSPtr_,AUTODB_STR("FactoryID"))
...
DS_DesignPlanInfoImp::DS_DesignPlanInfoImp( const DS_DesignPlanInfoImp& rhs ):Table(rhs)
	,DesignPlanID(rhs.DesignPlanID)
	,OrderCate(rhs.OrderCate)
	,OrderID(rhs.OrderID)
	,FactoryID(rhs.FactoryID)
...
DS_DesignPlanInfoImp::DS_DesignPlanInfoImp( DS_DesignPlanInfoImp&& rhs ):Table(rhs)
	,DesignPlanID(std::move(rhs.DesignPlanID))
	,OrderCate(std::move(rhs.OrderCate))
	,OrderID(std::move(rhs.OrderID))
	,FactoryID(std::move(rhs.FactoryID))
...
DS_DesignPlanInfoImp	DS_DesignPlanInfo("");



void	DS_FittingInfoImp::SData::SetAll(bool val)
{
...
void	DS_FittingInfoImp::SData::Flip()
{
...
void	DS_FittingInfoImp::SData::Check()
{
	if ( !DesignFittingID_ )
	{
...
void	DS_FittingInfoImp::SData::ToUtf8()
{
}

void	DS_FittingInfoImp::SData::ToAscii()
{
}

autoDB::SColumns DS_FittingInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns DS_FittingInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.DesignFittingID_ )
	{
...
DS_FittingInfoImp	DS_FittingInfoImp::operator() (const StringType& alias)
{
	return std::move(DS_FittingInfoImp(alias));
}

DS_FittingInfoImp::DS_FittingInfoImp( const StringType& alias ):Table(AUTODB_STR("DS_FittingInfo"), alias)
...
DS_FittingInfoImp::DS_FittingInfoImp( const DS_FittingInfoImp& rhs ):Table(rhs)
...
DS_FittingInfoImp::DS_FittingInfoImp( DS_FittingInfoImp&& rhs ):Table(rhs)
...
DS_FittingInfoImp	DS_FittingInfo("");



void	DS_HWFInfoImp::SData::SetAll(bool val)
{
...
void	DS_HWFInfoImp::SData::Check()
{
	if ( !DesignHWFID_ )
	{
...
void	DS_HWFInfoImp::SData::ToUtf8()
{
}

void	DS_HWFInfoImp::SData::ToAscii()
{
}

autoDB::SColumns DS_HWFInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns DS_HWFInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.DesignHWFID_ )
	{
...
DS_HWFInfoImp	DS_HWFInfoImp::operator() (const StringType& alias)
{
	return std::move(DS_HWFInfoImp(alias));
}

DS_HWFInfoImp::DS_HWFInfoImp( const StringType& alias ):Table(AUTODB_STR("DS_HWFInfo"), alias)
...
DS_HWFInfoImp::DS_HWFInfoImp( const DS_HWFInfoImp& rhs ):Table(rhs)
...
DS_HWFInfoImp::DS_HWFInfoImp( DS_HWFInfoImp&& rhs ):Table(rhs)
...
DS_HWFInfoImp	DS_HWFInfo("");



void	DS_MarkInfoImp::SData::SetAll(bool val)
{
...
void	DS_MarkInfoImp::SData::Flip()
{
...
void	DS_MarkInfoImp::SData::Check()
{
	if ( !DesignMarkID_ )
	{
...
void	DS_MarkInfoImp::SData::ToUtf8()
{
	if ( FaceName_ )
	{
...
void	DS_MarkInfoImp::SData::ToAscii()
{
	if ( FaceName_ )
	{
...
autoDB::SColumns DS_MarkInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns DS_MarkInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.DesignMarkID_ )
	{
...
DS_MarkInfoImp	DS_MarkInfoImp::operator() (const StringType& alias)
{
	return std::move(DS_MarkInfoImp(alias));
}

DS_MarkInfoImp::DS_MarkInfoImp( const StringType& alias ):Table(AUTODB_STR("DS_MarkInfo"), alias)
...
DS_MarkInfoImp::DS_MarkInfoImp( const DS_MarkInfoImp& rhs ):Table(rhs)
...
DS_MarkInfoImp::DS_MarkInfoImp( DS_MarkInfoImp&& rhs ):Table(rhs)
...
DS_MarkInfoImp	DS_MarkInfo("");



void	DS_MatrixInfoImp::SData::SetAll(bool val)
{
	val ? OrderID_.reset(boost::initialized_value) : OrderID_=boost::none;
	val ? OrderCate_.reset(boost::initialized_value) : OrderCate_=boost::none;
	val ? DesignPlanID_.reset(boost::initialized_value) : DesignPlanID_=boost::none;
...
void	DS_MatrixInfoImp::SData::Flip()
{
	OrderID_ ? OrderID_=boost::none : OrderID_.reset(boost::initialized_value);
	OrderCate_ ? OrderCate_=boost::none : OrderCate_.reset(boost::initialized_value);
	DesignPlanID_ ? DesignPlanID_=boost::none : DesignPlanID_.reset(boost::initialized_value);
...
void	DS_MatrixInfoImp::SData::Check()
{
	if ( !OrderID_ )
	{
		OrderID_.reset(boost::initialized_value);
...
void	DS_MatrixInfoImp::SData::ToUtf8()
{
}

void	DS_MatrixInfoImp::SData::ToAscii()
{
}

autoDB::SColumns DS_MatrixInfoImp::Use( const SData& data )
{
	SColumns ret;
	if ( data.OrderID_ )
	{
...
autoDB::SColumns DS_MatrixInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.OrderID_ )
	{
...
DS_MatrixInfoImp	DS_MatrixInfoImp::operator() (const StringType& alias)
{
	return std::move(DS_MatrixInfoImp(alias));
}

DS_MatrixInfoImp::DS_MatrixInfoImp( const StringType& alias ):Table(AUTODB_STR("DS_MatrixInfo"), alias)
	,OrderID(ImpSPtr_,AUTODB_STR("OrderID"))
	,OrderCate(ImpSPtr_,AUTODB_STR("OrderCate"))
	,DesignPlanID(ImpSPtr_,AUTODB_STR("DesignPlanID"))
	,FactoryID(ImpSPtr_,AUTODB_STR("FactoryID"))
...
DS_MatrixInfoImp::DS_MatrixInfoImp( const DS_MatrixInfoImp& rhs ):Table(rhs)
	,OrderID(rhs.OrderID)
	,OrderCate(rhs.OrderCate)
	,DesignPlanID(rhs.DesignPlanID)
	,FactoryID(rhs.FactoryID)
...
DS_MatrixInfoImp::DS_MatrixInfoImp( DS_MatrixInfoImp&& rhs ):Table(rhs)
	,OrderID(std::move(rhs.OrderID))
	,OrderCate(std::move(rhs.OrderCate))
	,DesignPlanID(std::move(rhs.DesignPlanID))
	,FactoryID(std::move(rhs.FactoryID))
...
DS_MatrixInfoImp	DS_MatrixInfo("");



void	DS_OrderAddedInfoImp::SData::SetAll(bool val)
{
...
void	DS_OrderAddedInfoImp::SData::Flip()
{
...
void	DS_OrderAddedInfoImp::SData::Check()
{
	if ( !OrderAddedID_ )
	{
...
void	DS_OrderAddedInfoImp::SData::ToUtf8()
{
	if ( AddedName_ )
	{
...
void	DS_OrderAddedInfoImp::SData::ToAscii()
{
	if ( AddedName_ )
	{
...
autoDB::SColumns DS_OrderAddedInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns DS_OrderAddedInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.OrderAddedID_ )
	{
...
DS_OrderAddedInfoImp	DS_OrderAddedInfoImp::operator() (const StringType& alias)
{
	return std::move(DS_OrderAddedInfoImp(alias));
}

DS_OrderAddedInfoImp::DS_OrderAddedInfoImp( const StringType& alias ):Table(AUTODB_STR("DS_OrderAddedInfo"), alias)
...
DS_OrderAddedInfoImp::DS_OrderAddedInfoImp( const DS_OrderAddedInfoImp& rhs ):Table(rhs)
...
DS_OrderAddedInfoImp::DS_OrderAddedInfoImp( DS_OrderAddedInfoImp&& rhs ):Table(rhs)
...
DS_OrderAddedInfoImp	DS_OrderAddedInfo("");



void	DS_OrderDataInfoImp::SData::SetAll(bool val)
{
	val ? OrderID_.reset(boost::initialized_value) : OrderID_=boost::none;
	val ? OrderCate_.reset(boost::initialized_value) : OrderCate_=boost::none;
	val ? FactoryID_.reset(boost::initialized_value) : FactoryID_=boost::none;
...
void	DS_OrderDataInfoImp::SData::Flip()
{
	OrderID_ ? OrderID_=boost::none : OrderID_.reset(boost::initialized_value);
	OrderCate_ ? OrderCate_=boost::none : OrderCate_.reset(boost::initialized_value);
	FactoryID_ ? FactoryID_=boost::none : FactoryID_.reset(boost::initialized_value);
...
void	DS_OrderDataInfoImp::SData::Check()
{
	if ( !OrderID_ )
	{
		OrderID_.reset(boost::initialized_value);
...
void	DS_OrderDataInfoImp::SData::ToUtf8()
{
	if ( GeoCode_ )
	{
...
void	DS_OrderDataInfoImp::SData::ToAscii()
{
	if ( GeoCode_ )
	{
...
autoDB::SColumns DS_OrderDataInfoImp::Use( const SData& data )
{
	SColumns ret;
	if ( data.OrderID_ )
	{
...
autoDB::SColumns DS_OrderDataInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.OrderID_ )
	{
...
DS_OrderDataInfoImp	DS_OrderDataInfoImp::operator() (const StringType& alias)
{
	return std::move(DS_OrderDataInfoImp(alias));
}

DS_OrderDataInfoImp::DS_OrderDataInfoImp( const StringType& alias ):Table(AUTODB_STR("DS_OrderDataInfo"), alias)
	,OrderID(ImpSPtr_,AUTODB_STR("OrderID"))
	,OrderCate(ImpSPtr_,AUTODB_STR("OrderCate"))
	,FactoryID(ImpSPtr_,AUTODB_STR("FactoryID"))
...
DS_OrderDataInfoImp::DS_OrderDataInfoImp( const DS_OrderDataInfoImp& rhs ):Table(rhs)
	,OrderID(rhs.OrderID)
	,OrderCate(rhs.OrderCate)
	,FactoryID(rhs.FactoryID)
	,ShopID(rhs.ShopID)
...
DS_OrderDataInfoImp::DS_OrderDataInfoImp( DS_OrderDataInfoImp&& rhs ):Table(rhs)
	,OrderID(std::move(rhs.OrderID))
	,OrderCate(std::move(rhs.OrderCate))
	,FactoryID(std::move(rhs.FactoryID))
...
DS_OrderDataInfoImp	DS_OrderDataInfo("");



void	DS_PackInfoImp::SData::SetAll(bool val)
{
...
void	DS_PackInfoImp::SData::Flip()
{
...
void	DS_PackInfoImp::SData::Check()
{
	if ( !DesignPackID_ )
	{
...
void	DS_PackInfoImp::SData::ToUtf8()
{
}

void	DS_PackInfoImp::SData::ToAscii()
{
}

autoDB::SColumns DS_PackInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns DS_PackInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.DesignPackID_ )
	{
...
DS_PackInfoImp	DS_PackInfoImp::operator() (const StringType& alias)
{
	return std::move(DS_PackInfoImp(alias));
}

DS_PackInfoImp::DS_PackInfoImp( const StringType& alias ):Table(AUTODB_STR("DS_PackInfo"), alias)
...
DS_PackInfoImp::DS_PackInfoImp( const DS_PackInfoImp& rhs ):Table(rhs)
...
DS_PackInfoImp::DS_PackInfoImp( DS_PackInfoImp&& rhs ):Table(rhs)
...
DS_PackInfoImp	DS_PackInfo("");



void	DS_PointInfoImp::SData::SetAll(bool val)
{
	val ? DesignPlanID_.reset(boost::initialized_value) : DesignPlanID_=boost::none;
	val ? OrderCate_.reset(boost::initialized_value) : OrderCate_=boost::none;
	val ? OrderID_.reset(boost::initialized_value) : OrderID_=boost::none;
...
void	DS_PointInfoImp::SData::Flip()
{
	DesignPlanID_ ? DesignPlanID_=boost::none : DesignPlanID_.reset(boost::initialized_value);
	OrderCate_ ? OrderCate_=boost::none : OrderCate_.reset(boost::initialized_value);
	OrderID_ ? OrderID_=boost::none : OrderID_.reset(boost::initialized_value);
...
void	DS_PointInfoImp::SData::Check()
{
	if ( !DesignPlanID_ )
	{
		DesignPlanID_.reset(boost::initialized_value);
...
void	DS_PointInfoImp::SData::ToUtf8()
{
}

void	DS_PointInfoImp::SData::ToAscii()
{
}

autoDB::SColumns DS_PointInfoImp::Use( const SData& data )
{
	SColumns ret;
	if ( data.DesignPlanID_ )
	{
...
autoDB::SColumns DS_PointInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.DesignPlanID_ )
	{
...
DS_PointInfoImp	DS_PointInfoImp::operator() (const StringType& alias)
{
	return std::move(DS_PointInfoImp(alias));
}

DS_PointInfoImp::DS_PointInfoImp( const StringType& alias ):Table(AUTODB_STR("DS_PointInfo"), alias)
	,DesignPlanID(ImpSPtr_,AUTODB_STR("DesignPlanID"))
	,OrderCate(ImpSPtr_,AUTODB_STR("OrderCate"))
	,OrderID(ImpSPtr_,AUTODB_STR("OrderID"))
	,FactoryID(ImpSPtr_,AUTODB_STR("FactoryID"))
...
DS_PointInfoImp::DS_PointInfoImp( const DS_PointInfoImp& rhs ):Table(rhs)
	,DesignPlanID(rhs.DesignPlanID)
	,OrderCate(rhs.OrderCate)
	,OrderID(rhs.OrderID)
	,FactoryID(rhs.FactoryID)
...
DS_PointInfoImp::DS_PointInfoImp( DS_PointInfoImp&& rhs ):Table(rhs)
	,DesignPlanID(std::move(rhs.DesignPlanID))
	,OrderCate(std::move(rhs.OrderCate))
	,OrderID(std::move(rhs.OrderID))
	,FactoryID(std::move(rhs.FactoryID))
...
DS_PointInfoImp	DS_PointInfo("");



void	DS_PrintElementInfoImp::SData::SetAll(bool val)
{
...
void	DS_PrintElementInfoImp::SData::Flip()
{
...
void	DS_PrintElementInfoImp::SData::Check()
{
...
void	DS_PrintElementInfoImp::SData::ToUtf8()
{
}

void	DS_PrintElementInfoImp::SData::ToAscii()
{
}

autoDB::SColumns DS_PrintElementInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns DS_PrintElementInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.DesignPrintElementID_ )
	{
...
DS_PrintElementInfoImp	DS_PrintElementInfoImp::operator() (const StringType& alias)
{
	return std::move(DS_PrintElementInfoImp(alias));
}

DS_PrintElementInfoImp::DS_PrintElementInfoImp( const StringType& alias ):Table(AUTODB_STR("DS_PrintElementInfo"), alias)
...
DS_PrintElementInfoImp::DS_PrintElementInfoImp( const DS_PrintElementInfoImp& rhs ):Table(rhs)
...
DS_PrintElementInfoImp::DS_PrintElementInfoImp( DS_PrintElementInfoImp&& rhs ):Table(rhs)
...
DS_PrintElementInfoImp	DS_PrintElementInfo("");



void	DS_PrintGroupInfoImp::SData::SetAll(bool val)
{
	val ? DesignPrintGroupID_.reset(boost::initialized_value) : DesignPrintGroupID_=boost::none;
	val ? DesignPrintID_.reset(boost::initialized_value) : DesignPrintID_=boost::none;
	val ? OrderCate_.reset(boost::initialized_value) : OrderCate_=boost::none;
...
void	DS_PrintGroupInfoImp::SData::Flip()
{
	DesignPrintGroupID_ ? DesignPrintGroupID_=boost::none : DesignPrintGroupID_.reset(boost::initialized_value);
	DesignPrintID_ ? DesignPrintID_=boost::none : DesignPrintID_.reset(boost::initialized_value);
	OrderCate_ ? OrderCate_=boost::none : OrderCate_.reset(boost::initialized_value);
...
void	DS_PrintGroupInfoImp::SData::Check()
{
	if ( !DesignPrintGroupID_ )
	{
		DesignPrintGroupID_.reset(boost::initialized_value);
...
void	DS_PrintGroupInfoImp::SData::ToUtf8()
{
}

void	DS_PrintGroupInfoImp::SData::ToAscii()
{
}

autoDB::SColumns DS_PrintGroupInfoImp::Use( const SData& data )
{
	SColumns ret;
	if ( data.DesignPrintGroupID_ )
	{
...
autoDB::SColumns DS_PrintGroupInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.DesignPrintGroupID_ )
	{
...
DS_PrintGroupInfoImp	DS_PrintGroupInfoImp::operator() (const StringType& alias)
{
	return std::move(DS_PrintGroupInfoImp(alias));
}

DS_PrintGroupInfoImp::DS_PrintGroupInfoImp( const StringType& alias ):Table(AUTODB_STR("DS_PrintGroupInfo"), alias)
	,DesignPrintGroupID(ImpSPtr_,AUTODB_STR("DesignPrintGroupID"))
	,DesignPrintID(ImpSPtr_,AUTODB_STR("DesignPrintID"))
	,OrderCate(ImpSPtr_,AUTODB_STR("OrderCate"))
	,DesignPlanID(ImpSPtr_,AUTODB_STR("DesignPlanID"))
...
DS_PrintGroupInfoImp::DS_PrintGroupInfoImp( const DS_PrintGroupInfoImp& rhs ):Table(rhs)
	,DesignPrintGroupID(rhs.DesignPrintGroupID)
	,DesignPrintID(rhs.DesignPrintID)
	,OrderCate(rhs.OrderCate)
	,DesignPlanID(rhs.DesignPlanID)
...
DS_PrintGroupInfoImp::DS_PrintGroupInfoImp( DS_PrintGroupInfoImp&& rhs ):Table(rhs)
	,DesignPrintGroupID(std::move(rhs.DesignPrintGroupID))
	,DesignPrintID(std::move(rhs.DesignPrintID))
	,OrderCate(std::move(rhs.OrderCate))
	,DesignPlanID(std::move(rhs.DesignPlanID))
...
DS_PrintGroupInfoImp	DS_PrintGroupInfo("");



void	DS_PrintInfoImp::SData::SetAll(bool val)
{
	val ? DesignPrintID_.reset(boost::initialized_value) : DesignPrintID_=boost::none;
	val ? OrderCate_.reset(boost::initialized_value) : OrderCate_=boost::none;
	val ? DesignPlanID_.reset(boost::initialized_value) : DesignPlanID_=boost::none;
...
void	DS_PrintInfoImp::SData::Flip()
{
	DesignPrintID_ ? DesignPrintID_=boost::none : DesignPrintID_.reset(boost::initialized_value);
	OrderCate_ ? OrderCate_=boost::none : OrderCate_.reset(boost::initialized_value);
	DesignPlanID_ ? DesignPlanID_=boost::none : DesignPlanID_.reset(boost::initialized_value);
...
void	DS_PrintInfoImp::SData::Check()
{
	if ( !DesignPrintID_ )
	{
		DesignPrintID_.reset(boost::initialized_value);
...
void	DS_PrintInfoImp::SData::ToUtf8()
{
	if ( PrintName_ )
	{
...
void	DS_PrintInfoImp::SData::ToAscii()
{
	if ( PrintName_ )
	{
...
autoDB::SColumns DS_PrintInfoImp::Use( const SData& data )
{
	SColumns ret;
	if ( data.DesignPrintID_ )
	{
...
autoDB::SColumns DS_PrintInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.DesignPrintID_ )
	{
...
DS_PrintInfoImp	DS_PrintInfoImp::operator() (const StringType& alias)
{
	return std::move(DS_PrintInfoImp(alias));
}

DS_PrintInfoImp::DS_PrintInfoImp( const StringType& alias ):Table(AUTODB_STR("DS_PrintInfo"), alias)
	,DesignPrintID(ImpSPtr_,AUTODB_STR("DesignPrintID"))
	,OrderCate(ImpSPtr_,AUTODB_STR("OrderCate"))
	,DesignPlanID(ImpSPtr_,AUTODB_STR("DesignPlanID"))
	,OrderID(ImpSPtr_,AUTODB_STR("OrderID"))
...
DS_PrintInfoImp::DS_PrintInfoImp( const DS_PrintInfoImp& rhs ):Table(rhs)
	,DesignPrintID(rhs.DesignPrintID)
	,OrderCate(rhs.OrderCate)
	,DesignPlanID(rhs.DesignPlanID)
	,OrderID(rhs.OrderID)
...
DS_PrintInfoImp::DS_PrintInfoImp( DS_PrintInfoImp&& rhs ):Table(rhs)
	,DesignPrintID(std::move(rhs.DesignPrintID))
	,OrderCate(std::move(rhs.OrderCate))
	,DesignPlanID(std::move(rhs.DesignPlanID))
	,OrderID(std::move(rhs.OrderID))
...
DS_PrintInfoImp	DS_PrintInfo("");



void	DS_PrintTableInfoImp::SData::SetAll(bool val)
{
...
void	DS_PrintTableInfoImp::SData::Flip()
{
...
void	DS_PrintTableInfoImp::SData::Check()
{
...
void	DS_PrintTableInfoImp::SData::ToUtf8()
{
	if ( FaceName_ )
	{
		FaceName_ = boost::locale::conv::to_utf<char>(*FaceName_, "GBK");
...
void	DS_PrintTableInfoImp::SData::ToAscii()
{
	if ( FaceName_ )
	{
		FaceName_ = boost::locale::conv::from_utf(*FaceName_, "GBK");
...
autoDB::SColumns DS_PrintTableInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns DS_PrintTableInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.DesignPrintTableID_ )
	{
...
DS_PrintTableInfoImp	DS_PrintTableInfoImp::operator() (const StringType& alias)
{
	return std::move(DS_PrintTableInfoImp(alias));
}

DS_PrintTableInfoImp::DS_PrintTableInfoImp( const StringType& alias ):Table(AUTODB_STR("DS_PrintTableInfo"), alias)
...
DS_PrintTableInfoImp::DS_PrintTableInfoImp( const DS_PrintTableInfoImp& rhs ):Table(rhs)
...
DS_PrintTableInfoImp::DS_PrintTableInfoImp( DS_PrintTableInfoImp&& rhs ):Table(rhs)
...
DS_PrintTableInfoImp	DS_PrintTableInfo("");



void	DS_PrintTableRowColInfoImp::SData::SetAll(bool val)
{
...
void	DS_PrintTableRowColInfoImp::SData::Flip()
{
...
void	DS_PrintTableRowColInfoImp::SData::Check()
{
...
void	DS_PrintTableRowColInfoImp::SData::ToUtf8()
{
	if ( FaceName_ )
	{
		FaceName_ = boost::locale::conv::to_utf<char>(*FaceName_, "GBK");
...
void	DS_PrintTableRowColInfoImp::SData::ToAscii()
{
	if ( FaceName_ )
	{
		FaceName_ = boost::locale::conv::from_utf(*FaceName_, "GBK");
...
autoDB::SColumns DS_PrintTableRowColInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns DS_PrintTableRowColInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.DesignPrintTableRowColID_ )
	{
...
DS_PrintTableRowColInfoImp	DS_PrintTableRowColInfoImp::operator() (const StringType& alias)
{
	return std::move(DS_PrintTableRowColInfoImp(alias));
}

DS_PrintTableRowColInfoImp::DS_PrintTableRowColInfoImp( const StringType& alias ):Table(AUTODB_STR("DS_PrintTableRowColInfo"), alias)
...
DS_PrintTableRowColInfoImp::DS_PrintTableRowColInfoImp( const DS_PrintTableRowColInfoImp& rhs ):Table(rhs)
...
DS_PrintTableRowColInfoImp::DS_PrintTableRowColInfoImp( DS_PrintTableRowColInfoImp&& rhs ):Table(rhs)
...
DS_PrintTableRowColInfoImp	DS_PrintTableRowColInfo("");



void	DS_PrintTableRowInfoImp::SData::SetAll(bool val)
{
	val ? DesignPrintTableRowID_.reset(boost::initialized_value) : DesignPrintTableRowID_=boost::none;
	val ? DesignPrintTableID_.reset(boost::initialized_value) : DesignPrintTableID_=boost::none;
	val ? OrderCate_.reset(boost::initialized_value) : OrderCate_=boost::none;
...
void	DS_PrintTableRowInfoImp::SData::Flip()
{
	DesignPrintTableRowID_ ? DesignPrintTableRowID_=boost::none : DesignPrintTableRowID_.reset(boost::initialized_value);
	DesignPrintTableID_ ? DesignPrintTableID_=boost::none : DesignPrintTableID_.reset(boost::initialized_value);
	OrderCate_ ? OrderCate_=boost::none : OrderCate_.reset(boost::initialized_value);
...
void	DS_PrintTableRowInfoImp::SData::Check()
{
	if ( !DesignPrintTableRowID_ )
	{
		DesignPrintTableRowID_.reset(boost::initialized_value);
...
void	DS_PrintTableRowInfoImp::SData::ToUtf8()
{
	if ( FaceName_ )
	{
		FaceName_ = boost::locale::conv::to_utf<char>(*FaceName_, "GBK");
...
void	DS_PrintTableRowInfoImp::SData::ToAscii()
{
	if ( FaceName_ )
	{
		FaceName_ = boost::locale::conv::from_utf(*FaceName_, "GBK");
...
autoDB::SColumns DS_PrintTableRowInfoImp::Use( const SData& data )
{
	SColumns ret;
	if ( data.DesignPrintTableRowID_ )
	{
...
autoDB::SColumns DS_PrintTableRowInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.DesignPrintTableRowID_ )
	{
...
DS_PrintTableRowInfoImp	DS_PrintTableRowInfoImp::operator() (const StringType& alias)
{
	return std::move(DS_PrintTableRowInfoImp(alias));
}

DS_PrintTableRowInfoImp::DS_PrintTableRowInfoImp( const StringType& alias ):Table(AUTODB_STR("DS_PrintTableRowInfo"), alias)
	,DesignPrintTableRowID(ImpSPtr_,AUTODB_STR("DesignPrintTableRowID"))
	,DesignPrintTableID(ImpSPtr_,AUTODB_STR("DesignPrintTableID"))
	,OrderCate(ImpSPtr_,AUTODB_STR("OrderCate"))
	,OrderID(ImpSPtr_,AUTODB_STR("OrderID"))
...
DS_PrintTableRowInfoImp::DS_PrintTableRowInfoImp( const DS_PrintTableRowInfoImp& rhs ):Table(rhs)
	,DesignPrintTableRowID(rhs.DesignPrintTableRowID)
	,DesignPrintTableID(rhs.DesignPrintTableID)
	,OrderCate(rhs.OrderCate)
	,OrderID(rhs.OrderID)
...
DS_PrintTableRowInfoImp::DS_PrintTableRowInfoImp( DS_PrintTableRowInfoImp&& rhs ):Table(rhs)
	,DesignPrintTableRowID(std::move(rhs.DesignPrintTableRowID))
	,DesignPrintTableID(std::move(rhs.DesignPrintTableID))
	,OrderCate(std::move(rhs.OrderCate))
	,OrderID(std::move(rhs.OrderID))
...
DS_PrintTableRowInfoImp	DS_PrintTableRowInfo("");



void	DS_ProductInfoImp::SData::SetAll(bool val)
{
...
void	DS_ProductInfoImp::SData::Flip()
{
...
void	DS_ProductInfoImp::SData::Check()
{
	if ( !DesignProductID_ )
	{
...
void	DS_ProductInfoImp::SData::ToUtf8()
{
}

void	DS_ProductInfoImp::SData::ToAscii()
{
}

autoDB::SColumns DS_ProductInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns DS_ProductInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.DesignProductID_ )
	{
...
DS_ProductInfoImp	DS_ProductInfoImp::operator() (const StringType& alias)
{
	return std::move(DS_ProductInfoImp(alias));
}

DS_ProductInfoImp::DS_ProductInfoImp( const StringType& alias ):Table(AUTODB_STR("DS_ProductInfo"), alias)
...
DS_ProductInfoImp::DS_ProductInfoImp( const DS_ProductInfoImp& rhs ):Table(rhs)
...
DS_ProductInfoImp::DS_ProductInfoImp( DS_ProductInfoImp&& rhs ):Table(rhs)
...
DS_ProductInfoImp	DS_ProductInfo("");



void	DS_RemarkInfoImp::SData::SetAll(bool val)
{
...
void	DS_RemarkInfoImp::SData::Flip()
{
...
void	DS_RemarkInfoImp::SData::Check()
{
	if ( !DesignRemarkID_ )
	{
...
void	DS_RemarkInfoImp::SData::ToUtf8()
{
	if ( FaceName_ )
	{
		FaceName_ = boost::locale::conv::to_utf<char>(*FaceName_, "GBK");
...
void	DS_RemarkInfoImp::SData::ToAscii()
{
	if ( FaceName_ )
	{
		FaceName_ = boost::locale::conv::from_utf(*FaceName_, "GBK");
...
autoDB::SColumns DS_RemarkInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns DS_RemarkInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.DesignRemarkID_ )
	{
...
DS_RemarkInfoImp	DS_RemarkInfoImp::operator() (const StringType& alias)
{
	return std::move(DS_RemarkInfoImp(alias));
}

DS_RemarkInfoImp::DS_RemarkInfoImp( const StringType& alias ):Table(AUTODB_STR("DS_RemarkInfo"), alias)
...
DS_RemarkInfoImp::DS_RemarkInfoImp( const DS_RemarkInfoImp& rhs ):Table(rhs)
...
DS_RemarkInfoImp::DS_RemarkInfoImp( DS_RemarkInfoImp&& rhs ):Table(rhs)
...
DS_RemarkInfoImp	DS_RemarkInfo("");



void	DS_ShapeInfoImp::SData::SetAll(bool val)
{
...
void	DS_ShapeInfoImp::SData::Flip()
{
...
void	DS_ShapeInfoImp::SData::Check()
{
	if ( !DesignShapeID_ )
	{
...
void	DS_ShapeInfoImp::SData::ToUtf8()
{
	if ( AttachFilePath_ )
	{
		AttachFilePath_ = boost::locale::conv::to_utf<char>(*AttachFilePath_, "GBK");
...
void	DS_ShapeInfoImp::SData::ToAscii()
{
	if ( AttachFilePath_ )
	{
		AttachFilePath_ = boost::locale::conv::from_utf(*AttachFilePath_, "GBK");
...
autoDB::SColumns DS_ShapeInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns DS_ShapeInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.DesignShapeID_ )
	{
...
DS_ShapeInfoImp	DS_ShapeInfoImp::operator() (const StringType& alias)
{
	return std::move(DS_ShapeInfoImp(alias));
}

DS_ShapeInfoImp::DS_ShapeInfoImp( const StringType& alias ):Table(AUTODB_STR("DS_ShapeInfo"), alias)
...
DS_ShapeInfoImp::DS_ShapeInfoImp( const DS_ShapeInfoImp& rhs ):Table(rhs)
...
DS_ShapeInfoImp::DS_ShapeInfoImp( DS_ShapeInfoImp&& rhs ):Table(rhs)
...
DS_ShapeInfoImp	DS_ShapeInfo("");



void	DS_SkinInfoImp::SData::SetAll(bool val)
{
...
void	DS_SkinInfoImp::SData::Flip()
{
...
void	DS_SkinInfoImp::SData::Check()
{
	if ( !DesignSkinID_ )
	{
...
void	DS_SkinInfoImp::SData::ToUtf8()
{
}

void	DS_SkinInfoImp::SData::ToAscii()
{
}

autoDB::SColumns DS_SkinInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns DS_SkinInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.DesignSkinID_ )
	{
...
DS_SkinInfoImp	DS_SkinInfoImp::operator() (const StringType& alias)
{
	return std::move(DS_SkinInfoImp(alias));
}

DS_SkinInfoImp::DS_SkinInfoImp( const StringType& alias ):Table(AUTODB_STR("DS_SkinInfo"), alias)
...
DS_SkinInfoImp::DS_SkinInfoImp( const DS_SkinInfoImp& rhs ):Table(rhs)
...
DS_SkinInfoImp::DS_SkinInfoImp( DS_SkinInfoImp&& rhs ):Table(rhs)
...
DS_SkinInfoImp	DS_SkinInfo("");



void	DS_TableInfoImp::SData::SetAll(bool val)
{
...
void	DS_TableInfoImp::SData::Flip()
{
...
void	DS_TableInfoImp::SData::Check()
{
	if ( !DesignTableID_ )
	{
...
void	DS_TableInfoImp::SData::ToUtf8()
{
}

void	DS_TableInfoImp::SData::ToAscii()
{
}

autoDB::SColumns DS_TableInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns DS_TableInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.DesignTableID_ )
	{
...
DS_TableInfoImp	DS_TableInfoImp::operator() (const StringType& alias)
{
	return std::move(DS_TableInfoImp(alias));
}

DS_TableInfoImp::DS_TableInfoImp( const StringType& alias ):Table(AUTODB_STR("DS_TableInfo"), alias)
...
DS_TableInfoImp::DS_TableInfoImp( const DS_TableInfoImp& rhs ):Table(rhs)
...
DS_TableInfoImp::DS_TableInfoImp( DS_TableInfoImp&& rhs ):Table(rhs)
...
DS_TableInfoImp	DS_TableInfo("");



void	DS_TablePartInfoImp::SData::SetAll(bool val)
{
...
void	DS_TablePartInfoImp::SData::Flip()
{
...
void	DS_TablePartInfoImp::SData::Check()
{
...
void	DS_TablePartInfoImp::SData::ToUtf8()
{
}

void	DS_TablePartInfoImp::SData::ToAscii()
{
}

autoDB::SColumns DS_TablePartInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns DS_TablePartInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.DesignTablePartID_ )
	{
...
DS_TablePartInfoImp	DS_TablePartInfoImp::operator() (const StringType& alias)
{
	return std::move(DS_TablePartInfoImp(alias));
}

DS_TablePartInfoImp::DS_TablePartInfoImp( const StringType& alias ):Table(AUTODB_STR("DS_TablePartInfo"), alias)
...
DS_TablePartInfoImp::DS_TablePartInfoImp( const DS_TablePartInfoImp& rhs ):Table(rhs)
...
DS_TablePartInfoImp::DS_TablePartInfoImp( DS_TablePartInfoImp&& rhs ):Table(rhs)
...
DS_TablePartInfoImp	DS_TablePartInfo("");



void	DS_TableSideInfoImp::SData::SetAll(bool val)
{
...
void	DS_TableSideInfoImp::SData::Flip()
{
...
void	DS_TableSideInfoImp::SData::Check()
{
...
void	DS_TableSideInfoImp::SData::ToUtf8()
{
}

void	DS_TableSideInfoImp::SData::ToAscii()
{
}

autoDB::SColumns DS_TableSideInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns DS_TableSideInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.DesignTableSideID_ )
	{
...
DS_TableSideInfoImp	DS_TableSideInfoImp::operator() (const StringType& alias)
{
	return std::move(DS_TableSideInfoImp(alias));
}

DS_TableSideInfoImp::DS_TableSideInfoImp( const StringType& alias ):Table(AUTODB_STR("DS_TableSideInfo"), alias)
...
DS_TableSideInfoImp::DS_TableSideInfoImp( const DS_TableSideInfoImp& rhs ):Table(rhs)
...
DS_TableSideInfoImp::DS_TableSideInfoImp( DS_TableSideInfoImp&& rhs ):Table(rhs)
...
DS_TableSideInfoImp	DS_TableSideInfo("");



void	DS_WallDecorInfoImp::SData::SetAll(bool val)
{
...
void	DS_WallDecorInfoImp::SData::Flip()
{
...
void	DS_WallDecorInfoImp::SData::Check()
{
...
void	DS_WallDecorInfoImp::SData::ToUtf8()
{
}

void	DS_WallDecorInfoImp::SData::ToAscii()
{
}

autoDB::SColumns DS_WallDecorInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns DS_WallDecorInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.DesignWallDecorID_ )
	{
...
DS_WallDecorInfoImp	DS_WallDecorInfoImp::operator() (const StringType& alias)
{
	return std::move(DS_WallDecorInfoImp(alias));
}

DS_WallDecorInfoImp::DS_WallDecorInfoImp( const StringType& alias ):Table(AUTODB_STR("DS_WallDecorInfo"), alias)
...
DS_WallDecorInfoImp::DS_WallDecorInfoImp( const DS_WallDecorInfoImp& rhs ):Table(rhs)
...
DS_WallDecorInfoImp::DS_WallDecorInfoImp( DS_WallDecorInfoImp&& rhs ):Table(rhs)
...
DS_WallDecorInfoImp	DS_WallDecorInfo("");



void	DS_WallInfoImp::SData::SetAll(bool val)
{
	val ? DesignWallID_.reset(boost::initialized_value) : DesignWallID_=boost::none;
	val ? DesignPlanID_.reset(boost::initialized_value) : DesignPlanID_=boost::none;
	val ? OrderCate_.reset(boost::initialized_value) : OrderCate_=boost::none;
...
void	DS_WallInfoImp::SData::Flip()
{
	DesignWallID_ ? DesignWallID_=boost::none : DesignWallID_.reset(boost::initialized_value);
	DesignPlanID_ ? DesignPlanID_=boost::none : DesignPlanID_.reset(boost::initialized_value);
	OrderCate_ ? OrderCate_=boost::none : OrderCate_.reset(boost::initialized_value);
...
void	DS_WallInfoImp::SData::Check()
{
	if ( !DesignWallID_ )
	{
		DesignWallID_.reset(boost::initialized_value);
...
void	DS_WallInfoImp::SData::ToUtf8()
{
}

void	DS_WallInfoImp::SData::ToAscii()
{
}

autoDB::SColumns DS_WallInfoImp::Use( const SData& data )
{
	SColumns ret;
	if ( data.DesignWallID_ )
	{
...
autoDB::SColumns DS_WallInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.DesignWallID_ )
	{
...
DS_WallInfoImp	DS_WallInfoImp::operator() (const StringType& alias)
{
	return std::move(DS_WallInfoImp(alias));
}

DS_WallInfoImp::DS_WallInfoImp( const StringType& alias ):Table(AUTODB_STR("DS_WallInfo"), alias)
	,DesignWallID(ImpSPtr_,AUTODB_STR("DesignWallID"))
	,DesignPlanID(ImpSPtr_,AUTODB_STR("DesignPlanID"))
	,OrderCate(ImpSPtr_,AUTODB_STR("OrderCate"))
	,OrderID(ImpSPtr_,AUTODB_STR("OrderID"))
...
DS_WallInfoImp::DS_WallInfoImp( const DS_WallInfoImp& rhs ):Table(rhs)
	,DesignWallID(rhs.DesignWallID)
	,DesignPlanID(rhs.DesignPlanID)
	,OrderCate(rhs.OrderCate)
	,OrderID(rhs.OrderID)
...
DS_WallInfoImp::DS_WallInfoImp( DS_WallInfoImp&& rhs ):Table(rhs)
	,DesignWallID(std::move(rhs.DesignWallID))
	,DesignPlanID(std::move(rhs.DesignPlanID))
	,OrderCate(std::move(rhs.OrderCate))
	,OrderID(std::move(rhs.OrderID))
