...
namespace autoDB
{
void	LS_BoardGapInfoImp::SData::SetAll(bool val)
{
...
void	LS_BoardGapInfoImp::SData::Flip()
{
...
void	LS_BoardGapInfoImp::SData::Check()
{
	if ( !ItemID_ )
	{
...
void	LS_BoardGapInfoImp::SData::ToUtf8()
{
	if ( OrderCode_ )
	{
...
void	LS_BoardGapInfoImp::SData::ToAscii()
{
	if ( OrderCode_ )
	{
...
autoDB::SColumns LS_BoardGapInfoImp::Use( const SData& data )
{
	SColumns ret;
	if ( data.ItemID_ )
	{
...
autoDB::SColumns LS_BoardGapInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.ItemID_ )
	{
...
LS_BoardGapInfoImp	LS_BoardGapInfoImp::operator() (const StringType& alias)
{
	return std::move(LS_BoardGapInfoImp(alias));
}

LS_BoardGapInfoImp::LS_BoardGapInfoImp( const StringType& alias ):Table(AUTODB_STR("LS_BoardGapInfo"), alias)
...
LS_BoardGapInfoImp::LS_BoardGapInfoImp( const LS_BoardGapInfoImp& rhs ):Table(rhs)
	,ItemID(rhs.ItemID)
...
LS_BoardGapInfoImp::LS_BoardGapInfoImp( LS_BoardGapInfoImp&& rhs ):Table(rhs)
...
LS_BoardGapInfoImp	LS_BoardGapInfo("");



void	LS_BoardInfoImp::SData::SetAll(bool val)
{
	val ? ItemID_.reset(boost::initialized_value) : ItemID_=boost::none;
	val ? OrderCate_.reset(boost::initialized_value) : OrderCate_=boost::none;
	val ? OrderID_.reset(boost::initialized_value) : OrderID_=boost::none;
...
void	LS_BoardInfoImp::SData::Flip()
{
	ItemID_ ? ItemID_=boost::none : ItemID_.reset(boost::initialized_value);
	OrderCate_ ? OrderCate_=boost::none : OrderCate_.reset(boost::initialized_value);
	OrderID_ ? OrderID_=boost::none : OrderID_.reset(boost::initialized_value);
...
void	LS_BoardInfoImp::SData::Check()
{
	if ( !ItemID_ )
	{
		ItemID_.reset(boost::initialized_value);
...
void	LS_BoardInfoImp::SData::ToUtf8()
{
	if ( OrderCode_ )
	{
		OrderCode_ = boost::locale::conv::to_utf<char>(*OrderCode_, "GBK");
...
void	LS_BoardInfoImp::SData::ToAscii()
{
	if ( OrderCode_ )
	{
		OrderCode_ = boost::locale::conv::from_utf(*OrderCode_, "GBK");
...
autoDB::SColumns LS_BoardInfoImp::Use( const SData& data )
{
	SColumns ret;
	if ( data.ItemID_ )
	{
...
autoDB::SColumns LS_BoardInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.ItemID_ )
	{
...
LS_BoardInfoImp	LS_BoardInfoImp::operator() (const StringType& alias)
{
	return std::move(LS_BoardInfoImp(alias));
}

LS_BoardInfoImp::LS_BoardInfoImp( const StringType& alias ):Table(AUTODB_STR("LS_BoardInfo"), alias)
	,ItemID(ImpSPtr_,AUTODB_STR("ItemID"))
	,OrderCate(ImpSPtr_,AUTODB_STR("OrderCate"))
	,OrderID(ImpSPtr_,AUTODB_STR("OrderID"))
	,FactoryID(ImpSPtr_,AUTODB_STR("FactoryID"))
...
LS_BoardInfoImp::LS_BoardInfoImp( const LS_BoardInfoImp& rhs ):Table(rhs)
	,ItemID(rhs.ItemID)
	,OrderCate(rhs.OrderCate)
	,OrderID(rhs.OrderID)
	,FactoryID(rhs.FactoryID)
...
LS_BoardInfoImp::LS_BoardInfoImp( LS_BoardInfoImp&& rhs ):Table(rhs)
	,ItemID(std::move(rhs.ItemID))
	,OrderCate(std::move(rhs.OrderCate))
	,OrderID(std::move(rhs.OrderID))
	,FactoryID(std::move(rhs.FactoryID))
...
LS_BoardInfoImp	LS_BoardInfo("");



void	LS_BoardSealInfoImp::SData::SetAll(bool val)
{
	val ? ItemID_.reset(boost::initialized_value) : ItemID_=boost::none;
	val ? OrderCate_.reset(boost::initialized_value) : OrderCate_=boost::none;
	val ? OrderID_.reset(boost::initialized_value) : OrderID_=boost::none;
...
void	LS_BoardSealInfoImp::SData::Flip()
{
	ItemID_ ? ItemID_=boost::none : ItemID_.reset(boost::initialized_value);
	OrderCate_ ? OrderCate_=boost::none : OrderCate_.reset(boost::initialized_value);
	OrderID_ ? OrderID_=boost::none : OrderID_.reset(boost::initialized_value);
...
void	LS_BoardSealInfoImp::SData::Check()
{
	if ( !ItemID_ )
	{
		ItemID_.reset(boost::initialized_value);
...
void	LS_BoardSealInfoImp::SData::ToUtf8()
{
	if ( OrderCode_ )
	{
		OrderCode_ = boost::locale::conv::to_utf<char>(*OrderCode_, "GBK");
...
void	LS_BoardSealInfoImp::SData::ToAscii()
{
	if ( OrderCode_ )
	{
		OrderCode_ = boost::locale::conv::from_utf(*OrderCode_, "GBK");
...
autoDB::SColumns LS_BoardSealInfoImp::Use( const SData& data )
{
	SColumns ret;
	if ( data.ItemID_ )
	{
...
autoDB::SColumns LS_BoardSealInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.ItemID_ )
	{
...
LS_BoardSealInfoImp	LS_BoardSealInfoImp::operator() (const StringType& alias)
{
	return std::move(LS_BoardSealInfoImp(alias));
}

LS_BoardSealInfoImp::LS_BoardSealInfoImp( const StringType& alias ):Table(AUTODB_STR("LS_BoardSealInfo"), alias)
	,ItemID(ImpSPtr_,AUTODB_STR("ItemID"))
	,OrderCate(ImpSPtr_,AUTODB_STR("OrderCate"))
	,OrderID(ImpSPtr_,AUTODB_STR("OrderID"))
	,FactoryID(ImpSPtr_,AUTODB_STR("FactoryID"))
...
LS_BoardSealInfoImp::LS_BoardSealInfoImp( const LS_BoardSealInfoImp& rhs ):Table(rhs)
	,ItemID(rhs.ItemID)
	,OrderCate(rhs.OrderCate)
	,OrderID(rhs.OrderID)
	,FactoryID(rhs.FactoryID)
...
LS_BoardSealInfoImp::LS_BoardSealInfoImp( LS_BoardSealInfoImp&& rhs ):Table(rhs)
	,ItemID(std::move(rhs.ItemID))
	,OrderCate(std::move(rhs.OrderCate))
	,OrderID(std::move(rhs.OrderID))
	,FactoryID(std::move(rhs.FactoryID))
...
LS_BoardSealInfoImp	LS_BoardSealInfo("");



void	LS_ObjectsImp::SData::SetAll(bool val)
{
	val ? ItemID_.reset(boost::initialized_value) : ItemID_=boost::none;
	val ? OrderCate_.reset(boost::initialized_value) : OrderCate_=boost::none;
	val ? OrderID_.reset(boost::initialized_value) : OrderID_=boost::none;
...
void	LS_ObjectsImp::SData::Check()
{
	if ( !ItemID_ )
	{
		ItemID_.reset(boost::initialized_value);
...
void	LS_ObjectsImp::SData::ToUtf8()
{
	if ( OrderCode_ )
	{
		OrderCode_ = boost::locale::conv::to_utf<char>(*OrderCode_, "GBK");
...
void	LS_ObjectsImp::SData::ToAscii()
{
	if ( OrderCode_ )
	{
		OrderCode_ = boost::locale::conv::from_utf(*OrderCode_, "GBK");
...
autoDB::SColumns LS_ObjectsImp::Use( const SData& data )
{
	SColumns ret;
	if ( data.ItemID_ )
	{
...
autoDB::SColumns LS_ObjectsImp::Into( SData& data )
{
	SColumns ret;
	if ( data.ItemID_ )
	{
...
LS_ObjectsImp	LS_ObjectsImp::operator() (const StringType& alias)
{
	return std::move(LS_ObjectsImp(alias));
}

LS_ObjectsImp::LS_ObjectsImp( const StringType& alias ):Table(AUTODB_STR("LS_Objects"), alias)
	,ItemID(ImpSPtr_,AUTODB_STR("ItemID"))
	,OrderCate(ImpSPtr_,AUTODB_STR("OrderCate"))
	,OrderID(ImpSPtr_,AUTODB_STR("OrderID"))
	,FactoryID(ImpSPtr_,AUTODB_STR("FactoryID"))
...
LS_ObjectsImp::LS_ObjectsImp( const LS_ObjectsImp& rhs ):Table(rhs)
	,ItemID(rhs.ItemID)
	,OrderCate(rhs.OrderCate)
	,OrderID(rhs.OrderID)
	,FactoryID(rhs.FactoryID)
...
LS_ObjectsImp::LS_ObjectsImp( LS_ObjectsImp&& rhs ):Table(rhs)
	,ItemID(std::move(rhs.ItemID))
	,OrderCate(std::move(rhs.OrderCate))
	,OrderID(std::move(rhs.OrderID))
	,FactoryID(std::move(rhs.FactoryID))
...
LS_ObjectsImp	LS_Objects("");



void	LS_OrderInfoImp::SData::SetAll(bool val)
{
	val ? ItemID_.reset(boost::initialized_value) : ItemID_=boost::none;
	val ? OrderCate_.reset(boost::initialized_value) : OrderCate_=boost::none;
	val ? OrderID_.reset(boost::initialized_value) : OrderID_=boost::none;
...
void	LS_OrderInfoImp::SData::Flip()
{
	ItemID_ ? ItemID_=boost::none : ItemID_.reset(boost::initialized_value);
	OrderCate_ ? OrderCate_=boost::none : OrderCate_.reset(boost::initialized_value);
	OrderID_ ? OrderID_=boost::none : OrderID_.reset(boost::initialized_value);
...
void	LS_OrderInfoImp::SData::Check()
{
	if ( !ItemID_ )
	{
		ItemID_.reset(boost::initialized_value);
...
void	LS_OrderInfoImp::SData::ToUtf8()
{
	if ( ShopName_ )
	{
...
void	LS_OrderInfoImp::SData::ToAscii()
{
	if ( ShopName_ )
	{
...
autoDB::SColumns LS_OrderInfoImp::Use( const SData& data )
{
	SColumns ret;
	if ( data.ItemID_ )
	{
...
autoDB::SColumns LS_OrderInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.ItemID_ )
	{
...
LS_OrderInfoImp	LS_OrderInfoImp::operator() (const StringType& alias)
{
	return std::move(LS_OrderInfoImp(alias));
}

LS_OrderInfoImp::LS_OrderInfoImp( const StringType& alias ):Table(AUTODB_STR("LS_OrderInfo"), alias)
	,ItemID(ImpSPtr_,AUTODB_STR("ItemID"))
	,OrderCate(ImpSPtr_,AUTODB_STR("OrderCate"))
	,OrderID(ImpSPtr_,AUTODB_STR("OrderID"))
	,ParentID(ImpSPtr_,AUTODB_STR("ParentID"))
...
LS_OrderInfoImp::LS_OrderInfoImp( const LS_OrderInfoImp& rhs ):Table(rhs)
	,ItemID(rhs.ItemID)
	,OrderCate(rhs.OrderCate)
	,OrderID(rhs.OrderID)
	,ParentID(rhs.ParentID)
...
LS_OrderInfoImp::LS_OrderInfoImp( LS_OrderInfoImp&& rhs ):Table(rhs)
	,ItemID(std::move(rhs.ItemID))
	,OrderCate(std::move(rhs.OrderCate))
	,OrderID(std::move(rhs.OrderID))
	,ParentID(std::move(rhs.ParentID))
