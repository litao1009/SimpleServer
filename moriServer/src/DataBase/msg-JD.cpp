...
namespace autoDB
{
void	JD_BoardGapInfoImp::SData::SetAll(bool val)
{
...
void	JD_BoardGapInfoImp::SData::Flip()
{
...
void	JD_BoardGapInfoImp::SData::Check()
{
	if ( !ItemID_ )
	{
...
void	JD_BoardGapInfoImp::SData::ToUtf8()
{
	if ( OrderCode_ )
	{
...
void	JD_BoardGapInfoImp::SData::ToAscii()
{
	if ( OrderCode_ )
	{
...
autoDB::SColumns JD_BoardGapInfoImp::Use( const SData& data )
{
	SColumns ret;
	if ( data.ItemID_ )
	{
...
autoDB::SColumns JD_BoardGapInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.ItemID_ )
	{
...
JD_BoardGapInfoImp	JD_BoardGapInfoImp::operator() (const StringType& alias)
{
	return std::move(JD_BoardGapInfoImp(alias));
}

JD_BoardGapInfoImp::JD_BoardGapInfoImp( const StringType& alias ):Table(AUTODB_STR("JD_BoardGapInfo"), alias)
...
JD_BoardGapInfoImp::JD_BoardGapInfoImp( const JD_BoardGapInfoImp& rhs ):Table(rhs)
	,ItemID(rhs.ItemID)
...
JD_BoardGapInfoImp::JD_BoardGapInfoImp( JD_BoardGapInfoImp&& rhs ):Table(rhs)
...
JD_BoardGapInfoImp	JD_BoardGapInfo("");



void	JD_BoardInfoImp::SData::SetAll(bool val)
{
	val ? ItemID_.reset(boost::initialized_value) : ItemID_=boost::none;
	val ? OrderCate_.reset(boost::initialized_value) : OrderCate_=boost::none;
	val ? OrderID_.reset(boost::initialized_value) : OrderID_=boost::none;
...
void	JD_BoardInfoImp::SData::Flip()
{
	ItemID_ ? ItemID_=boost::none : ItemID_.reset(boost::initialized_value);
	OrderCate_ ? OrderCate_=boost::none : OrderCate_.reset(boost::initialized_value);
	OrderID_ ? OrderID_=boost::none : OrderID_.reset(boost::initialized_value);
...
void	JD_BoardInfoImp::SData::Check()
{
	if ( !ItemID_ )
	{
		ItemID_.reset(boost::initialized_value);
...
void	JD_BoardInfoImp::SData::ToUtf8()
{
	if ( OrderCode_ )
	{
		OrderCode_ = boost::locale::conv::to_utf<char>(*OrderCode_, "GBK");
...
void	JD_BoardInfoImp::SData::ToAscii()
{
	if ( OrderCode_ )
	{
		OrderCode_ = boost::locale::conv::from_utf(*OrderCode_, "GBK");
...
autoDB::SColumns JD_BoardInfoImp::Use( const SData& data )
{
	SColumns ret;
	if ( data.ItemID_ )
	{
...
autoDB::SColumns JD_BoardInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.ItemID_ )
	{
...
JD_BoardInfoImp	JD_BoardInfoImp::operator() (const StringType& alias)
{
	return std::move(JD_BoardInfoImp(alias));
}

JD_BoardInfoImp::JD_BoardInfoImp( const StringType& alias ):Table(AUTODB_STR("JD_BoardInfo"), alias)
	,ItemID(ImpSPtr_,AUTODB_STR("ItemID"))
	,OrderCate(ImpSPtr_,AUTODB_STR("OrderCate"))
	,OrderID(ImpSPtr_,AUTODB_STR("OrderID"))
	,FactoryID(ImpSPtr_,AUTODB_STR("FactoryID"))
...
JD_BoardInfoImp::JD_BoardInfoImp( const JD_BoardInfoImp& rhs ):Table(rhs)
	,ItemID(rhs.ItemID)
	,OrderCate(rhs.OrderCate)
	,OrderID(rhs.OrderID)
	,FactoryID(rhs.FactoryID)
...
JD_BoardInfoImp::JD_BoardInfoImp( JD_BoardInfoImp&& rhs ):Table(rhs)
	,ItemID(std::move(rhs.ItemID))
	,OrderCate(std::move(rhs.OrderCate))
	,OrderID(std::move(rhs.OrderID))
	,FactoryID(std::move(rhs.FactoryID))
...
JD_BoardInfoImp	JD_BoardInfo("");



void	JD_BoardSealInfoImp::SData::SetAll(bool val)
{
	val ? ItemID_.reset(boost::initialized_value) : ItemID_=boost::none;
	val ? OrderCate_.reset(boost::initialized_value) : OrderCate_=boost::none;
	val ? OrderID_.reset(boost::initialized_value) : OrderID_=boost::none;
...
void	JD_BoardSealInfoImp::SData::Flip()
{
	ItemID_ ? ItemID_=boost::none : ItemID_.reset(boost::initialized_value);
	OrderCate_ ? OrderCate_=boost::none : OrderCate_.reset(boost::initialized_value);
	OrderID_ ? OrderID_=boost::none : OrderID_.reset(boost::initialized_value);
...
void	JD_BoardSealInfoImp::SData::Check()
{
	if ( !ItemID_ )
	{
		ItemID_.reset(boost::initialized_value);
...
void	JD_BoardSealInfoImp::SData::ToUtf8()
{
	if ( OrderCode_ )
	{
		OrderCode_ = boost::locale::conv::to_utf<char>(*OrderCode_, "GBK");
...
void	JD_BoardSealInfoImp::SData::ToAscii()
{
	if ( OrderCode_ )
	{
		OrderCode_ = boost::locale::conv::from_utf(*OrderCode_, "GBK");
...
autoDB::SColumns JD_BoardSealInfoImp::Use( const SData& data )
{
	SColumns ret;
	if ( data.ItemID_ )
	{
...
autoDB::SColumns JD_BoardSealInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.ItemID_ )
	{
...
JD_BoardSealInfoImp	JD_BoardSealInfoImp::operator() (const StringType& alias)
{
	return std::move(JD_BoardSealInfoImp(alias));
}

JD_BoardSealInfoImp::JD_BoardSealInfoImp( const StringType& alias ):Table(AUTODB_STR("JD_BoardSealInfo"), alias)
	,ItemID(ImpSPtr_,AUTODB_STR("ItemID"))
	,OrderCate(ImpSPtr_,AUTODB_STR("OrderCate"))
	,OrderID(ImpSPtr_,AUTODB_STR("OrderID"))
	,FactoryID(ImpSPtr_,AUTODB_STR("FactoryID"))
...
JD_BoardSealInfoImp::JD_BoardSealInfoImp( const JD_BoardSealInfoImp& rhs ):Table(rhs)
	,ItemID(rhs.ItemID)
	,OrderCate(rhs.OrderCate)
	,OrderID(rhs.OrderID)
	,FactoryID(rhs.FactoryID)
...
JD_BoardSealInfoImp::JD_BoardSealInfoImp( JD_BoardSealInfoImp&& rhs ):Table(rhs)
	,ItemID(std::move(rhs.ItemID))
	,OrderCate(std::move(rhs.OrderCate))
	,OrderID(std::move(rhs.OrderID))
	,FactoryID(std::move(rhs.FactoryID))
...
JD_BoardSealInfoImp	JD_BoardSealInfo("");



void	JD_ObjectsImp::SData::SetAll(bool val)
{
	val ? ItemID_.reset(boost::initialized_value) : ItemID_=boost::none;
	val ? OrderCate_.reset(boost::initialized_value) : OrderCate_=boost::none;
	val ? OrderID_.reset(boost::initialized_value) : OrderID_=boost::none;
...
void	JD_ObjectsImp::SData::Check()
{
	if ( !ItemID_ )
	{
		ItemID_.reset(boost::initialized_value);
...
void	JD_ObjectsImp::SData::ToUtf8()
{
	if ( OrderCode_ )
	{
		OrderCode_ = boost::locale::conv::to_utf<char>(*OrderCode_, "GBK");
...
void	JD_ObjectsImp::SData::ToAscii()
{
	if ( OrderCode_ )
	{
		OrderCode_ = boost::locale::conv::from_utf(*OrderCode_, "GBK");
...
autoDB::SColumns JD_ObjectsImp::Use( const SData& data )
{
	SColumns ret;
	if ( data.ItemID_ )
	{
...
autoDB::SColumns JD_ObjectsImp::Into( SData& data )
{
	SColumns ret;
	if ( data.ItemID_ )
	{
...
JD_ObjectsImp	JD_ObjectsImp::operator() (const StringType& alias)
{
	return std::move(JD_ObjectsImp(alias));
}

JD_ObjectsImp::JD_ObjectsImp( const StringType& alias ):Table(AUTODB_STR("JD_Objects"), alias)
	,ItemID(ImpSPtr_,AUTODB_STR("ItemID"))
	,OrderCate(ImpSPtr_,AUTODB_STR("OrderCate"))
	,OrderID(ImpSPtr_,AUTODB_STR("OrderID"))
	,FactoryID(ImpSPtr_,AUTODB_STR("FactoryID"))
...
JD_ObjectsImp::JD_ObjectsImp( const JD_ObjectsImp& rhs ):Table(rhs)
	,ItemID(rhs.ItemID)
	,OrderCate(rhs.OrderCate)
	,OrderID(rhs.OrderID)
	,FactoryID(rhs.FactoryID)
...
JD_ObjectsImp::JD_ObjectsImp( JD_ObjectsImp&& rhs ):Table(rhs)
	,ItemID(std::move(rhs.ItemID))
	,OrderCate(std::move(rhs.OrderCate))
	,OrderID(std::move(rhs.OrderID))
	,FactoryID(std::move(rhs.FactoryID))
...
JD_ObjectsImp	JD_Objects("");



void	JD_OrderInfoImp::SData::SetAll(bool val)
{
	val ? ItemID_.reset(boost::initialized_value) : ItemID_=boost::none;
	val ? OrderCate_.reset(boost::initialized_value) : OrderCate_=boost::none;
	val ? OrderID_.reset(boost::initialized_value) : OrderID_=boost::none;
...
void	JD_OrderInfoImp::SData::Flip()
{
	ItemID_ ? ItemID_=boost::none : ItemID_.reset(boost::initialized_value);
	OrderCate_ ? OrderCate_=boost::none : OrderCate_.reset(boost::initialized_value);
	OrderID_ ? OrderID_=boost::none : OrderID_.reset(boost::initialized_value);
...
void	JD_OrderInfoImp::SData::Check()
{
	if ( !ItemID_ )
	{
		ItemID_.reset(boost::initialized_value);
...
void	JD_OrderInfoImp::SData::ToUtf8()
{
	if ( ShopName_ )
	{
...
void	JD_OrderInfoImp::SData::ToAscii()
{
	if ( ShopName_ )
	{
...
autoDB::SColumns JD_OrderInfoImp::Use( const SData& data )
{
	SColumns ret;
	if ( data.ItemID_ )
	{
...
autoDB::SColumns JD_OrderInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.ItemID_ )
	{
...
JD_OrderInfoImp	JD_OrderInfoImp::operator() (const StringType& alias)
{
	return std::move(JD_OrderInfoImp(alias));
}

JD_OrderInfoImp::JD_OrderInfoImp( const StringType& alias ):Table(AUTODB_STR("JD_OrderInfo"), alias)
	,ItemID(ImpSPtr_,AUTODB_STR("ItemID"))
	,OrderCate(ImpSPtr_,AUTODB_STR("OrderCate"))
	,OrderID(ImpSPtr_,AUTODB_STR("OrderID"))
	,ParentID(ImpSPtr_,AUTODB_STR("ParentID"))
...
JD_OrderInfoImp::JD_OrderInfoImp( const JD_OrderInfoImp& rhs ):Table(rhs)
	,ItemID(rhs.ItemID)
	,OrderCate(rhs.OrderCate)
	,OrderID(rhs.OrderID)
	,ParentID(rhs.ParentID)
...
JD_OrderInfoImp::JD_OrderInfoImp( JD_OrderInfoImp&& rhs ):Table(rhs)
	,ItemID(std::move(rhs.ItemID))
	,OrderCate(std::move(rhs.OrderCate))
	,OrderID(std::move(rhs.OrderID))
	,ParentID(std::move(rhs.ParentID))
