...
::autoDB::DS_CabBoardGapInfoImp::SData	ToData( const transMsg::DS_CabBoardGapInfo& message )
{
	DS_CabBoardGapInfoImp::SData sdata;
...
{
	transMsg::DS_CabBoardInfo message;
	if ( sdata.CabBoardID_ )
	{
		message.set_cabboardid(*sdata.CabBoardID_);
	}
...
::autoDB::DS_CabBoardInfoImp::SData	ToData( const transMsg::DS_CabBoardInfo& message )
{
	DS_CabBoardInfoImp::SData sdata;
	if ( message.has_cabboardid() )
	{
		sdata.CabBoardID_ = message.cabboardid();
	}
...
{
	transMsg::DS_CabBoardSealInfo message;
...
::autoDB::DS_CabBoardSealInfoImp::SData	ToData( const transMsg::DS_CabBoardSealInfo& message )
{
	DS_CabBoardSealInfoImp::SData sdata;
...
{
	transMsg::DS_CabDoorBoardGapInfo message;
...
::autoDB::DS_CabDoorBoardGapInfoImp::SData	ToData( const transMsg::DS_CabDoorBoardGapInfo& message )
{
	DS_CabDoorBoardGapInfoImp::SData sdata;
...
{
	transMsg::DS_CabDoorBoardInfo message;
	if ( sdata.CabDoorBoardID_ )
	{
		message.set_cabdoorboardid(*sdata.CabDoorBoardID_);
	}
...
::autoDB::DS_CabDoorBoardInfoImp::SData	ToData( const transMsg::DS_CabDoorBoardInfo& message )
{
	DS_CabDoorBoardInfoImp::SData sdata;
	if ( message.has_cabdoorboardid() )
	{
		sdata.CabDoorBoardID_ = message.cabdoorboardid();
	}
...
{
	transMsg::DS_CabDoorBoardSealInfo message;
...
::autoDB::DS_CabDoorBoardSealInfoImp::SData	ToData( const transMsg::DS_CabDoorBoardSealInfo& message )
{
	DS_CabDoorBoardSealInfoImp::SData sdata;
...
{
	transMsg::DS_CabDoorHWFInfo message;
...
::autoDB::DS_CabDoorHWFInfoImp::SData	ToData( const transMsg::DS_CabDoorHWFInfo& message )
{
	DS_CabDoorHWFInfoImp::SData sdata;
...
{
	transMsg::DS_CabDoorHandleInfo message;
...
::autoDB::DS_CabDoorHandleInfoImp::SData	ToData( const transMsg::DS_CabDoorHandleInfo& message )
{
	DS_CabDoorHandleInfoImp::SData sdata;
...
{
	transMsg::DS_CabDoorInfo message;
	if ( sdata.CabDoorID_ )
	{
		message.set_cabdoorid(*sdata.CabDoorID_);
	}
...
::autoDB::DS_CabDoorInfoImp::SData	ToData( const transMsg::DS_CabDoorInfo& message )
{
	DS_CabDoorInfoImp::SData sdata;
	if ( message.has_cabdoorid() )
	{
		sdata.CabDoorID_ = message.cabdoorid();
	}
...
{
	transMsg::DS_CabDoorRegionInfo message;
	if ( sdata.CabDoorRegionID_ )
	{
		message.set_cabdoorregionid(*sdata.CabDoorRegionID_);
	}
...
::autoDB::DS_CabDoorRegionInfoImp::SData	ToData( const transMsg::DS_CabDoorRegionInfo& message )
{
	DS_CabDoorRegionInfoImp::SData sdata;
	if ( message.has_cabdoorregionid() )
	{
		sdata.CabDoorRegionID_ = message.cabdoorregionid();
	}
...
{
	transMsg::DS_CabDoorSlideInfo message;
...
::autoDB::DS_CabDoorSlideInfoImp::SData	ToData( const transMsg::DS_CabDoorSlideInfo& message )
{
	DS_CabDoorSlideInfoImp::SData sdata;
...
{
	transMsg::DS_CabDoorSystemInfo message;
	if ( sdata.CabDoorSystemID_ )
	{
		message.set_cabdoorsystemid(*sdata.CabDoorSystemID_);
	}
...
::autoDB::DS_CabDoorSystemInfoImp::SData	ToData( const transMsg::DS_CabDoorSystemInfo& message )
{
	DS_CabDoorSystemInfoImp::SData sdata;
	if ( message.has_cabdoorsystemid() )
	{
		sdata.CabDoorSystemID_ = message.cabdoorsystemid();
	}
...
{
	transMsg::DS_CabFNFHWFInfo message;
...
::autoDB::DS_CabFNFHWFInfoImp::SData	ToData( const transMsg::DS_CabFNFHWFInfo& message )
{
	DS_CabFNFHWFInfoImp::SData sdata;
...
{
	transMsg::DS_CabFNFHoleInfo message;
...
::autoDB::DS_CabFNFHoleInfoImp::SData	ToData( const transMsg::DS_CabFNFHoleInfo& message )
{
	DS_CabFNFHoleInfoImp::SData sdata;
...
{
	transMsg::DS_CabFNFInfo message;
	if ( sdata.CabFNFID_ )
	{
		message.set_cabfnfid(*sdata.CabFNFID_);
	}
...
::autoDB::DS_CabFNFInfoImp::SData	ToData( const transMsg::DS_CabFNFInfo& message )
{
	DS_CabFNFInfoImp::SData sdata;
	if ( message.has_cabfnfid() )
	{
		sdata.CabFNFID_ = message.cabfnfid();
	}
...
{
	transMsg::DS_CabFNFPartInfo message;
...
::autoDB::DS_CabFNFPartInfoImp::SData	ToData( const transMsg::DS_CabFNFPartInfo& message )
{
	DS_CabFNFPartInfoImp::SData sdata;
...
{
	transMsg::DS_CabFNFPartSealInfo message;
...
::autoDB::DS_CabFNFPartSealInfoImp::SData	ToData( const transMsg::DS_CabFNFPartSealInfo& message )
{
	DS_CabFNFPartSealInfoImp::SData sdata;
...
::autoDB::DS_CabInfoImp::SData	ToData( const transMsg::DS_CabInfo& message )
{
	DS_CabInfoImp::SData sdata;
	if ( message.has_cabid() )
	{
		sdata.CabID_ = message.cabid();
	}
...
{
	transMsg::DS_DecorBoardInfo message;
...
::autoDB::DS_DecorBoardInfoImp::SData	ToData( const transMsg::DS_DecorBoardInfo& message )
{
	DS_DecorBoardInfoImp::SData sdata;
...
{
	transMsg::DS_DecorBoardUnitInfo message;
...
::autoDB::DS_DecorBoardUnitInfoImp::SData	ToData( const transMsg::DS_DecorBoardUnitInfo& message )
{
	DS_DecorBoardUnitInfoImp::SData sdata;
...
{
	transMsg::DS_DecorBoardUnitSealInfo message;
...
::autoDB::DS_DecorBoardUnitSealInfoImp::SData	ToData( const transMsg::DS_DecorBoardUnitSealInfo& message )
{
	DS_DecorBoardUnitSealInfoImp::SData sdata;
...
::autoDB::DS_DecorInfoImp::SData	ToData( const transMsg::DS_DecorInfo& message )
{
	DS_DecorInfoImp::SData sdata;
...
{
	transMsg::DS_DecorLineInfo message;
...
::autoDB::DS_DecorLineInfoImp::SData	ToData( const transMsg::DS_DecorLineInfo& message )
{
	DS_DecorLineInfoImp::SData sdata;
...
{
	transMsg::DS_DesignPlanInfo message;
	if ( sdata.DesignPlanID_ )
	{
		message.set_designplanid(*sdata.DesignPlanID_);
	}
...
::autoDB::DS_DesignPlanInfoImp::SData	ToData( const transMsg::DS_DesignPlanInfo& message )
{
	DS_DesignPlanInfoImp::SData sdata;
	if ( message.has_designplanid() )
	{
		sdata.DesignPlanID_ = message.designplanid();
	}
...
{
	transMsg::DS_FittingInfo message;
...
::autoDB::DS_FittingInfoImp::SData	ToData( const transMsg::DS_FittingInfo& message )
{
	DS_FittingInfoImp::SData sdata;
...
::autoDB::DS_HWFInfoImp::SData	ToData( const transMsg::DS_HWFInfo& message )
{
	DS_HWFInfoImp::SData sdata;
...
::autoDB::DS_MarkInfoImp::SData	ToData( const transMsg::DS_MarkInfo& message )
{
	DS_MarkInfoImp::SData sdata;
...
{
	transMsg::DS_MatrixInfo message;
	if ( sdata.OrderID_ )
	{
		message.set_orderid(*sdata.OrderID_);
	}
...
::autoDB::DS_MatrixInfoImp::SData	ToData( const transMsg::DS_MatrixInfo& message )
{
	DS_MatrixInfoImp::SData sdata;
	if ( message.has_orderid() )
	{
		sdata.OrderID_ = message.orderid();
	}
...
{
	transMsg::DS_OrderAddedInfo message;
...
::autoDB::DS_OrderAddedInfoImp::SData	ToData( const transMsg::DS_OrderAddedInfo& message )
{
	DS_OrderAddedInfoImp::SData sdata;
...
{
	transMsg::DS_OrderDataInfo message;
	if ( sdata.OrderID_ )
	{
		message.set_orderid(*sdata.OrderID_);
	}
...
::autoDB::DS_OrderDataInfoImp::SData	ToData( const transMsg::DS_OrderDataInfo& message )
{
	DS_OrderDataInfoImp::SData sdata;
	if ( message.has_orderid() )
	{
		sdata.OrderID_ = message.orderid();
	}
...
::autoDB::DS_PackInfoImp::SData	ToData( const transMsg::DS_PackInfo& message )
{
	DS_PackInfoImp::SData sdata;
...
::autoDB::DS_PointInfoImp::SData	ToData( const transMsg::DS_PointInfo& message )
{
	DS_PointInfoImp::SData sdata;
	if ( message.has_designplanid() )
	{
		sdata.DesignPlanID_ = message.designplanid();
	}
...
{
	transMsg::DS_PrintElementInfo message;
...
::autoDB::DS_PrintElementInfoImp::SData	ToData( const transMsg::DS_PrintElementInfo& message )
{
	DS_PrintElementInfoImp::SData sdata;
...
{
	transMsg::DS_PrintGroupInfo message;
	if ( sdata.DesignPrintGroupID_ )
	{
		message.set_designprintgroupid(*sdata.DesignPrintGroupID_);
	}
...
::autoDB::DS_PrintGroupInfoImp::SData	ToData( const transMsg::DS_PrintGroupInfo& message )
{
	DS_PrintGroupInfoImp::SData sdata;
	if ( message.has_designprintgroupid() )
	{
		sdata.DesignPrintGroupID_ = message.designprintgroupid();
	}
...
::autoDB::DS_PrintInfoImp::SData	ToData( const transMsg::DS_PrintInfo& message )
{
	DS_PrintInfoImp::SData sdata;
	if ( message.has_designprintid() )
	{
		sdata.DesignPrintID_ = message.designprintid();
	}
...
{
	transMsg::DS_PrintTableInfo message;
...
::autoDB::DS_PrintTableInfoImp::SData	ToData( const transMsg::DS_PrintTableInfo& message )
{
	DS_PrintTableInfoImp::SData sdata;
...
{
	transMsg::DS_PrintTableRowColInfo message;
...
::autoDB::DS_PrintTableRowColInfoImp::SData	ToData( const transMsg::DS_PrintTableRowColInfo& message )
{
	DS_PrintTableRowColInfoImp::SData sdata;
...
{
	transMsg::DS_PrintTableRowInfo message;
	if ( sdata.DesignPrintTableRowID_ )
	{
		message.set_designprinttablerowid(*sdata.DesignPrintTableRowID_);
	}
...
::autoDB::DS_PrintTableRowInfoImp::SData	ToData( const transMsg::DS_PrintTableRowInfo& message )
{
	DS_PrintTableRowInfoImp::SData sdata;
	if ( message.has_designprinttablerowid() )
	{
		sdata.DesignPrintTableRowID_ = message.designprinttablerowid();
	}
...
{
	transMsg::DS_ProductInfo message;
...
::autoDB::DS_ProductInfoImp::SData	ToData( const transMsg::DS_ProductInfo& message )
{
	DS_ProductInfoImp::SData sdata;
...
{
	transMsg::DS_RemarkInfo message;
...
::autoDB::DS_RemarkInfoImp::SData	ToData( const transMsg::DS_RemarkInfo& message )
{
	DS_RemarkInfoImp::SData sdata;
...
::autoDB::DS_ShapeInfoImp::SData	ToData( const transMsg::DS_ShapeInfo& message )
{
	DS_ShapeInfoImp::SData sdata;
...
::autoDB::DS_SkinInfoImp::SData	ToData( const transMsg::DS_SkinInfo& message )
{
	DS_SkinInfoImp::SData sdata;
...
::autoDB::DS_TableInfoImp::SData	ToData( const transMsg::DS_TableInfo& message )
{
	DS_TableInfoImp::SData sdata;
...
{
	transMsg::DS_TablePartInfo message;
...
::autoDB::DS_TablePartInfoImp::SData	ToData( const transMsg::DS_TablePartInfo& message )
{
	DS_TablePartInfoImp::SData sdata;
...
{
	transMsg::DS_TableSideInfo message;
...
::autoDB::DS_TableSideInfoImp::SData	ToData( const transMsg::DS_TableSideInfo& message )
{
	DS_TableSideInfoImp::SData sdata;
...
{
	transMsg::DS_WallDecorInfo message;
...
::autoDB::DS_WallDecorInfoImp::SData	ToData( const transMsg::DS_WallDecorInfo& message )
{
	DS_WallDecorInfoImp::SData sdata;
...
::autoDB::DS_WallInfoImp::SData	ToData( const transMsg::DS_WallInfo& message )
{
	DS_WallInfoImp::SData sdata;
	if ( message.has_designwallid() )
	{
		sdata.DesignWallID_ = message.designwallid();
	}
...
{
	return *( package.mutable_ds_cabboardgapinfo() );
}
...
{
	return *( package.mutable_ds_cabboardinfo() );
}
...
{
	return *( package.mutable_ds_cabboardsealinfo() );
}
...
{
	return *( package.mutable_ds_cabdoorboardgapinfo() );
}
...
{
	return *( package.mutable_ds_cabdoorboardinfo() );
}
...
{
	return *( package.mutable_ds_cabdoorboardsealinfo() );
}
...
{
	return *( package.mutable_ds_cabdoorhwfinfo() );
}
...
{
	return *( package.mutable_ds_cabdoorhandleinfo() );
}
...
{
	return *( package.mutable_ds_cabdoorinfo() );
}
...
{
	return *( package.mutable_ds_cabdoorregioninfo() );
}
...
{
	return *( package.mutable_ds_cabdoorslideinfo() );
}
...
{
	return *( package.mutable_ds_cabdoorsysteminfo() );
}
...
{
	return *( package.mutable_ds_cabfnfhwfinfo() );
}
...
{
	return *( package.mutable_ds_cabfnfholeinfo() );
}
...
{
	return *( package.mutable_ds_cabfnfinfo() );
}
...
{
	return *( package.mutable_ds_cabfnfpartinfo() );
}
...
{
	return *( package.mutable_ds_cabfnfpartsealinfo() );
}
...
{
	return *( package.mutable_ds_cabinfo() );
}
...
{
	return *( package.mutable_ds_decorboardinfo() );
}
...
{
	return *( package.mutable_ds_decorboardunitinfo() );
}
...
{
	return *( package.mutable_ds_decorboardunitsealinfo() );
}
...
{
	return *( package.mutable_ds_decorinfo() );
}
...
{
	return *( package.mutable_ds_decorlineinfo() );
}
...
{
	return *( package.mutable_ds_designplaninfo() );
}
...
{
	return *( package.mutable_ds_fittinginfo() );
}
...
{
	return *( package.mutable_ds_hwfinfo() );
}
...
{
	return *( package.mutable_ds_markinfo() );
}
...
{
	return *( package.mutable_ds_matrixinfo() );
}
...
{
	return *( package.mutable_ds_orderaddedinfo() );
}
...
{
	return *( package.mutable_ds_orderdatainfo() );
}
...
{
	return *( package.mutable_ds_packinfo() );
}
...
{
	return *( package.mutable_ds_pointinfo() );
}
...
{
	return *( package.mutable_ds_printelementinfo() );
}
...
{
	return *( package.mutable_ds_printgroupinfo() );
}
...
{
	return *( package.mutable_ds_printinfo() );
}
...
{
	return *( package.mutable_ds_printtableinfo() );
}
...
{
	return *( package.mutable_ds_printtablerowcolinfo() );
}
...
{
	return *( package.mutable_ds_printtablerowinfo() );
}
...
{
	return *( package.mutable_ds_productinfo() );
}
...
{
	return *( package.mutable_ds_remarkinfo() );
}
...
{
	return *( package.mutable_ds_shapeinfo() );
}
...
{
	return *( package.mutable_ds_skininfo() );
}
...
{
	return *( package.mutable_ds_tableinfo() );
}
...
{
	return *( package.mutable_ds_tablepartinfo() );
}
...
{
	return *( package.mutable_ds_tablesideinfo() );
}
...
{
	return *( package.mutable_ds_walldecorinfo() );
}
...
{
	return *( package.mutable_ds_wallinfo() );
}
