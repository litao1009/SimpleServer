...
::autoDB::ZB_BoardGapInfoImp::SData	ToData( const transMsg::ZB_BoardGapInfo& message )
{
	ZB_BoardGapInfoImp::SData sdata;
...
::autoDB::ZB_BoardInfoImp::SData	ToData( const transMsg::ZB_BoardInfo& message )
{
	ZB_BoardInfoImp::SData sdata;
	if ( message.has_itemid() )
	{
		sdata.ItemID_ = message.itemid();
	}
...
{
	transMsg::ZB_BoardSealInfo message;
	if ( sdata.ItemID_ )
	{
		message.set_itemid(*sdata.ItemID_);
	}
...
::autoDB::ZB_BoardSealInfoImp::SData	ToData( const transMsg::ZB_BoardSealInfo& message )
{
	ZB_BoardSealInfoImp::SData sdata;
	if ( message.has_itemid() )
	{
		sdata.ItemID_ = message.itemid();
	}
...
::autoDB::ZB_ObjectsImp::SData	ToData( const transMsg::ZB_Objects& message )
{
	ZB_ObjectsImp::SData sdata;
	if ( message.has_itemid() )
	{
		sdata.ItemID_ = message.itemid();
	}
...
::autoDB::ZB_OrderInfoImp::SData	ToData( const transMsg::ZB_OrderInfo& message )
{
	ZB_OrderInfoImp::SData sdata;
	if ( message.has_itemid() )
	{
		sdata.ItemID_ = message.itemid();
	}
...
{
	return *( package.mutable_zb_boardgapinfo() );
}
...
{
	return *( package.mutable_zb_boardinfo() );
}
...
{
	return *( package.mutable_zb_boardsealinfo() );
}
...
{
	return *( package.mutable_zb_objects() );
}
...
{
	return *( package.mutable_zb_orderinfo() );
}
