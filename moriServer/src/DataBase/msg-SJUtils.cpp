...
::autoDB::SJ_CabBoardGapInfoImp::SData	ToData( const transMsg::SJ_CabBoardGapInfo& message )
{
	SJ_CabBoardGapInfoImp::SData sdata;
...
{
	transMsg::SJ_CabBoardInfo message;
	if ( sdata.CabBoardID_ )
	{
		message.set_cabboardid(*sdata.CabBoardID_);
	}
...
::autoDB::SJ_CabBoardInfoImp::SData	ToData( const transMsg::SJ_CabBoardInfo& message )
{
	SJ_CabBoardInfoImp::SData sdata;
	if ( message.has_cabboardid() )
	{
		sdata.CabBoardID_ = message.cabboardid();
	}
...
{
	transMsg::SJ_CabBoardSealInfo message;
...
::autoDB::SJ_CabBoardSealInfoImp::SData	ToData( const transMsg::SJ_CabBoardSealInfo& message )
{
	SJ_CabBoardSealInfoImp::SData sdata;
...
{
	transMsg::SJ_CabDoorBoardGapInfo message;
...
::autoDB::SJ_CabDoorBoardGapInfoImp::SData	ToData( const transMsg::SJ_CabDoorBoardGapInfo& message )
{
	SJ_CabDoorBoardGapInfoImp::SData sdata;
...
{
	transMsg::SJ_CabDoorBoardInfo message;
	if ( sdata.CabDoorBoardID_ )
	{
		message.set_cabdoorboardid(*sdata.CabDoorBoardID_);
	}
...
::autoDB::SJ_CabDoorBoardInfoImp::SData	ToData( const transMsg::SJ_CabDoorBoardInfo& message )
{
	SJ_CabDoorBoardInfoImp::SData sdata;
	if ( message.has_cabdoorboardid() )
	{
		sdata.CabDoorBoardID_ = message.cabdoorboardid();
	}
...
{
	transMsg::SJ_CabDoorBoardSealInfo message;
...
::autoDB::SJ_CabDoorBoardSealInfoImp::SData	ToData( const transMsg::SJ_CabDoorBoardSealInfo& message )
{
	SJ_CabDoorBoardSealInfoImp::SData sdata;
...
{
	transMsg::SJ_CabDoorHWFInfo message;
...
::autoDB::SJ_CabDoorHWFInfoImp::SData	ToData( const transMsg::SJ_CabDoorHWFInfo& message )
{
	SJ_CabDoorHWFInfoImp::SData sdata;
...
{
	transMsg::SJ_CabDoorHandleInfo message;
...
::autoDB::SJ_CabDoorHandleInfoImp::SData	ToData( const transMsg::SJ_CabDoorHandleInfo& message )
{
	SJ_CabDoorHandleInfoImp::SData sdata;
...
{
	transMsg::SJ_CabDoorInfo message;
	if ( sdata.CabDoorID_ )
	{
		message.set_cabdoorid(*sdata.CabDoorID_);
	}
...
::autoDB::SJ_CabDoorInfoImp::SData	ToData( const transMsg::SJ_CabDoorInfo& message )
{
	SJ_CabDoorInfoImp::SData sdata;
	if ( message.has_cabdoorid() )
	{
		sdata.CabDoorID_ = message.cabdoorid();
	}
...
{
	transMsg::SJ_CabDoorRegionInfo message;
	if ( sdata.CabDoorRegionID_ )
	{
		message.set_cabdoorregionid(*sdata.CabDoorRegionID_);
	}
...
::autoDB::SJ_CabDoorRegionInfoImp::SData	ToData( const transMsg::SJ_CabDoorRegionInfo& message )
{
	SJ_CabDoorRegionInfoImp::SData sdata;
	if ( message.has_cabdoorregionid() )
	{
		sdata.CabDoorRegionID_ = message.cabdoorregionid();
	}
...
{
	transMsg::SJ_CabDoorSlideInfo message;
...
::autoDB::SJ_CabDoorSlideInfoImp::SData	ToData( const transMsg::SJ_CabDoorSlideInfo& message )
{
	SJ_CabDoorSlideInfoImp::SData sdata;
...
{
	transMsg::SJ_CabDoorSystemInfo message;
	if ( sdata.CabDoorSystemID_ )
	{
		message.set_cabdoorsystemid(*sdata.CabDoorSystemID_);
	}
...
::autoDB::SJ_CabDoorSystemInfoImp::SData	ToData( const transMsg::SJ_CabDoorSystemInfo& message )
{
	SJ_CabDoorSystemInfoImp::SData sdata;
	if ( message.has_cabdoorsystemid() )
	{
		sdata.CabDoorSystemID_ = message.cabdoorsystemid();
	}
...
{
	transMsg::SJ_CabFNFHWFInfo message;
...
::autoDB::SJ_CabFNFHWFInfoImp::SData	ToData( const transMsg::SJ_CabFNFHWFInfo& message )
{
	SJ_CabFNFHWFInfoImp::SData sdata;
...
{
	transMsg::SJ_CabFNFHoleInfo message;
...
::autoDB::SJ_CabFNFHoleInfoImp::SData	ToData( const transMsg::SJ_CabFNFHoleInfo& message )
{
	SJ_CabFNFHoleInfoImp::SData sdata;
...
{
	transMsg::SJ_CabFNFInfo message;
	if ( sdata.CabFNFID_ )
	{
		message.set_cabfnfid(*sdata.CabFNFID_);
	}
...
::autoDB::SJ_CabFNFInfoImp::SData	ToData( const transMsg::SJ_CabFNFInfo& message )
{
	SJ_CabFNFInfoImp::SData sdata;
	if ( message.has_cabfnfid() )
	{
		sdata.CabFNFID_ = message.cabfnfid();
	}
...
{
	transMsg::SJ_CabFNFPartInfo message;
...
::autoDB::SJ_CabFNFPartInfoImp::SData	ToData( const transMsg::SJ_CabFNFPartInfo& message )
{
	SJ_CabFNFPartInfoImp::SData sdata;
...
{
	transMsg::SJ_CabFNFPartSealInfo message;
...
::autoDB::SJ_CabFNFPartSealInfoImp::SData	ToData( const transMsg::SJ_CabFNFPartSealInfo& message )
{
	SJ_CabFNFPartSealInfoImp::SData sdata;
...
::autoDB::SJ_CabInfoImp::SData	ToData( const transMsg::SJ_CabInfo& message )
{
	SJ_CabInfoImp::SData sdata;
	if ( message.has_cabid() )
	{
		sdata.CabID_ = message.cabid();
	}
...
{
	transMsg::SJ_DecorBoardInfo message;
...
::autoDB::SJ_DecorBoardInfoImp::SData	ToData( const transMsg::SJ_DecorBoardInfo& message )
{
	SJ_DecorBoardInfoImp::SData sdata;
...
{
	transMsg::SJ_DecorBoardUnitInfo message;
...
::autoDB::SJ_DecorBoardUnitInfoImp::SData	ToData( const transMsg::SJ_DecorBoardUnitInfo& message )
{
	SJ_DecorBoardUnitInfoImp::SData sdata;
...
{
	transMsg::SJ_DecorBoardUnitSealInfo message;
...
::autoDB::SJ_DecorBoardUnitSealInfoImp::SData	ToData( const transMsg::SJ_DecorBoardUnitSealInfo& message )
{
	SJ_DecorBoardUnitSealInfoImp::SData sdata;
...
::autoDB::SJ_DecorInfoImp::SData	ToData( const transMsg::SJ_DecorInfo& message )
{
	SJ_DecorInfoImp::SData sdata;
...
{
	transMsg::SJ_DecorLineInfo message;
...
::autoDB::SJ_DecorLineInfoImp::SData	ToData( const transMsg::SJ_DecorLineInfo& message )
{
	SJ_DecorLineInfoImp::SData sdata;
...
{
	transMsg::SJ_DesignPlanInfo message;
	if ( sdata.DesignPlanID_ )
	{
		message.set_designplanid(*sdata.DesignPlanID_);
	}
...
::autoDB::SJ_DesignPlanInfoImp::SData	ToData( const transMsg::SJ_DesignPlanInfo& message )
{
	SJ_DesignPlanInfoImp::SData sdata;
	if ( message.has_designplanid() )
	{
		sdata.DesignPlanID_ = message.designplanid();
	}
...
{
	transMsg::SJ_FittingInfo message;
...
::autoDB::SJ_FittingInfoImp::SData	ToData( const transMsg::SJ_FittingInfo& message )
{
	SJ_FittingInfoImp::SData sdata;
...
::autoDB::SJ_HWFInfoImp::SData	ToData( const transMsg::SJ_HWFInfo& message )
{
	SJ_HWFInfoImp::SData sdata;
...
::autoDB::SJ_MarkInfoImp::SData	ToData( const transMsg::SJ_MarkInfo& message )
{
	SJ_MarkInfoImp::SData sdata;
...
{
	transMsg::SJ_MatrixInfo message;
	if ( sdata.OrderID_ )
	{
		message.set_orderid(*sdata.OrderID_);
	}
...
::autoDB::SJ_MatrixInfoImp::SData	ToData( const transMsg::SJ_MatrixInfo& message )
{
	SJ_MatrixInfoImp::SData sdata;
	if ( message.has_orderid() )
	{
		sdata.OrderID_ = message.orderid();
	}
...
{
	transMsg::SJ_OrderAddedInfo message;
...
::autoDB::SJ_OrderAddedInfoImp::SData	ToData( const transMsg::SJ_OrderAddedInfo& message )
{
	SJ_OrderAddedInfoImp::SData sdata;
...
{
	transMsg::SJ_OrderDataInfo message;
	if ( sdata.OrderID_ )
	{
		message.set_orderid(*sdata.OrderID_);
	}
...
::autoDB::SJ_OrderDataInfoImp::SData	ToData( const transMsg::SJ_OrderDataInfo& message )
{
	SJ_OrderDataInfoImp::SData sdata;
	if ( message.has_orderid() )
	{
		sdata.OrderID_ = message.orderid();
	}
...
::autoDB::SJ_PackInfoImp::SData	ToData( const transMsg::SJ_PackInfo& message )
{
	SJ_PackInfoImp::SData sdata;
...
::autoDB::SJ_PointInfoImp::SData	ToData( const transMsg::SJ_PointInfo& message )
{
	SJ_PointInfoImp::SData sdata;
	if ( message.has_designplanid() )
	{
		sdata.DesignPlanID_ = message.designplanid();
	}
...
{
	transMsg::SJ_PrintElementInfo message;
...
::autoDB::SJ_PrintElementInfoImp::SData	ToData( const transMsg::SJ_PrintElementInfo& message )
{
	SJ_PrintElementInfoImp::SData sdata;
...
{
	transMsg::SJ_PrintGroupInfo message;
	if ( sdata.DesignPrintGroupID_ )
	{
		message.set_designprintgroupid(*sdata.DesignPrintGroupID_);
	}
...
::autoDB::SJ_PrintGroupInfoImp::SData	ToData( const transMsg::SJ_PrintGroupInfo& message )
{
	SJ_PrintGroupInfoImp::SData sdata;
	if ( message.has_designprintgroupid() )
	{
		sdata.DesignPrintGroupID_ = message.designprintgroupid();
	}
...
::autoDB::SJ_PrintInfoImp::SData	ToData( const transMsg::SJ_PrintInfo& message )
{
	SJ_PrintInfoImp::SData sdata;
	if ( message.has_designprintid() )
	{
		sdata.DesignPrintID_ = message.designprintid();
	}
...
{
	transMsg::SJ_PrintTableInfo message;
...
::autoDB::SJ_PrintTableInfoImp::SData	ToData( const transMsg::SJ_PrintTableInfo& message )
{
	SJ_PrintTableInfoImp::SData sdata;
...
{
	transMsg::SJ_PrintTableRowColInfo message;
...
::autoDB::SJ_PrintTableRowColInfoImp::SData	ToData( const transMsg::SJ_PrintTableRowColInfo& message )
{
	SJ_PrintTableRowColInfoImp::SData sdata;
...
{
	transMsg::SJ_PrintTableRowInfo message;
	if ( sdata.DesignPrintTableRowID_ )
	{
		message.set_designprinttablerowid(*sdata.DesignPrintTableRowID_);
	}
...
::autoDB::SJ_PrintTableRowInfoImp::SData	ToData( const transMsg::SJ_PrintTableRowInfo& message )
{
	SJ_PrintTableRowInfoImp::SData sdata;
	if ( message.has_designprinttablerowid() )
	{
		sdata.DesignPrintTableRowID_ = message.designprinttablerowid();
	}
...
{
	transMsg::SJ_ProductInfo message;
...
::autoDB::SJ_ProductInfoImp::SData	ToData( const transMsg::SJ_ProductInfo& message )
{
	SJ_ProductInfoImp::SData sdata;
...
{
	transMsg::SJ_RemarkInfo message;
...
::autoDB::SJ_RemarkInfoImp::SData	ToData( const transMsg::SJ_RemarkInfo& message )
{
	SJ_RemarkInfoImp::SData sdata;
...
::autoDB::SJ_ShapeInfoImp::SData	ToData( const transMsg::SJ_ShapeInfo& message )
{
	SJ_ShapeInfoImp::SData sdata;
...
::autoDB::SJ_SkinInfoImp::SData	ToData( const transMsg::SJ_SkinInfo& message )
{
	SJ_SkinInfoImp::SData sdata;
...
::autoDB::SJ_TableInfoImp::SData	ToData( const transMsg::SJ_TableInfo& message )
{
	SJ_TableInfoImp::SData sdata;
...
{
	transMsg::SJ_TablePartInfo message;
...
::autoDB::SJ_TablePartInfoImp::SData	ToData( const transMsg::SJ_TablePartInfo& message )
{
	SJ_TablePartInfoImp::SData sdata;
...
{
	transMsg::SJ_TableSideInfo message;
...
::autoDB::SJ_TableSideInfoImp::SData	ToData( const transMsg::SJ_TableSideInfo& message )
{
	SJ_TableSideInfoImp::SData sdata;
...
{
	transMsg::SJ_WallDecorInfo message;
...
::autoDB::SJ_WallDecorInfoImp::SData	ToData( const transMsg::SJ_WallDecorInfo& message )
{
	SJ_WallDecorInfoImp::SData sdata;
...
::autoDB::SJ_WallInfoImp::SData	ToData( const transMsg::SJ_WallInfo& message )
{
	SJ_WallInfoImp::SData sdata;
	if ( message.has_designwallid() )
	{
		sdata.DesignWallID_ = message.designwallid();
	}
...
{
	return *( package.mutable_sj_cabboardgapinfo() );
}
...
{
	return *( package.mutable_sj_cabboardinfo() );
}
...
{
	return *( package.mutable_sj_cabboardsealinfo() );
}
...
{
	return *( package.mutable_sj_cabdoorboardgapinfo() );
}
...
{
	return *( package.mutable_sj_cabdoorboardinfo() );
}
...
{
	return *( package.mutable_sj_cabdoorboardsealinfo() );
}
...
{
	return *( package.mutable_sj_cabdoorhwfinfo() );
}
...
{
	return *( package.mutable_sj_cabdoorhandleinfo() );
}
...
{
	return *( package.mutable_sj_cabdoorinfo() );
}
...
{
	return *( package.mutable_sj_cabdoorregioninfo() );
}
...
{
	return *( package.mutable_sj_cabdoorslideinfo() );
}
...
{
	return *( package.mutable_sj_cabdoorsysteminfo() );
}
...
{
	return *( package.mutable_sj_cabfnfhwfinfo() );
}
...
{
	return *( package.mutable_sj_cabfnfholeinfo() );
}
...
{
	return *( package.mutable_sj_cabfnfinfo() );
}
...
{
	return *( package.mutable_sj_cabfnfpartinfo() );
}
...
{
	return *( package.mutable_sj_cabfnfpartsealinfo() );
}
...
{
	return *( package.mutable_sj_cabinfo() );
}
...
{
	return *( package.mutable_sj_decorboardinfo() );
}
...
{
	return *( package.mutable_sj_decorboardunitinfo() );
}
...
{
	return *( package.mutable_sj_decorboardunitsealinfo() );
}
...
{
	return *( package.mutable_sj_decorinfo() );
}
...
{
	return *( package.mutable_sj_decorlineinfo() );
}
...
{
	return *( package.mutable_sj_designplaninfo() );
}
...
{
	return *( package.mutable_sj_fittinginfo() );
}
...
{
	return *( package.mutable_sj_hwfinfo() );
}
...
{
	return *( package.mutable_sj_markinfo() );
}
...
{
	return *( package.mutable_sj_matrixinfo() );
}
...
{
	return *( package.mutable_sj_orderaddedinfo() );
}
...
{
	return *( package.mutable_sj_orderdatainfo() );
}
...
{
	return *( package.mutable_sj_packinfo() );
}
...
{
	return *( package.mutable_sj_pointinfo() );
}
...
{
	return *( package.mutable_sj_printelementinfo() );
}
...
{
	return *( package.mutable_sj_printgroupinfo() );
}
...
{
	return *( package.mutable_sj_printinfo() );
}
...
{
	return *( package.mutable_sj_printtableinfo() );
}
...
{
	return *( package.mutable_sj_printtablerowcolinfo() );
}
...
{
	return *( package.mutable_sj_printtablerowinfo() );
}
...
{
	return *( package.mutable_sj_productinfo() );
}
...
{
	return *( package.mutable_sj_remarkinfo() );
}
...
{
	return *( package.mutable_sj_shapeinfo() );
}
...
{
	return *( package.mutable_sj_skininfo() );
}
...
{
	return *( package.mutable_sj_tableinfo() );
}
...
{
	return *( package.mutable_sj_tablepartinfo() );
}
...
{
	return *( package.mutable_sj_tablesideinfo() );
}
...
{
	return *( package.mutable_sj_walldecorinfo() );
}
...
{
	return *( package.mutable_sj_wallinfo() );
}
