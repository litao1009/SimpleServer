...
namespace autoDB
{
void	SJ_CabBoardGapInfoImp::SData::SetAll(bool val)
{
...
void	SJ_CabBoardGapInfoImp::SData::Flip()
{
...
void	SJ_CabBoardGapInfoImp::SData::Check()
{
	if ( !CabBoardGapID_ )
	{
...
void	SJ_CabBoardGapInfoImp::SData::ToUtf8()
{
}

void	SJ_CabBoardGapInfoImp::SData::ToAscii()
{
}

autoDB::SColumns SJ_CabBoardGapInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns SJ_CabBoardGapInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.CabBoardGapID_ )
	{
...
SJ_CabBoardGapInfoImp	SJ_CabBoardGapInfoImp::operator() (const StringType& alias)
{
	return std::move(SJ_CabBoardGapInfoImp(alias));
}

SJ_CabBoardGapInfoImp::SJ_CabBoardGapInfoImp( const StringType& alias ):Table(AUTODB_STR("SJ_CabBoardGapInfo"), alias)
...
SJ_CabBoardGapInfoImp::SJ_CabBoardGapInfoImp( const SJ_CabBoardGapInfoImp& rhs ):Table(rhs)
...
SJ_CabBoardGapInfoImp::SJ_CabBoardGapInfoImp( SJ_CabBoardGapInfoImp&& rhs ):Table(rhs)
...
SJ_CabBoardGapInfoImp	SJ_CabBoardGapInfo("");



void	SJ_CabBoardInfoImp::SData::SetAll(bool val)
{
	val ? CabBoardID_.reset(boost::initialized_value) : CabBoardID_=boost::none;
...
void	SJ_CabBoardInfoImp::SData::Flip()
{
	CabBoardID_ ? CabBoardID_=boost::none : CabBoardID_.reset(boost::initialized_value);
...
void	SJ_CabBoardInfoImp::SData::Check()
{
	if ( !CabBoardID_ )
	{
		CabBoardID_.reset(boost::initialized_value);
...
void	SJ_CabBoardInfoImp::SData::ToUtf8()
{
	if ( CabBoardName_ )
	{
...
void	SJ_CabBoardInfoImp::SData::ToAscii()
{
	if ( CabBoardName_ )
	{
...
autoDB::SColumns SJ_CabBoardInfoImp::Use( const SData& data )
{
	SColumns ret;
	if ( data.CabBoardID_ )
	{
...
autoDB::SColumns SJ_CabBoardInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.CabBoardID_ )
	{
...
SJ_CabBoardInfoImp	SJ_CabBoardInfoImp::operator() (const StringType& alias)
{
	return std::move(SJ_CabBoardInfoImp(alias));
}

SJ_CabBoardInfoImp::SJ_CabBoardInfoImp( const StringType& alias ):Table(AUTODB_STR("SJ_CabBoardInfo"), alias)
	,CabBoardID(ImpSPtr_,AUTODB_STR("CabBoardID"))
...
SJ_CabBoardInfoImp::SJ_CabBoardInfoImp( const SJ_CabBoardInfoImp& rhs ):Table(rhs)
	,CabBoardID(rhs.CabBoardID)
	,CabID(rhs.CabID)
	,OrderCate(rhs.OrderCate)
	,OrderID(rhs.OrderID)
...
SJ_CabBoardInfoImp::SJ_CabBoardInfoImp( SJ_CabBoardInfoImp&& rhs ):Table(rhs)
	,CabBoardID(std::move(rhs.CabBoardID))
...
SJ_CabBoardInfoImp	SJ_CabBoardInfo("");



void	SJ_CabBoardSealInfoImp::SData::SetAll(bool val)
{
...
void	SJ_CabBoardSealInfoImp::SData::Flip()
{
...
void	SJ_CabBoardSealInfoImp::SData::Check()
{
	if ( !CabBoardSealID_ )
	{
...
void	SJ_CabBoardSealInfoImp::SData::ToUtf8()
{
}

void	SJ_CabBoardSealInfoImp::SData::ToAscii()
{
}

autoDB::SColumns SJ_CabBoardSealInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns SJ_CabBoardSealInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.CabBoardSealID_ )
	{
...
SJ_CabBoardSealInfoImp	SJ_CabBoardSealInfoImp::operator() (const StringType& alias)
{
	return std::move(SJ_CabBoardSealInfoImp(alias));
}

SJ_CabBoardSealInfoImp::SJ_CabBoardSealInfoImp( const StringType& alias ):Table(AUTODB_STR("SJ_CabBoardSealInfo"), alias)
...
SJ_CabBoardSealInfoImp::SJ_CabBoardSealInfoImp( const SJ_CabBoardSealInfoImp& rhs ):Table(rhs)
...
SJ_CabBoardSealInfoImp::SJ_CabBoardSealInfoImp( SJ_CabBoardSealInfoImp&& rhs ):Table(rhs)
...
SJ_CabBoardSealInfoImp	SJ_CabBoardSealInfo("");



void	SJ_CabDoorBoardGapInfoImp::SData::SetAll(bool val)
{
...
void	SJ_CabDoorBoardGapInfoImp::SData::Flip()
{
...
void	SJ_CabDoorBoardGapInfoImp::SData::Check()
{
...
void	SJ_CabDoorBoardGapInfoImp::SData::ToUtf8()
{
}

void	SJ_CabDoorBoardGapInfoImp::SData::ToAscii()
{
}

autoDB::SColumns SJ_CabDoorBoardGapInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns SJ_CabDoorBoardGapInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.CabDoorBoardGapID_ )
	{
...
SJ_CabDoorBoardGapInfoImp	SJ_CabDoorBoardGapInfoImp::operator() (const StringType& alias)
{
	return std::move(SJ_CabDoorBoardGapInfoImp(alias));
}

SJ_CabDoorBoardGapInfoImp::SJ_CabDoorBoardGapInfoImp( const StringType& alias ):Table(AUTODB_STR("SJ_CabDoorBoardGapInfo"), alias)
...
SJ_CabDoorBoardGapInfoImp::SJ_CabDoorBoardGapInfoImp( const SJ_CabDoorBoardGapInfoImp& rhs ):Table(rhs)
...
SJ_CabDoorBoardGapInfoImp::SJ_CabDoorBoardGapInfoImp( SJ_CabDoorBoardGapInfoImp&& rhs ):Table(rhs)
...
SJ_CabDoorBoardGapInfoImp	SJ_CabDoorBoardGapInfo("");



void	SJ_CabDoorBoardInfoImp::SData::SetAll(bool val)
{
	val ? CabDoorBoardID_.reset(boost::initialized_value) : CabDoorBoardID_=boost::none;
...
void	SJ_CabDoorBoardInfoImp::SData::Flip()
{
	CabDoorBoardID_ ? CabDoorBoardID_=boost::none : CabDoorBoardID_.reset(boost::initialized_value);
...
void	SJ_CabDoorBoardInfoImp::SData::Check()
{
	if ( !CabDoorBoardID_ )
	{
		CabDoorBoardID_.reset(boost::initialized_value);
...
void	SJ_CabDoorBoardInfoImp::SData::ToUtf8()
{
}

void	SJ_CabDoorBoardInfoImp::SData::ToAscii()
{
}

autoDB::SColumns SJ_CabDoorBoardInfoImp::Use( const SData& data )
{
	SColumns ret;
	if ( data.CabDoorBoardID_ )
	{
...
autoDB::SColumns SJ_CabDoorBoardInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.CabDoorBoardID_ )
	{
...
SJ_CabDoorBoardInfoImp	SJ_CabDoorBoardInfoImp::operator() (const StringType& alias)
{
	return std::move(SJ_CabDoorBoardInfoImp(alias));
}

SJ_CabDoorBoardInfoImp::SJ_CabDoorBoardInfoImp( const StringType& alias ):Table(AUTODB_STR("SJ_CabDoorBoardInfo"), alias)
	,CabDoorBoardID(ImpSPtr_,AUTODB_STR("CabDoorBoardID"))
...
SJ_CabDoorBoardInfoImp::SJ_CabDoorBoardInfoImp( const SJ_CabDoorBoardInfoImp& rhs ):Table(rhs)
	,CabDoorBoardID(rhs.CabDoorBoardID)
...
SJ_CabDoorBoardInfoImp::SJ_CabDoorBoardInfoImp( SJ_CabDoorBoardInfoImp&& rhs ):Table(rhs)
	,CabDoorBoardID(std::move(rhs.CabDoorBoardID))
...
SJ_CabDoorBoardInfoImp	SJ_CabDoorBoardInfo("");



void	SJ_CabDoorBoardSealInfoImp::SData::SetAll(bool val)
{
...
void	SJ_CabDoorBoardSealInfoImp::SData::Flip()
{
...
void	SJ_CabDoorBoardSealInfoImp::SData::Check()
{
...
void	SJ_CabDoorBoardSealInfoImp::SData::ToUtf8()
{
}

void	SJ_CabDoorBoardSealInfoImp::SData::ToAscii()
{
}

autoDB::SColumns SJ_CabDoorBoardSealInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns SJ_CabDoorBoardSealInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.CabDoorBoardSealID_ )
	{
...
SJ_CabDoorBoardSealInfoImp	SJ_CabDoorBoardSealInfoImp::operator() (const StringType& alias)
{
	return std::move(SJ_CabDoorBoardSealInfoImp(alias));
}

SJ_CabDoorBoardSealInfoImp::SJ_CabDoorBoardSealInfoImp( const StringType& alias ):Table(AUTODB_STR("SJ_CabDoorBoardSealInfo"), alias)
...
SJ_CabDoorBoardSealInfoImp::SJ_CabDoorBoardSealInfoImp( const SJ_CabDoorBoardSealInfoImp& rhs ):Table(rhs)
...
SJ_CabDoorBoardSealInfoImp::SJ_CabDoorBoardSealInfoImp( SJ_CabDoorBoardSealInfoImp&& rhs ):Table(rhs)
...
SJ_CabDoorBoardSealInfoImp	SJ_CabDoorBoardSealInfo("");



void	SJ_CabDoorHWFInfoImp::SData::SetAll(bool val)
{
...
void	SJ_CabDoorHWFInfoImp::SData::Flip()
{
...
void	SJ_CabDoorHWFInfoImp::SData::Check()
{
	if ( !CabDoorHWFID_ )
	{
...
void	SJ_CabDoorHWFInfoImp::SData::ToUtf8()
{
}

void	SJ_CabDoorHWFInfoImp::SData::ToAscii()
{
}

autoDB::SColumns SJ_CabDoorHWFInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns SJ_CabDoorHWFInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.CabDoorHWFID_ )
	{
...
SJ_CabDoorHWFInfoImp	SJ_CabDoorHWFInfoImp::operator() (const StringType& alias)
{
	return std::move(SJ_CabDoorHWFInfoImp(alias));
}

SJ_CabDoorHWFInfoImp::SJ_CabDoorHWFInfoImp( const StringType& alias ):Table(AUTODB_STR("SJ_CabDoorHWFInfo"), alias)
...
SJ_CabDoorHWFInfoImp::SJ_CabDoorHWFInfoImp( const SJ_CabDoorHWFInfoImp& rhs ):Table(rhs)
...
SJ_CabDoorHWFInfoImp::SJ_CabDoorHWFInfoImp( SJ_CabDoorHWFInfoImp&& rhs ):Table(rhs)
...
SJ_CabDoorHWFInfoImp	SJ_CabDoorHWFInfo("");



void	SJ_CabDoorHandleInfoImp::SData::SetAll(bool val)
{
...
void	SJ_CabDoorHandleInfoImp::SData::Flip()
{
...
void	SJ_CabDoorHandleInfoImp::SData::Check()
{
	if ( !CabDoorHandleID_ )
	{
...
void	SJ_CabDoorHandleInfoImp::SData::ToUtf8()
{
}

void	SJ_CabDoorHandleInfoImp::SData::ToAscii()
{
}

autoDB::SColumns SJ_CabDoorHandleInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns SJ_CabDoorHandleInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.CabDoorHandleID_ )
	{
...
SJ_CabDoorHandleInfoImp	SJ_CabDoorHandleInfoImp::operator() (const StringType& alias)
{
	return std::move(SJ_CabDoorHandleInfoImp(alias));
}

SJ_CabDoorHandleInfoImp::SJ_CabDoorHandleInfoImp( const StringType& alias ):Table(AUTODB_STR("SJ_CabDoorHandleInfo"), alias)
...
SJ_CabDoorHandleInfoImp::SJ_CabDoorHandleInfoImp( const SJ_CabDoorHandleInfoImp& rhs ):Table(rhs)
...
SJ_CabDoorHandleInfoImp::SJ_CabDoorHandleInfoImp( SJ_CabDoorHandleInfoImp&& rhs ):Table(rhs)
...
SJ_CabDoorHandleInfoImp	SJ_CabDoorHandleInfo("");



void	SJ_CabDoorInfoImp::SData::SetAll(bool val)
{
	val ? CabDoorID_.reset(boost::initialized_value) : CabDoorID_=boost::none;
	val ? CabParentID_.reset(boost::initialized_value) : CabParentID_=boost::none;
	val ? ParentType_.reset(boost::initialized_value) : ParentType_=boost::none;
...
void	SJ_CabDoorInfoImp::SData::Flip()
{
	CabDoorID_ ? CabDoorID_=boost::none : CabDoorID_.reset(boost::initialized_value);
	CabParentID_ ? CabParentID_=boost::none : CabParentID_.reset(boost::initialized_value);
	ParentType_ ? ParentType_=boost::none : ParentType_.reset(boost::initialized_value);
...
void	SJ_CabDoorInfoImp::SData::Check()
{
	if ( !CabDoorID_ )
	{
		CabDoorID_.reset(boost::initialized_value);
...
void	SJ_CabDoorInfoImp::SData::ToUtf8()
{
}

void	SJ_CabDoorInfoImp::SData::ToAscii()
{
}

autoDB::SColumns SJ_CabDoorInfoImp::Use( const SData& data )
{
	SColumns ret;
	if ( data.CabDoorID_ )
	{
...
autoDB::SColumns SJ_CabDoorInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.CabDoorID_ )
	{
...
SJ_CabDoorInfoImp	SJ_CabDoorInfoImp::operator() (const StringType& alias)
{
	return std::move(SJ_CabDoorInfoImp(alias));
}

SJ_CabDoorInfoImp::SJ_CabDoorInfoImp( const StringType& alias ):Table(AUTODB_STR("SJ_CabDoorInfo"), alias)
	,CabDoorID(ImpSPtr_,AUTODB_STR("CabDoorID"))
	,CabParentID(ImpSPtr_,AUTODB_STR("CabParentID"))
	,ParentType(ImpSPtr_,AUTODB_STR("ParentType"))
	,OrderCate(ImpSPtr_,AUTODB_STR("OrderCate"))
...
SJ_CabDoorInfoImp::SJ_CabDoorInfoImp( const SJ_CabDoorInfoImp& rhs ):Table(rhs)
	,CabDoorID(rhs.CabDoorID)
	,CabParentID(rhs.CabParentID)
	,ParentType(rhs.ParentType)
	,OrderCate(rhs.OrderCate)
...
SJ_CabDoorInfoImp::SJ_CabDoorInfoImp( SJ_CabDoorInfoImp&& rhs ):Table(rhs)
	,CabDoorID(std::move(rhs.CabDoorID))
	,CabParentID(std::move(rhs.CabParentID))
	,ParentType(std::move(rhs.ParentType))
	,OrderCate(std::move(rhs.OrderCate))
...
SJ_CabDoorInfoImp	SJ_CabDoorInfo("");



void	SJ_CabDoorRegionInfoImp::SData::SetAll(bool val)
{
	val ? CabDoorRegionID_.reset(boost::initialized_value) : CabDoorRegionID_=boost::none;
...
void	SJ_CabDoorRegionInfoImp::SData::Flip()
{
	CabDoorRegionID_ ? CabDoorRegionID_=boost::none : CabDoorRegionID_.reset(boost::initialized_value);
...
void	SJ_CabDoorRegionInfoImp::SData::Check()
{
	if ( !CabDoorRegionID_ )
	{
		CabDoorRegionID_.reset(boost::initialized_value);
...
void	SJ_CabDoorRegionInfoImp::SData::ToUtf8()
{
}

void	SJ_CabDoorRegionInfoImp::SData::ToAscii()
{
}

autoDB::SColumns SJ_CabDoorRegionInfoImp::Use( const SData& data )
{
	SColumns ret;
	if ( data.CabDoorRegionID_ )
	{
...
autoDB::SColumns SJ_CabDoorRegionInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.CabDoorRegionID_ )
	{
...
SJ_CabDoorRegionInfoImp	SJ_CabDoorRegionInfoImp::operator() (const StringType& alias)
{
	return std::move(SJ_CabDoorRegionInfoImp(alias));
}

SJ_CabDoorRegionInfoImp::SJ_CabDoorRegionInfoImp( const StringType& alias ):Table(AUTODB_STR("SJ_CabDoorRegionInfo"), alias)
	,CabDoorRegionID(ImpSPtr_,AUTODB_STR("CabDoorRegionID"))
...
SJ_CabDoorRegionInfoImp::SJ_CabDoorRegionInfoImp( const SJ_CabDoorRegionInfoImp& rhs ):Table(rhs)
	,CabDoorRegionID(rhs.CabDoorRegionID)
...
SJ_CabDoorRegionInfoImp::SJ_CabDoorRegionInfoImp( SJ_CabDoorRegionInfoImp&& rhs ):Table(rhs)
	,CabDoorRegionID(std::move(rhs.CabDoorRegionID))
...
SJ_CabDoorRegionInfoImp	SJ_CabDoorRegionInfo("");



void	SJ_CabDoorSlideInfoImp::SData::SetAll(bool val)
{
...
void	SJ_CabDoorSlideInfoImp::SData::Flip()
{
...
void	SJ_CabDoorSlideInfoImp::SData::Check()
{
	if ( !CabDoorSlideID_ )
	{
...
void	SJ_CabDoorSlideInfoImp::SData::ToUtf8()
{
}

void	SJ_CabDoorSlideInfoImp::SData::ToAscii()
{
}

autoDB::SColumns SJ_CabDoorSlideInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns SJ_CabDoorSlideInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.CabDoorSlideID_ )
	{
...
SJ_CabDoorSlideInfoImp	SJ_CabDoorSlideInfoImp::operator() (const StringType& alias)
{
	return std::move(SJ_CabDoorSlideInfoImp(alias));
}

SJ_CabDoorSlideInfoImp::SJ_CabDoorSlideInfoImp( const StringType& alias ):Table(AUTODB_STR("SJ_CabDoorSlideInfo"), alias)
...
SJ_CabDoorSlideInfoImp::SJ_CabDoorSlideInfoImp( const SJ_CabDoorSlideInfoImp& rhs ):Table(rhs)
...
SJ_CabDoorSlideInfoImp::SJ_CabDoorSlideInfoImp( SJ_CabDoorSlideInfoImp&& rhs ):Table(rhs)
...
SJ_CabDoorSlideInfoImp	SJ_CabDoorSlideInfo("");



void	SJ_CabDoorSystemInfoImp::SData::SetAll(bool val)
{
	val ? CabDoorSystemID_.reset(boost::initialized_value) : CabDoorSystemID_=boost::none;
	val ? CabID_.reset(boost::initialized_value) : CabID_=boost::none;
	val ? OrderCate_.reset(boost::initialized_value) : OrderCate_=boost::none;
...
void	SJ_CabDoorSystemInfoImp::SData::Flip()
{
	CabDoorSystemID_ ? CabDoorSystemID_=boost::none : CabDoorSystemID_.reset(boost::initialized_value);
	CabID_ ? CabID_=boost::none : CabID_.reset(boost::initialized_value);
	OrderCate_ ? OrderCate_=boost::none : OrderCate_.reset(boost::initialized_value);
...
void	SJ_CabDoorSystemInfoImp::SData::Check()
{
	if ( !CabDoorSystemID_ )
	{
		CabDoorSystemID_.reset(boost::initialized_value);
...
void	SJ_CabDoorSystemInfoImp::SData::ToUtf8()
{
}

void	SJ_CabDoorSystemInfoImp::SData::ToAscii()
{
}

autoDB::SColumns SJ_CabDoorSystemInfoImp::Use( const SData& data )
{
	SColumns ret;
	if ( data.CabDoorSystemID_ )
	{
...
autoDB::SColumns SJ_CabDoorSystemInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.CabDoorSystemID_ )
	{
...
SJ_CabDoorSystemInfoImp	SJ_CabDoorSystemInfoImp::operator() (const StringType& alias)
{
	return std::move(SJ_CabDoorSystemInfoImp(alias));
}

SJ_CabDoorSystemInfoImp::SJ_CabDoorSystemInfoImp( const StringType& alias ):Table(AUTODB_STR("SJ_CabDoorSystemInfo"), alias)
	,CabDoorSystemID(ImpSPtr_,AUTODB_STR("CabDoorSystemID"))
	,CabID(ImpSPtr_,AUTODB_STR("CabID"))
	,OrderCate(ImpSPtr_,AUTODB_STR("OrderCate"))
	,OrderID(ImpSPtr_,AUTODB_STR("OrderID"))
...
SJ_CabDoorSystemInfoImp::SJ_CabDoorSystemInfoImp( const SJ_CabDoorSystemInfoImp& rhs ):Table(rhs)
	,CabDoorSystemID(rhs.CabDoorSystemID)
	,CabID(rhs.CabID)
	,OrderCate(rhs.OrderCate)
	,OrderID(rhs.OrderID)
...
SJ_CabDoorSystemInfoImp::SJ_CabDoorSystemInfoImp( SJ_CabDoorSystemInfoImp&& rhs ):Table(rhs)
	,CabDoorSystemID(std::move(rhs.CabDoorSystemID))
	,CabID(std::move(rhs.CabID))
	,OrderCate(std::move(rhs.OrderCate))
	,OrderID(std::move(rhs.OrderID))
...
SJ_CabDoorSystemInfoImp	SJ_CabDoorSystemInfo("");



void	SJ_CabFNFHWFInfoImp::SData::SetAll(bool val)
{
...
void	SJ_CabFNFHWFInfoImp::SData::Flip()
{
...
void	SJ_CabFNFHWFInfoImp::SData::Check()
{
	if ( !CabFNFHWFID_ )
	{
...
void	SJ_CabFNFHWFInfoImp::SData::ToUtf8()
{
}

void	SJ_CabFNFHWFInfoImp::SData::ToAscii()
{
}

autoDB::SColumns SJ_CabFNFHWFInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns SJ_CabFNFHWFInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.CabFNFHWFID_ )
	{
...
SJ_CabFNFHWFInfoImp	SJ_CabFNFHWFInfoImp::operator() (const StringType& alias)
{
	return std::move(SJ_CabFNFHWFInfoImp(alias));
}

SJ_CabFNFHWFInfoImp::SJ_CabFNFHWFInfoImp( const StringType& alias ):Table(AUTODB_STR("SJ_CabFNFHWFInfo"), alias)
...
SJ_CabFNFHWFInfoImp::SJ_CabFNFHWFInfoImp( const SJ_CabFNFHWFInfoImp& rhs ):Table(rhs)
...
SJ_CabFNFHWFInfoImp::SJ_CabFNFHWFInfoImp( SJ_CabFNFHWFInfoImp&& rhs ):Table(rhs)
...
SJ_CabFNFHWFInfoImp	SJ_CabFNFHWFInfo("");



void	SJ_CabFNFHoleInfoImp::SData::SetAll(bool val)
{
...
void	SJ_CabFNFHoleInfoImp::SData::Flip()
{
...
void	SJ_CabFNFHoleInfoImp::SData::Check()
{
	if ( !CabFNFHoleID_ )
	{
...
void	SJ_CabFNFHoleInfoImp::SData::ToUtf8()
{
}

void	SJ_CabFNFHoleInfoImp::SData::ToAscii()
{
}

autoDB::SColumns SJ_CabFNFHoleInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns SJ_CabFNFHoleInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.CabFNFHoleID_ )
	{
...
SJ_CabFNFHoleInfoImp	SJ_CabFNFHoleInfoImp::operator() (const StringType& alias)
{
	return std::move(SJ_CabFNFHoleInfoImp(alias));
}

SJ_CabFNFHoleInfoImp::SJ_CabFNFHoleInfoImp( const StringType& alias ):Table(AUTODB_STR("SJ_CabFNFHoleInfo"), alias)
...
SJ_CabFNFHoleInfoImp::SJ_CabFNFHoleInfoImp( const SJ_CabFNFHoleInfoImp& rhs ):Table(rhs)
...
SJ_CabFNFHoleInfoImp::SJ_CabFNFHoleInfoImp( SJ_CabFNFHoleInfoImp&& rhs ):Table(rhs)
...
SJ_CabFNFHoleInfoImp	SJ_CabFNFHoleInfo("");



void	SJ_CabFNFInfoImp::SData::SetAll(bool val)
{
	val ? CabFNFID_.reset(boost::initialized_value) : CabFNFID_=boost::none;
...
void	SJ_CabFNFInfoImp::SData::Flip()
{
	CabFNFID_ ? CabFNFID_=boost::none : CabFNFID_.reset(boost::initialized_value);
...
void	SJ_CabFNFInfoImp::SData::Check()
{
	if ( !CabFNFID_ )
	{
		CabFNFID_.reset(boost::initialized_value);
...
void	SJ_CabFNFInfoImp::SData::ToUtf8()
{
	if ( UserMemo_ )
	{
...
void	SJ_CabFNFInfoImp::SData::ToAscii()
{
	if ( UserMemo_ )
	{
...
autoDB::SColumns SJ_CabFNFInfoImp::Use( const SData& data )
{
	SColumns ret;
	if ( data.CabFNFID_ )
	{
...
autoDB::SColumns SJ_CabFNFInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.CabFNFID_ )
	{
...
SJ_CabFNFInfoImp	SJ_CabFNFInfoImp::operator() (const StringType& alias)
{
	return std::move(SJ_CabFNFInfoImp(alias));
}

SJ_CabFNFInfoImp::SJ_CabFNFInfoImp( const StringType& alias ):Table(AUTODB_STR("SJ_CabFNFInfo"), alias)
	,CabFNFID(ImpSPtr_,AUTODB_STR("CabFNFID"))
...
SJ_CabFNFInfoImp::SJ_CabFNFInfoImp( const SJ_CabFNFInfoImp& rhs ):Table(rhs)
	,CabFNFID(rhs.CabFNFID)
...
SJ_CabFNFInfoImp::SJ_CabFNFInfoImp( SJ_CabFNFInfoImp&& rhs ):Table(rhs)
	,CabFNFID(std::move(rhs.CabFNFID))
...
SJ_CabFNFInfoImp	SJ_CabFNFInfo("");



void	SJ_CabFNFPartInfoImp::SData::SetAll(bool val)
{
...
void	SJ_CabFNFPartInfoImp::SData::Flip()
{
...
void	SJ_CabFNFPartInfoImp::SData::Check()
{
	if ( !CabFNFPartID_ )
	{
...
void	SJ_CabFNFPartInfoImp::SData::ToUtf8()
{
}

void	SJ_CabFNFPartInfoImp::SData::ToAscii()
{
}

autoDB::SColumns SJ_CabFNFPartInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns SJ_CabFNFPartInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.CabFNFPartID_ )
	{
...
SJ_CabFNFPartInfoImp	SJ_CabFNFPartInfoImp::operator() (const StringType& alias)
{
	return std::move(SJ_CabFNFPartInfoImp(alias));
}

SJ_CabFNFPartInfoImp::SJ_CabFNFPartInfoImp( const StringType& alias ):Table(AUTODB_STR("SJ_CabFNFPartInfo"), alias)
...
SJ_CabFNFPartInfoImp::SJ_CabFNFPartInfoImp( const SJ_CabFNFPartInfoImp& rhs ):Table(rhs)
...
SJ_CabFNFPartInfoImp::SJ_CabFNFPartInfoImp( SJ_CabFNFPartInfoImp&& rhs ):Table(rhs)
...
SJ_CabFNFPartInfoImp	SJ_CabFNFPartInfo("");



void	SJ_CabFNFPartSealInfoImp::SData::SetAll(bool val)
{
...
void	SJ_CabFNFPartSealInfoImp::SData::Flip()
{
...
void	SJ_CabFNFPartSealInfoImp::SData::Check()
{
...
void	SJ_CabFNFPartSealInfoImp::SData::ToUtf8()
{
}

void	SJ_CabFNFPartSealInfoImp::SData::ToAscii()
{
}

autoDB::SColumns SJ_CabFNFPartSealInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns SJ_CabFNFPartSealInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.CabFNFPartSealID_ )
	{
...
SJ_CabFNFPartSealInfoImp	SJ_CabFNFPartSealInfoImp::operator() (const StringType& alias)
{
	return std::move(SJ_CabFNFPartSealInfoImp(alias));
}

SJ_CabFNFPartSealInfoImp::SJ_CabFNFPartSealInfoImp( const StringType& alias ):Table(AUTODB_STR("SJ_CabFNFPartSealInfo"), alias)
...
SJ_CabFNFPartSealInfoImp::SJ_CabFNFPartSealInfoImp( const SJ_CabFNFPartSealInfoImp& rhs ):Table(rhs)
...
SJ_CabFNFPartSealInfoImp::SJ_CabFNFPartSealInfoImp( SJ_CabFNFPartSealInfoImp&& rhs ):Table(rhs)
...
SJ_CabFNFPartSealInfoImp	SJ_CabFNFPartSealInfo("");



void	SJ_CabInfoImp::SData::SetAll(bool val)
{
	val ? CabID_.reset(boost::initialized_value) : CabID_=boost::none;
	val ? OrderCate_.reset(boost::initialized_value) : OrderCate_=boost::none;
	val ? DesignPlanID_.reset(boost::initialized_value) : DesignPlanID_=boost::none;
...
void	SJ_CabInfoImp::SData::Check()
{
	if ( !CabID_ )
	{
		CabID_.reset(boost::initialized_value);
...
void	SJ_CabInfoImp::SData::ToUtf8()
{
}

void	SJ_CabInfoImp::SData::ToAscii()
{
}

autoDB::SColumns SJ_CabInfoImp::Use( const SData& data )
{
	SColumns ret;
	if ( data.CabID_ )
	{
...
autoDB::SColumns SJ_CabInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.CabID_ )
	{
...
SJ_CabInfoImp	SJ_CabInfoImp::operator() (const StringType& alias)
{
	return std::move(SJ_CabInfoImp(alias));
}

SJ_CabInfoImp::SJ_CabInfoImp( const StringType& alias ):Table(AUTODB_STR("SJ_CabInfo"), alias)
	,CabID(ImpSPtr_,AUTODB_STR("CabID"))
	,OrderCate(ImpSPtr_,AUTODB_STR("OrderCate"))
	,DesignPlanID(ImpSPtr_,AUTODB_STR("DesignPlanID"))
	,OrderID(ImpSPtr_,AUTODB_STR("OrderID"))
...
SJ_CabInfoImp::SJ_CabInfoImp( const SJ_CabInfoImp& rhs ):Table(rhs)
	,CabID(rhs.CabID)
	,OrderCate(rhs.OrderCate)
	,DesignPlanID(rhs.DesignPlanID)
	,OrderID(rhs.OrderID)
...
SJ_CabInfoImp::SJ_CabInfoImp( SJ_CabInfoImp&& rhs ):Table(rhs)
	,CabID(std::move(rhs.CabID))
	,OrderCate(std::move(rhs.OrderCate))
	,DesignPlanID(std::move(rhs.DesignPlanID))
	,OrderID(std::move(rhs.OrderID))
...
SJ_CabInfoImp	SJ_CabInfo("");



void	SJ_DecorBoardInfoImp::SData::SetAll(bool val)
{
...
void	SJ_DecorBoardInfoImp::SData::Flip()
{
...
void	SJ_DecorBoardInfoImp::SData::Check()
{
...
void	SJ_DecorBoardInfoImp::SData::ToUtf8()
{
}

void	SJ_DecorBoardInfoImp::SData::ToAscii()
{
}

autoDB::SColumns SJ_DecorBoardInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns SJ_DecorBoardInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.DesignDecorBoardID_ )
	{
...
SJ_DecorBoardInfoImp	SJ_DecorBoardInfoImp::operator() (const StringType& alias)
{
	return std::move(SJ_DecorBoardInfoImp(alias));
}

SJ_DecorBoardInfoImp::SJ_DecorBoardInfoImp( const StringType& alias ):Table(AUTODB_STR("SJ_DecorBoardInfo"), alias)
...
SJ_DecorBoardInfoImp::SJ_DecorBoardInfoImp( const SJ_DecorBoardInfoImp& rhs ):Table(rhs)
...
SJ_DecorBoardInfoImp::SJ_DecorBoardInfoImp( SJ_DecorBoardInfoImp&& rhs ):Table(rhs)
...
SJ_DecorBoardInfoImp	SJ_DecorBoardInfo("");



void	SJ_DecorBoardUnitInfoImp::SData::SetAll(bool val)
{
...
void	SJ_DecorBoardUnitInfoImp::SData::Flip()
{
...
void	SJ_DecorBoardUnitInfoImp::SData::Check()
{
...
void	SJ_DecorBoardUnitInfoImp::SData::ToUtf8()
{
}

void	SJ_DecorBoardUnitInfoImp::SData::ToAscii()
{
}

autoDB::SColumns SJ_DecorBoardUnitInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns SJ_DecorBoardUnitInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.DesignDecorBoardUnitID_ )
	{
...
SJ_DecorBoardUnitInfoImp	SJ_DecorBoardUnitInfoImp::operator() (const StringType& alias)
{
	return std::move(SJ_DecorBoardUnitInfoImp(alias));
}

SJ_DecorBoardUnitInfoImp::SJ_DecorBoardUnitInfoImp( const StringType& alias ):Table(AUTODB_STR("SJ_DecorBoardUnitInfo"), alias)
...
SJ_DecorBoardUnitInfoImp::SJ_DecorBoardUnitInfoImp( const SJ_DecorBoardUnitInfoImp& rhs ):Table(rhs)
...
SJ_DecorBoardUnitInfoImp::SJ_DecorBoardUnitInfoImp( SJ_DecorBoardUnitInfoImp&& rhs ):Table(rhs)
...
SJ_DecorBoardUnitInfoImp	SJ_DecorBoardUnitInfo("");



void	SJ_DecorBoardUnitSealInfoImp::SData::SetAll(bool val)
{
...
void	SJ_DecorBoardUnitSealInfoImp::SData::Flip()
{
...
void	SJ_DecorBoardUnitSealInfoImp::SData::Check()
{
...
void	SJ_DecorBoardUnitSealInfoImp::SData::ToUtf8()
{
}

void	SJ_DecorBoardUnitSealInfoImp::SData::ToAscii()
{
}

autoDB::SColumns SJ_DecorBoardUnitSealInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns SJ_DecorBoardUnitSealInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.DesignDecorBoardUnitSealID_ )
	{
...
SJ_DecorBoardUnitSealInfoImp	SJ_DecorBoardUnitSealInfoImp::operator() (const StringType& alias)
{
	return std::move(SJ_DecorBoardUnitSealInfoImp(alias));
}

SJ_DecorBoardUnitSealInfoImp::SJ_DecorBoardUnitSealInfoImp( const StringType& alias ):Table(AUTODB_STR("SJ_DecorBoardUnitSealInfo"), alias)
...
SJ_DecorBoardUnitSealInfoImp::SJ_DecorBoardUnitSealInfoImp( const SJ_DecorBoardUnitSealInfoImp& rhs ):Table(rhs)
...
SJ_DecorBoardUnitSealInfoImp::SJ_DecorBoardUnitSealInfoImp( SJ_DecorBoardUnitSealInfoImp&& rhs ):Table(rhs)
...
SJ_DecorBoardUnitSealInfoImp	SJ_DecorBoardUnitSealInfo("");



void	SJ_DecorInfoImp::SData::SetAll(bool val)
{
...
void	SJ_DecorInfoImp::SData::Flip()
{
...
void	SJ_DecorInfoImp::SData::Check()
{
	if ( !DesignDecorID_ )
	{
...
void	SJ_DecorInfoImp::SData::ToUtf8()
{
}

void	SJ_DecorInfoImp::SData::ToAscii()
{
}

autoDB::SColumns SJ_DecorInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns SJ_DecorInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.DesignDecorID_ )
	{
...
SJ_DecorInfoImp	SJ_DecorInfoImp::operator() (const StringType& alias)
{
	return std::move(SJ_DecorInfoImp(alias));
}

SJ_DecorInfoImp::SJ_DecorInfoImp( const StringType& alias ):Table(AUTODB_STR("SJ_DecorInfo"), alias)
...
SJ_DecorInfoImp::SJ_DecorInfoImp( const SJ_DecorInfoImp& rhs ):Table(rhs)
...
SJ_DecorInfoImp::SJ_DecorInfoImp( SJ_DecorInfoImp&& rhs ):Table(rhs)
...
SJ_DecorInfoImp	SJ_DecorInfo("");



void	SJ_DecorLineInfoImp::SData::SetAll(bool val)
{
...
void	SJ_DecorLineInfoImp::SData::Flip()
{
...
void	SJ_DecorLineInfoImp::SData::Check()
{
...
void	SJ_DecorLineInfoImp::SData::ToUtf8()
{
}

void	SJ_DecorLineInfoImp::SData::ToAscii()
{
}

autoDB::SColumns SJ_DecorLineInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns SJ_DecorLineInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.DesignDecorLineID_ )
	{
...
SJ_DecorLineInfoImp	SJ_DecorLineInfoImp::operator() (const StringType& alias)
{
	return std::move(SJ_DecorLineInfoImp(alias));
}

SJ_DecorLineInfoImp::SJ_DecorLineInfoImp( const StringType& alias ):Table(AUTODB_STR("SJ_DecorLineInfo"), alias)
...
SJ_DecorLineInfoImp::SJ_DecorLineInfoImp( const SJ_DecorLineInfoImp& rhs ):Table(rhs)
...
SJ_DecorLineInfoImp::SJ_DecorLineInfoImp( SJ_DecorLineInfoImp&& rhs ):Table(rhs)
...
SJ_DecorLineInfoImp	SJ_DecorLineInfo("");



void	SJ_DesignPlanInfoImp::SData::SetAll(bool val)
{
	val ? DesignPlanID_.reset(boost::initialized_value) : DesignPlanID_=boost::none;
	val ? OrderCate_.reset(boost::initialized_value) : OrderCate_=boost::none;
	val ? OrderID_.reset(boost::initialized_value) : OrderID_=boost::none;
...
void	SJ_DesignPlanInfoImp::SData::Flip()
{
	DesignPlanID_ ? DesignPlanID_=boost::none : DesignPlanID_.reset(boost::initialized_value);
	OrderCate_ ? OrderCate_=boost::none : OrderCate_.reset(boost::initialized_value);
	OrderID_ ? OrderID_=boost::none : OrderID_.reset(boost::initialized_value);
...
void	SJ_DesignPlanInfoImp::SData::Check()
{
	if ( !DesignPlanID_ )
	{
		DesignPlanID_.reset(boost::initialized_value);
...
void	SJ_DesignPlanInfoImp::SData::ToUtf8()
{
	if ( DesignPlanName_ )
	{
...
void	SJ_DesignPlanInfoImp::SData::ToAscii()
{
	if ( DesignPlanName_ )
	{
...
autoDB::SColumns SJ_DesignPlanInfoImp::Use( const SData& data )
{
	SColumns ret;
	if ( data.DesignPlanID_ )
	{
...
autoDB::SColumns SJ_DesignPlanInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.DesignPlanID_ )
	{
...
SJ_DesignPlanInfoImp	SJ_DesignPlanInfoImp::operator() (const StringType& alias)
{
	return std::move(SJ_DesignPlanInfoImp(alias));
}

SJ_DesignPlanInfoImp::SJ_DesignPlanInfoImp( const StringType& alias ):Table(AUTODB_STR("SJ_DesignPlanInfo"), alias)
	,DesignPlanID(ImpSPtr_,AUTODB_STR("DesignPlanID"))
	,OrderCate(ImpSPtr_,AUTODB_STR("OrderCate"))
	,OrderID(ImpSPtr_,AUTODB_STR("OrderID"))
	,FactoryID(ImpSPtr_,AUTODB_STR("FactoryID"))
...
SJ_DesignPlanInfoImp::SJ_DesignPlanInfoImp( const SJ_DesignPlanInfoImp& rhs ):Table(rhs)
	,DesignPlanID(rhs.DesignPlanID)
	,OrderCate(rhs.OrderCate)
	,OrderID(rhs.OrderID)
	,FactoryID(rhs.FactoryID)
...
SJ_DesignPlanInfoImp::SJ_DesignPlanInfoImp( SJ_DesignPlanInfoImp&& rhs ):Table(rhs)
	,DesignPlanID(std::move(rhs.DesignPlanID))
	,OrderCate(std::move(rhs.OrderCate))
	,OrderID(std::move(rhs.OrderID))
	,FactoryID(std::move(rhs.FactoryID))
...
SJ_DesignPlanInfoImp	SJ_DesignPlanInfo("");



void	SJ_FittingInfoImp::SData::SetAll(bool val)
{
...
void	SJ_FittingInfoImp::SData::Flip()
{
...
void	SJ_FittingInfoImp::SData::Check()
{
	if ( !DesignFittingID_ )
	{
...
void	SJ_FittingInfoImp::SData::ToUtf8()
{
}

void	SJ_FittingInfoImp::SData::ToAscii()
{
}

autoDB::SColumns SJ_FittingInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns SJ_FittingInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.DesignFittingID_ )
	{
...
SJ_FittingInfoImp	SJ_FittingInfoImp::operator() (const StringType& alias)
{
	return std::move(SJ_FittingInfoImp(alias));
}

SJ_FittingInfoImp::SJ_FittingInfoImp( const StringType& alias ):Table(AUTODB_STR("SJ_FittingInfo"), alias)
...
SJ_FittingInfoImp::SJ_FittingInfoImp( const SJ_FittingInfoImp& rhs ):Table(rhs)
...
SJ_FittingInfoImp::SJ_FittingInfoImp( SJ_FittingInfoImp&& rhs ):Table(rhs)
...
SJ_FittingInfoImp	SJ_FittingInfo("");



void	SJ_HWFInfoImp::SData::SetAll(bool val)
{
...
void	SJ_HWFInfoImp::SData::Check()
{
	if ( !DesignHWFID_ )
	{
...
void	SJ_HWFInfoImp::SData::ToUtf8()
{
}

void	SJ_HWFInfoImp::SData::ToAscii()
{
}

autoDB::SColumns SJ_HWFInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns SJ_HWFInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.DesignHWFID_ )
	{
...
SJ_HWFInfoImp	SJ_HWFInfoImp::operator() (const StringType& alias)
{
	return std::move(SJ_HWFInfoImp(alias));
}

SJ_HWFInfoImp::SJ_HWFInfoImp( const StringType& alias ):Table(AUTODB_STR("SJ_HWFInfo"), alias)
...
SJ_HWFInfoImp::SJ_HWFInfoImp( const SJ_HWFInfoImp& rhs ):Table(rhs)
...
SJ_HWFInfoImp::SJ_HWFInfoImp( SJ_HWFInfoImp&& rhs ):Table(rhs)
...
SJ_HWFInfoImp	SJ_HWFInfo("");



void	SJ_MarkInfoImp::SData::SetAll(bool val)
{
...
void	SJ_MarkInfoImp::SData::Flip()
{
...
void	SJ_MarkInfoImp::SData::Check()
{
	if ( !DesignMarkID_ )
	{
...
void	SJ_MarkInfoImp::SData::ToUtf8()
{
	if ( FaceName_ )
	{
...
void	SJ_MarkInfoImp::SData::ToAscii()
{
	if ( FaceName_ )
	{
...
autoDB::SColumns SJ_MarkInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns SJ_MarkInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.DesignMarkID_ )
	{
...
SJ_MarkInfoImp	SJ_MarkInfoImp::operator() (const StringType& alias)
{
	return std::move(SJ_MarkInfoImp(alias));
}

SJ_MarkInfoImp::SJ_MarkInfoImp( const StringType& alias ):Table(AUTODB_STR("SJ_MarkInfo"), alias)
...
SJ_MarkInfoImp::SJ_MarkInfoImp( const SJ_MarkInfoImp& rhs ):Table(rhs)
...
SJ_MarkInfoImp::SJ_MarkInfoImp( SJ_MarkInfoImp&& rhs ):Table(rhs)
...
SJ_MarkInfoImp	SJ_MarkInfo("");



void	SJ_MatrixInfoImp::SData::SetAll(bool val)
{
	val ? OrderID_.reset(boost::initialized_value) : OrderID_=boost::none;
	val ? OrderCate_.reset(boost::initialized_value) : OrderCate_=boost::none;
	val ? DesignPlanID_.reset(boost::initialized_value) : DesignPlanID_=boost::none;
...
void	SJ_MatrixInfoImp::SData::Flip()
{
	OrderID_ ? OrderID_=boost::none : OrderID_.reset(boost::initialized_value);
	OrderCate_ ? OrderCate_=boost::none : OrderCate_.reset(boost::initialized_value);
	DesignPlanID_ ? DesignPlanID_=boost::none : DesignPlanID_.reset(boost::initialized_value);
...
void	SJ_MatrixInfoImp::SData::Check()
{
	if ( !OrderID_ )
	{
		OrderID_.reset(boost::initialized_value);
...
void	SJ_MatrixInfoImp::SData::ToUtf8()
{
}

void	SJ_MatrixInfoImp::SData::ToAscii()
{
}

autoDB::SColumns SJ_MatrixInfoImp::Use( const SData& data )
{
	SColumns ret;
	if ( data.OrderID_ )
	{
...
autoDB::SColumns SJ_MatrixInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.OrderID_ )
	{
...
SJ_MatrixInfoImp	SJ_MatrixInfoImp::operator() (const StringType& alias)
{
	return std::move(SJ_MatrixInfoImp(alias));
}

SJ_MatrixInfoImp::SJ_MatrixInfoImp( const StringType& alias ):Table(AUTODB_STR("SJ_MatrixInfo"), alias)
	,OrderID(ImpSPtr_,AUTODB_STR("OrderID"))
	,OrderCate(ImpSPtr_,AUTODB_STR("OrderCate"))
	,DesignPlanID(ImpSPtr_,AUTODB_STR("DesignPlanID"))
	,FactoryID(ImpSPtr_,AUTODB_STR("FactoryID"))
...
SJ_MatrixInfoImp::SJ_MatrixInfoImp( const SJ_MatrixInfoImp& rhs ):Table(rhs)
	,OrderID(rhs.OrderID)
	,OrderCate(rhs.OrderCate)
	,DesignPlanID(rhs.DesignPlanID)
	,FactoryID(rhs.FactoryID)
...
SJ_MatrixInfoImp::SJ_MatrixInfoImp( SJ_MatrixInfoImp&& rhs ):Table(rhs)
	,OrderID(std::move(rhs.OrderID))
	,OrderCate(std::move(rhs.OrderCate))
	,DesignPlanID(std::move(rhs.DesignPlanID))
	,FactoryID(std::move(rhs.FactoryID))
...
SJ_MatrixInfoImp	SJ_MatrixInfo("");



void	SJ_OrderAddedInfoImp::SData::SetAll(bool val)
{
...
void	SJ_OrderAddedInfoImp::SData::Flip()
{
...
void	SJ_OrderAddedInfoImp::SData::Check()
{
	if ( !OrderAddedID_ )
	{
...
void	SJ_OrderAddedInfoImp::SData::ToUtf8()
{
	if ( AddedName_ )
	{
...
void	SJ_OrderAddedInfoImp::SData::ToAscii()
{
	if ( AddedName_ )
	{
...
autoDB::SColumns SJ_OrderAddedInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns SJ_OrderAddedInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.OrderAddedID_ )
	{
...
SJ_OrderAddedInfoImp	SJ_OrderAddedInfoImp::operator() (const StringType& alias)
{
	return std::move(SJ_OrderAddedInfoImp(alias));
}

SJ_OrderAddedInfoImp::SJ_OrderAddedInfoImp( const StringType& alias ):Table(AUTODB_STR("SJ_OrderAddedInfo"), alias)
...
SJ_OrderAddedInfoImp::SJ_OrderAddedInfoImp( const SJ_OrderAddedInfoImp& rhs ):Table(rhs)
...
SJ_OrderAddedInfoImp::SJ_OrderAddedInfoImp( SJ_OrderAddedInfoImp&& rhs ):Table(rhs)
...
SJ_OrderAddedInfoImp	SJ_OrderAddedInfo("");



void	SJ_OrderDataInfoImp::SData::SetAll(bool val)
{
	val ? OrderID_.reset(boost::initialized_value) : OrderID_=boost::none;
	val ? OrderCate_.reset(boost::initialized_value) : OrderCate_=boost::none;
	val ? FactoryID_.reset(boost::initialized_value) : FactoryID_=boost::none;
...
void	SJ_OrderDataInfoImp::SData::Flip()
{
	OrderID_ ? OrderID_=boost::none : OrderID_.reset(boost::initialized_value);
	OrderCate_ ? OrderCate_=boost::none : OrderCate_.reset(boost::initialized_value);
	FactoryID_ ? FactoryID_=boost::none : FactoryID_.reset(boost::initialized_value);
...
void	SJ_OrderDataInfoImp::SData::Check()
{
	if ( !OrderID_ )
	{
		OrderID_.reset(boost::initialized_value);
...
void	SJ_OrderDataInfoImp::SData::ToUtf8()
{
	if ( GeoCode_ )
	{
...
void	SJ_OrderDataInfoImp::SData::ToAscii()
{
	if ( GeoCode_ )
	{
...
autoDB::SColumns SJ_OrderDataInfoImp::Use( const SData& data )
{
	SColumns ret;
	if ( data.OrderID_ )
	{
...
autoDB::SColumns SJ_OrderDataInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.OrderID_ )
	{
...
SJ_OrderDataInfoImp	SJ_OrderDataInfoImp::operator() (const StringType& alias)
{
	return std::move(SJ_OrderDataInfoImp(alias));
}

SJ_OrderDataInfoImp::SJ_OrderDataInfoImp( const StringType& alias ):Table(AUTODB_STR("SJ_OrderDataInfo"), alias)
	,OrderID(ImpSPtr_,AUTODB_STR("OrderID"))
	,OrderCate(ImpSPtr_,AUTODB_STR("OrderCate"))
	,FactoryID(ImpSPtr_,AUTODB_STR("FactoryID"))
...
SJ_OrderDataInfoImp::SJ_OrderDataInfoImp( const SJ_OrderDataInfoImp& rhs ):Table(rhs)
	,OrderID(rhs.OrderID)
	,OrderCate(rhs.OrderCate)
	,FactoryID(rhs.FactoryID)
	,ShopID(rhs.ShopID)
...
SJ_OrderDataInfoImp::SJ_OrderDataInfoImp( SJ_OrderDataInfoImp&& rhs ):Table(rhs)
	,OrderID(std::move(rhs.OrderID))
	,OrderCate(std::move(rhs.OrderCate))
	,FactoryID(std::move(rhs.FactoryID))
...
SJ_OrderDataInfoImp	SJ_OrderDataInfo("");



void	SJ_PackInfoImp::SData::SetAll(bool val)
{
...
void	SJ_PackInfoImp::SData::Flip()
{
...
void	SJ_PackInfoImp::SData::Check()
{
	if ( !DesignPackID_ )
	{
...
void	SJ_PackInfoImp::SData::ToUtf8()
{
}

void	SJ_PackInfoImp::SData::ToAscii()
{
}

autoDB::SColumns SJ_PackInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns SJ_PackInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.DesignPackID_ )
	{
...
SJ_PackInfoImp	SJ_PackInfoImp::operator() (const StringType& alias)
{
	return std::move(SJ_PackInfoImp(alias));
}

SJ_PackInfoImp::SJ_PackInfoImp( const StringType& alias ):Table(AUTODB_STR("SJ_PackInfo"), alias)
...
SJ_PackInfoImp::SJ_PackInfoImp( const SJ_PackInfoImp& rhs ):Table(rhs)
...
SJ_PackInfoImp::SJ_PackInfoImp( SJ_PackInfoImp&& rhs ):Table(rhs)
...
SJ_PackInfoImp	SJ_PackInfo("");



void	SJ_PointInfoImp::SData::SetAll(bool val)
{
	val ? DesignPlanID_.reset(boost::initialized_value) : DesignPlanID_=boost::none;
	val ? OrderCate_.reset(boost::initialized_value) : OrderCate_=boost::none;
	val ? OrderID_.reset(boost::initialized_value) : OrderID_=boost::none;
...
void	SJ_PointInfoImp::SData::Flip()
{
	DesignPlanID_ ? DesignPlanID_=boost::none : DesignPlanID_.reset(boost::initialized_value);
	OrderCate_ ? OrderCate_=boost::none : OrderCate_.reset(boost::initialized_value);
	OrderID_ ? OrderID_=boost::none : OrderID_.reset(boost::initialized_value);
...
void	SJ_PointInfoImp::SData::Check()
{
	if ( !DesignPlanID_ )
	{
		DesignPlanID_.reset(boost::initialized_value);
...
void	SJ_PointInfoImp::SData::ToUtf8()
{
}

void	SJ_PointInfoImp::SData::ToAscii()
{
}

autoDB::SColumns SJ_PointInfoImp::Use( const SData& data )
{
	SColumns ret;
	if ( data.DesignPlanID_ )
	{
...
autoDB::SColumns SJ_PointInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.DesignPlanID_ )
	{
...
SJ_PointInfoImp	SJ_PointInfoImp::operator() (const StringType& alias)
{
	return std::move(SJ_PointInfoImp(alias));
}

SJ_PointInfoImp::SJ_PointInfoImp( const StringType& alias ):Table(AUTODB_STR("SJ_PointInfo"), alias)
	,DesignPlanID(ImpSPtr_,AUTODB_STR("DesignPlanID"))
	,OrderCate(ImpSPtr_,AUTODB_STR("OrderCate"))
	,OrderID(ImpSPtr_,AUTODB_STR("OrderID"))
	,FactoryID(ImpSPtr_,AUTODB_STR("FactoryID"))
...
SJ_PointInfoImp::SJ_PointInfoImp( const SJ_PointInfoImp& rhs ):Table(rhs)
	,DesignPlanID(rhs.DesignPlanID)
	,OrderCate(rhs.OrderCate)
	,OrderID(rhs.OrderID)
	,FactoryID(rhs.FactoryID)
...
SJ_PointInfoImp::SJ_PointInfoImp( SJ_PointInfoImp&& rhs ):Table(rhs)
	,DesignPlanID(std::move(rhs.DesignPlanID))
	,OrderCate(std::move(rhs.OrderCate))
	,OrderID(std::move(rhs.OrderID))
	,FactoryID(std::move(rhs.FactoryID))
...
SJ_PointInfoImp	SJ_PointInfo("");



void	SJ_PrintElementInfoImp::SData::SetAll(bool val)
{
...
void	SJ_PrintElementInfoImp::SData::Flip()
{
...
void	SJ_PrintElementInfoImp::SData::Check()
{
...
void	SJ_PrintElementInfoImp::SData::ToUtf8()
{
}

void	SJ_PrintElementInfoImp::SData::ToAscii()
{
}

autoDB::SColumns SJ_PrintElementInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns SJ_PrintElementInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.DesignPrintElementID_ )
	{
...
SJ_PrintElementInfoImp	SJ_PrintElementInfoImp::operator() (const StringType& alias)
{
	return std::move(SJ_PrintElementInfoImp(alias));
}

SJ_PrintElementInfoImp::SJ_PrintElementInfoImp( const StringType& alias ):Table(AUTODB_STR("SJ_PrintElementInfo"), alias)
...
SJ_PrintElementInfoImp::SJ_PrintElementInfoImp( const SJ_PrintElementInfoImp& rhs ):Table(rhs)
...
SJ_PrintElementInfoImp::SJ_PrintElementInfoImp( SJ_PrintElementInfoImp&& rhs ):Table(rhs)
...
SJ_PrintElementInfoImp	SJ_PrintElementInfo("");



void	SJ_PrintGroupInfoImp::SData::SetAll(bool val)
{
	val ? DesignPrintGroupID_.reset(boost::initialized_value) : DesignPrintGroupID_=boost::none;
	val ? DesignPrintID_.reset(boost::initialized_value) : DesignPrintID_=boost::none;
	val ? OrderCate_.reset(boost::initialized_value) : OrderCate_=boost::none;
...
void	SJ_PrintGroupInfoImp::SData::Flip()
{
	DesignPrintGroupID_ ? DesignPrintGroupID_=boost::none : DesignPrintGroupID_.reset(boost::initialized_value);
	DesignPrintID_ ? DesignPrintID_=boost::none : DesignPrintID_.reset(boost::initialized_value);
	OrderCate_ ? OrderCate_=boost::none : OrderCate_.reset(boost::initialized_value);
...
void	SJ_PrintGroupInfoImp::SData::Check()
{
	if ( !DesignPrintGroupID_ )
	{
		DesignPrintGroupID_.reset(boost::initialized_value);
...
void	SJ_PrintGroupInfoImp::SData::ToUtf8()
{
}

void	SJ_PrintGroupInfoImp::SData::ToAscii()
{
}

autoDB::SColumns SJ_PrintGroupInfoImp::Use( const SData& data )
{
	SColumns ret;
	if ( data.DesignPrintGroupID_ )
	{
...
autoDB::SColumns SJ_PrintGroupInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.DesignPrintGroupID_ )
	{
...
SJ_PrintGroupInfoImp	SJ_PrintGroupInfoImp::operator() (const StringType& alias)
{
	return std::move(SJ_PrintGroupInfoImp(alias));
}

SJ_PrintGroupInfoImp::SJ_PrintGroupInfoImp( const StringType& alias ):Table(AUTODB_STR("SJ_PrintGroupInfo"), alias)
	,DesignPrintGroupID(ImpSPtr_,AUTODB_STR("DesignPrintGroupID"))
	,DesignPrintID(ImpSPtr_,AUTODB_STR("DesignPrintID"))
	,OrderCate(ImpSPtr_,AUTODB_STR("OrderCate"))
	,DesignPlanID(ImpSPtr_,AUTODB_STR("DesignPlanID"))
...
SJ_PrintGroupInfoImp::SJ_PrintGroupInfoImp( const SJ_PrintGroupInfoImp& rhs ):Table(rhs)
	,DesignPrintGroupID(rhs.DesignPrintGroupID)
	,DesignPrintID(rhs.DesignPrintID)
	,OrderCate(rhs.OrderCate)
	,DesignPlanID(rhs.DesignPlanID)
...
SJ_PrintGroupInfoImp::SJ_PrintGroupInfoImp( SJ_PrintGroupInfoImp&& rhs ):Table(rhs)
	,DesignPrintGroupID(std::move(rhs.DesignPrintGroupID))
	,DesignPrintID(std::move(rhs.DesignPrintID))
	,OrderCate(std::move(rhs.OrderCate))
	,DesignPlanID(std::move(rhs.DesignPlanID))
...
SJ_PrintGroupInfoImp	SJ_PrintGroupInfo("");



void	SJ_PrintInfoImp::SData::SetAll(bool val)
{
	val ? DesignPrintID_.reset(boost::initialized_value) : DesignPrintID_=boost::none;
	val ? OrderCate_.reset(boost::initialized_value) : OrderCate_=boost::none;
	val ? DesignPlanID_.reset(boost::initialized_value) : DesignPlanID_=boost::none;
...
void	SJ_PrintInfoImp::SData::Flip()
{
	DesignPrintID_ ? DesignPrintID_=boost::none : DesignPrintID_.reset(boost::initialized_value);
	OrderCate_ ? OrderCate_=boost::none : OrderCate_.reset(boost::initialized_value);
	DesignPlanID_ ? DesignPlanID_=boost::none : DesignPlanID_.reset(boost::initialized_value);
...
void	SJ_PrintInfoImp::SData::Check()
{
	if ( !DesignPrintID_ )
	{
		DesignPrintID_.reset(boost::initialized_value);
...
void	SJ_PrintInfoImp::SData::ToUtf8()
{
	if ( PrintName_ )
	{
...
void	SJ_PrintInfoImp::SData::ToAscii()
{
	if ( PrintName_ )
	{
...
autoDB::SColumns SJ_PrintInfoImp::Use( const SData& data )
{
	SColumns ret;
	if ( data.DesignPrintID_ )
	{
...
autoDB::SColumns SJ_PrintInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.DesignPrintID_ )
	{
...
SJ_PrintInfoImp	SJ_PrintInfoImp::operator() (const StringType& alias)
{
	return std::move(SJ_PrintInfoImp(alias));
}

SJ_PrintInfoImp::SJ_PrintInfoImp( const StringType& alias ):Table(AUTODB_STR("SJ_PrintInfo"), alias)
	,DesignPrintID(ImpSPtr_,AUTODB_STR("DesignPrintID"))
	,OrderCate(ImpSPtr_,AUTODB_STR("OrderCate"))
	,DesignPlanID(ImpSPtr_,AUTODB_STR("DesignPlanID"))
	,OrderID(ImpSPtr_,AUTODB_STR("OrderID"))
...
SJ_PrintInfoImp::SJ_PrintInfoImp( const SJ_PrintInfoImp& rhs ):Table(rhs)
	,DesignPrintID(rhs.DesignPrintID)
	,OrderCate(rhs.OrderCate)
	,DesignPlanID(rhs.DesignPlanID)
	,OrderID(rhs.OrderID)
...
SJ_PrintInfoImp::SJ_PrintInfoImp( SJ_PrintInfoImp&& rhs ):Table(rhs)
	,DesignPrintID(std::move(rhs.DesignPrintID))
	,OrderCate(std::move(rhs.OrderCate))
	,DesignPlanID(std::move(rhs.DesignPlanID))
	,OrderID(std::move(rhs.OrderID))
...
SJ_PrintInfoImp	SJ_PrintInfo("");



void	SJ_PrintTableInfoImp::SData::SetAll(bool val)
{
...
void	SJ_PrintTableInfoImp::SData::Flip()
{
...
void	SJ_PrintTableInfoImp::SData::Check()
{
...
void	SJ_PrintTableInfoImp::SData::ToUtf8()
{
	if ( FaceName_ )
	{
		FaceName_ = boost::locale::conv::to_utf<char>(*FaceName_, "GBK");
...
void	SJ_PrintTableInfoImp::SData::ToAscii()
{
	if ( FaceName_ )
	{
		FaceName_ = boost::locale::conv::from_utf(*FaceName_, "GBK");
...
autoDB::SColumns SJ_PrintTableInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns SJ_PrintTableInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.DesignPrintTableID_ )
	{
...
SJ_PrintTableInfoImp	SJ_PrintTableInfoImp::operator() (const StringType& alias)
{
	return std::move(SJ_PrintTableInfoImp(alias));
}

SJ_PrintTableInfoImp::SJ_PrintTableInfoImp( const StringType& alias ):Table(AUTODB_STR("SJ_PrintTableInfo"), alias)
...
SJ_PrintTableInfoImp::SJ_PrintTableInfoImp( const SJ_PrintTableInfoImp& rhs ):Table(rhs)
...
SJ_PrintTableInfoImp::SJ_PrintTableInfoImp( SJ_PrintTableInfoImp&& rhs ):Table(rhs)
...
SJ_PrintTableInfoImp	SJ_PrintTableInfo("");



void	SJ_PrintTableRowColInfoImp::SData::SetAll(bool val)
{
...
void	SJ_PrintTableRowColInfoImp::SData::Flip()
{
...
void	SJ_PrintTableRowColInfoImp::SData::Check()
{
...
void	SJ_PrintTableRowColInfoImp::SData::ToUtf8()
{
	if ( FaceName_ )
	{
		FaceName_ = boost::locale::conv::to_utf<char>(*FaceName_, "GBK");
...
void	SJ_PrintTableRowColInfoImp::SData::ToAscii()
{
	if ( FaceName_ )
	{
		FaceName_ = boost::locale::conv::from_utf(*FaceName_, "GBK");
...
autoDB::SColumns SJ_PrintTableRowColInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns SJ_PrintTableRowColInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.DesignPrintTableRowColID_ )
	{
...
SJ_PrintTableRowColInfoImp	SJ_PrintTableRowColInfoImp::operator() (const StringType& alias)
{
	return std::move(SJ_PrintTableRowColInfoImp(alias));
}

SJ_PrintTableRowColInfoImp::SJ_PrintTableRowColInfoImp( const StringType& alias ):Table(AUTODB_STR("SJ_PrintTableRowColInfo"), alias)
...
SJ_PrintTableRowColInfoImp::SJ_PrintTableRowColInfoImp( const SJ_PrintTableRowColInfoImp& rhs ):Table(rhs)
...
SJ_PrintTableRowColInfoImp::SJ_PrintTableRowColInfoImp( SJ_PrintTableRowColInfoImp&& rhs ):Table(rhs)
...
SJ_PrintTableRowColInfoImp	SJ_PrintTableRowColInfo("");



void	SJ_PrintTableRowInfoImp::SData::SetAll(bool val)
{
	val ? DesignPrintTableRowID_.reset(boost::initialized_value) : DesignPrintTableRowID_=boost::none;
	val ? DesignPrintTableID_.reset(boost::initialized_value) : DesignPrintTableID_=boost::none;
	val ? OrderCate_.reset(boost::initialized_value) : OrderCate_=boost::none;
...
void	SJ_PrintTableRowInfoImp::SData::Flip()
{
	DesignPrintTableRowID_ ? DesignPrintTableRowID_=boost::none : DesignPrintTableRowID_.reset(boost::initialized_value);
	DesignPrintTableID_ ? DesignPrintTableID_=boost::none : DesignPrintTableID_.reset(boost::initialized_value);
	OrderCate_ ? OrderCate_=boost::none : OrderCate_.reset(boost::initialized_value);
...
void	SJ_PrintTableRowInfoImp::SData::Check()
{
	if ( !DesignPrintTableRowID_ )
	{
		DesignPrintTableRowID_.reset(boost::initialized_value);
...
void	SJ_PrintTableRowInfoImp::SData::ToUtf8()
{
	if ( FaceName_ )
	{
		FaceName_ = boost::locale::conv::to_utf<char>(*FaceName_, "GBK");
...
void	SJ_PrintTableRowInfoImp::SData::ToAscii()
{
	if ( FaceName_ )
	{
		FaceName_ = boost::locale::conv::from_utf(*FaceName_, "GBK");
...
autoDB::SColumns SJ_PrintTableRowInfoImp::Use( const SData& data )
{
	SColumns ret;
	if ( data.DesignPrintTableRowID_ )
	{
...
autoDB::SColumns SJ_PrintTableRowInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.DesignPrintTableRowID_ )
	{
...
SJ_PrintTableRowInfoImp	SJ_PrintTableRowInfoImp::operator() (const StringType& alias)
{
	return std::move(SJ_PrintTableRowInfoImp(alias));
}

SJ_PrintTableRowInfoImp::SJ_PrintTableRowInfoImp( const StringType& alias ):Table(AUTODB_STR("SJ_PrintTableRowInfo"), alias)
	,DesignPrintTableRowID(ImpSPtr_,AUTODB_STR("DesignPrintTableRowID"))
	,DesignPrintTableID(ImpSPtr_,AUTODB_STR("DesignPrintTableID"))
	,OrderCate(ImpSPtr_,AUTODB_STR("OrderCate"))
	,OrderID(ImpSPtr_,AUTODB_STR("OrderID"))
...
SJ_PrintTableRowInfoImp::SJ_PrintTableRowInfoImp( const SJ_PrintTableRowInfoImp& rhs ):Table(rhs)
	,DesignPrintTableRowID(rhs.DesignPrintTableRowID)
	,DesignPrintTableID(rhs.DesignPrintTableID)
	,OrderCate(rhs.OrderCate)
	,OrderID(rhs.OrderID)
...
SJ_PrintTableRowInfoImp::SJ_PrintTableRowInfoImp( SJ_PrintTableRowInfoImp&& rhs ):Table(rhs)
	,DesignPrintTableRowID(std::move(rhs.DesignPrintTableRowID))
	,DesignPrintTableID(std::move(rhs.DesignPrintTableID))
	,OrderCate(std::move(rhs.OrderCate))
	,OrderID(std::move(rhs.OrderID))
...
SJ_PrintTableRowInfoImp	SJ_PrintTableRowInfo("");



void	SJ_ProductInfoImp::SData::SetAll(bool val)
{
...
void	SJ_ProductInfoImp::SData::Flip()
{
...
void	SJ_ProductInfoImp::SData::Check()
{
	if ( !DesignProductID_ )
	{
...
void	SJ_ProductInfoImp::SData::ToUtf8()
{
}

void	SJ_ProductInfoImp::SData::ToAscii()
{
}

autoDB::SColumns SJ_ProductInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns SJ_ProductInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.DesignProductID_ )
	{
...
SJ_ProductInfoImp	SJ_ProductInfoImp::operator() (const StringType& alias)
{
	return std::move(SJ_ProductInfoImp(alias));
}

SJ_ProductInfoImp::SJ_ProductInfoImp( const StringType& alias ):Table(AUTODB_STR("SJ_ProductInfo"), alias)
...
SJ_ProductInfoImp::SJ_ProductInfoImp( const SJ_ProductInfoImp& rhs ):Table(rhs)
...
SJ_ProductInfoImp::SJ_ProductInfoImp( SJ_ProductInfoImp&& rhs ):Table(rhs)
...
SJ_ProductInfoImp	SJ_ProductInfo("");



void	SJ_RemarkInfoImp::SData::SetAll(bool val)
{
...
void	SJ_RemarkInfoImp::SData::Flip()
{
...
void	SJ_RemarkInfoImp::SData::Check()
{
	if ( !DesignRemarkID_ )
	{
...
void	SJ_RemarkInfoImp::SData::ToUtf8()
{
	if ( FaceName_ )
	{
		FaceName_ = boost::locale::conv::to_utf<char>(*FaceName_, "GBK");
...
void	SJ_RemarkInfoImp::SData::ToAscii()
{
	if ( FaceName_ )
	{
		FaceName_ = boost::locale::conv::from_utf(*FaceName_, "GBK");
...
autoDB::SColumns SJ_RemarkInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns SJ_RemarkInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.DesignRemarkID_ )
	{
...
SJ_RemarkInfoImp	SJ_RemarkInfoImp::operator() (const StringType& alias)
{
	return std::move(SJ_RemarkInfoImp(alias));
}

SJ_RemarkInfoImp::SJ_RemarkInfoImp( const StringType& alias ):Table(AUTODB_STR("SJ_RemarkInfo"), alias)
...
SJ_RemarkInfoImp::SJ_RemarkInfoImp( const SJ_RemarkInfoImp& rhs ):Table(rhs)
...
SJ_RemarkInfoImp::SJ_RemarkInfoImp( SJ_RemarkInfoImp&& rhs ):Table(rhs)
...
SJ_RemarkInfoImp	SJ_RemarkInfo("");



void	SJ_ShapeInfoImp::SData::SetAll(bool val)
{
...
void	SJ_ShapeInfoImp::SData::Flip()
{
...
void	SJ_ShapeInfoImp::SData::Check()
{
	if ( !DesignShapeID_ )
	{
...
void	SJ_ShapeInfoImp::SData::ToUtf8()
{
	if ( AttachFilePath_ )
	{
		AttachFilePath_ = boost::locale::conv::to_utf<char>(*AttachFilePath_, "GBK");
...
void	SJ_ShapeInfoImp::SData::ToAscii()
{
	if ( AttachFilePath_ )
	{
		AttachFilePath_ = boost::locale::conv::from_utf(*AttachFilePath_, "GBK");
...
autoDB::SColumns SJ_ShapeInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns SJ_ShapeInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.DesignShapeID_ )
	{
...
SJ_ShapeInfoImp	SJ_ShapeInfoImp::operator() (const StringType& alias)
{
	return std::move(SJ_ShapeInfoImp(alias));
}

SJ_ShapeInfoImp::SJ_ShapeInfoImp( const StringType& alias ):Table(AUTODB_STR("SJ_ShapeInfo"), alias)
...
SJ_ShapeInfoImp::SJ_ShapeInfoImp( const SJ_ShapeInfoImp& rhs ):Table(rhs)
...
SJ_ShapeInfoImp::SJ_ShapeInfoImp( SJ_ShapeInfoImp&& rhs ):Table(rhs)
...
SJ_ShapeInfoImp	SJ_ShapeInfo("");



void	SJ_SkinInfoImp::SData::SetAll(bool val)
{
...
void	SJ_SkinInfoImp::SData::Flip()
{
...
void	SJ_SkinInfoImp::SData::Check()
{
	if ( !DesignSkinID_ )
	{
...
void	SJ_SkinInfoImp::SData::ToUtf8()
{
}

void	SJ_SkinInfoImp::SData::ToAscii()
{
}

autoDB::SColumns SJ_SkinInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns SJ_SkinInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.DesignSkinID_ )
	{
...
SJ_SkinInfoImp	SJ_SkinInfoImp::operator() (const StringType& alias)
{
	return std::move(SJ_SkinInfoImp(alias));
}

SJ_SkinInfoImp::SJ_SkinInfoImp( const StringType& alias ):Table(AUTODB_STR("SJ_SkinInfo"), alias)
...
SJ_SkinInfoImp::SJ_SkinInfoImp( const SJ_SkinInfoImp& rhs ):Table(rhs)
...
SJ_SkinInfoImp::SJ_SkinInfoImp( SJ_SkinInfoImp&& rhs ):Table(rhs)
...
SJ_SkinInfoImp	SJ_SkinInfo("");



void	SJ_TableInfoImp::SData::SetAll(bool val)
{
...
void	SJ_TableInfoImp::SData::Flip()
{
...
void	SJ_TableInfoImp::SData::Check()
{
	if ( !DesignTableID_ )
	{
...
void	SJ_TableInfoImp::SData::ToUtf8()
{
}

void	SJ_TableInfoImp::SData::ToAscii()
{
}

autoDB::SColumns SJ_TableInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns SJ_TableInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.DesignTableID_ )
	{
...
SJ_TableInfoImp	SJ_TableInfoImp::operator() (const StringType& alias)
{
	return std::move(SJ_TableInfoImp(alias));
}

SJ_TableInfoImp::SJ_TableInfoImp( const StringType& alias ):Table(AUTODB_STR("SJ_TableInfo"), alias)
...
SJ_TableInfoImp::SJ_TableInfoImp( const SJ_TableInfoImp& rhs ):Table(rhs)
...
SJ_TableInfoImp::SJ_TableInfoImp( SJ_TableInfoImp&& rhs ):Table(rhs)
...
SJ_TableInfoImp	SJ_TableInfo("");



void	SJ_TablePartInfoImp::SData::SetAll(bool val)
{
...
void	SJ_TablePartInfoImp::SData::Flip()
{
...
void	SJ_TablePartInfoImp::SData::Check()
{
...
void	SJ_TablePartInfoImp::SData::ToUtf8()
{
}

void	SJ_TablePartInfoImp::SData::ToAscii()
{
}

autoDB::SColumns SJ_TablePartInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns SJ_TablePartInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.DesignTablePartID_ )
	{
...
SJ_TablePartInfoImp	SJ_TablePartInfoImp::operator() (const StringType& alias)
{
	return std::move(SJ_TablePartInfoImp(alias));
}

SJ_TablePartInfoImp::SJ_TablePartInfoImp( const StringType& alias ):Table(AUTODB_STR("SJ_TablePartInfo"), alias)
...
SJ_TablePartInfoImp::SJ_TablePartInfoImp( const SJ_TablePartInfoImp& rhs ):Table(rhs)
...
SJ_TablePartInfoImp::SJ_TablePartInfoImp( SJ_TablePartInfoImp&& rhs ):Table(rhs)
...
SJ_TablePartInfoImp	SJ_TablePartInfo("");



void	SJ_TableSideInfoImp::SData::SetAll(bool val)
{
...
void	SJ_TableSideInfoImp::SData::Flip()
{
...
void	SJ_TableSideInfoImp::SData::Check()
{
...
void	SJ_TableSideInfoImp::SData::ToUtf8()
{
}

void	SJ_TableSideInfoImp::SData::ToAscii()
{
}

autoDB::SColumns SJ_TableSideInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns SJ_TableSideInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.DesignTableSideID_ )
	{
...
SJ_TableSideInfoImp	SJ_TableSideInfoImp::operator() (const StringType& alias)
{
	return std::move(SJ_TableSideInfoImp(alias));
}

SJ_TableSideInfoImp::SJ_TableSideInfoImp( const StringType& alias ):Table(AUTODB_STR("SJ_TableSideInfo"), alias)
...
SJ_TableSideInfoImp::SJ_TableSideInfoImp( const SJ_TableSideInfoImp& rhs ):Table(rhs)
...
SJ_TableSideInfoImp::SJ_TableSideInfoImp( SJ_TableSideInfoImp&& rhs ):Table(rhs)
...
SJ_TableSideInfoImp	SJ_TableSideInfo("");



void	SJ_WallDecorInfoImp::SData::SetAll(bool val)
{
...
void	SJ_WallDecorInfoImp::SData::Flip()
{
...
void	SJ_WallDecorInfoImp::SData::Check()
{
...
void	SJ_WallDecorInfoImp::SData::ToUtf8()
{
}

void	SJ_WallDecorInfoImp::SData::ToAscii()
{
}

autoDB::SColumns SJ_WallDecorInfoImp::Use( const SData& data )
{
	SColumns ret;
...
autoDB::SColumns SJ_WallDecorInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.DesignWallDecorID_ )
	{
...
SJ_WallDecorInfoImp	SJ_WallDecorInfoImp::operator() (const StringType& alias)
{
	return std::move(SJ_WallDecorInfoImp(alias));
}

SJ_WallDecorInfoImp::SJ_WallDecorInfoImp( const StringType& alias ):Table(AUTODB_STR("SJ_WallDecorInfo"), alias)
...
SJ_WallDecorInfoImp::SJ_WallDecorInfoImp( const SJ_WallDecorInfoImp& rhs ):Table(rhs)
...
SJ_WallDecorInfoImp::SJ_WallDecorInfoImp( SJ_WallDecorInfoImp&& rhs ):Table(rhs)
...
SJ_WallDecorInfoImp	SJ_WallDecorInfo("");



void	SJ_WallInfoImp::SData::SetAll(bool val)
{
	val ? DesignWallID_.reset(boost::initialized_value) : DesignWallID_=boost::none;
	val ? DesignPlanID_.reset(boost::initialized_value) : DesignPlanID_=boost::none;
	val ? OrderCate_.reset(boost::initialized_value) : OrderCate_=boost::none;
...
void	SJ_WallInfoImp::SData::Flip()
{
	DesignWallID_ ? DesignWallID_=boost::none : DesignWallID_.reset(boost::initialized_value);
	DesignPlanID_ ? DesignPlanID_=boost::none : DesignPlanID_.reset(boost::initialized_value);
	OrderCate_ ? OrderCate_=boost::none : OrderCate_.reset(boost::initialized_value);
...
void	SJ_WallInfoImp::SData::Check()
{
	if ( !DesignWallID_ )
	{
		DesignWallID_.reset(boost::initialized_value);
...
void	SJ_WallInfoImp::SData::ToUtf8()
{
}

void	SJ_WallInfoImp::SData::ToAscii()
{
}

autoDB::SColumns SJ_WallInfoImp::Use( const SData& data )
{
	SColumns ret;
	if ( data.DesignWallID_ )
	{
...
autoDB::SColumns SJ_WallInfoImp::Into( SData& data )
{
	SColumns ret;
	if ( data.DesignWallID_ )
	{
...
SJ_WallInfoImp	SJ_WallInfoImp::operator() (const StringType& alias)
{
	return std::move(SJ_WallInfoImp(alias));
}

SJ_WallInfoImp::SJ_WallInfoImp( const StringType& alias ):Table(AUTODB_STR("SJ_WallInfo"), alias)
	,DesignWallID(ImpSPtr_,AUTODB_STR("DesignWallID"))
	,DesignPlanID(ImpSPtr_,AUTODB_STR("DesignPlanID"))
	,OrderCate(ImpSPtr_,AUTODB_STR("OrderCate"))
	,OrderID(ImpSPtr_,AUTODB_STR("OrderID"))
...
SJ_WallInfoImp::SJ_WallInfoImp( const SJ_WallInfoImp& rhs ):Table(rhs)
	,DesignWallID(rhs.DesignWallID)
	,DesignPlanID(rhs.DesignPlanID)
	,OrderCate(rhs.OrderCate)
	,OrderID(rhs.OrderID)
...
SJ_WallInfoImp::SJ_WallInfoImp( SJ_WallInfoImp&& rhs ):Table(rhs)
	,DesignWallID(std::move(rhs.DesignWallID))
	,DesignPlanID(std::move(rhs.DesignPlanID))
	,OrderCate(std::move(rhs.OrderCate))
	,OrderID(std::move(rhs.OrderID))
